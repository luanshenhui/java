...
public class PageBean {
	 ...
	 */
	@SuppressWarnings("static-access")
	public static PageBean getPageBean(String displayId, int resultSize,
		...
		String isMorePage = (String) (request.getAttribute("MorePage") == null ? "N"
				: request.getAttribute("MorePage"));
	...
	public static List setPageList(int pageSize, String tableName, List list,
			HttpServletRequest request) {

		// 页数的参数名
		pageIndexName = new org.displaytag.util.ParamEncoder(tableName)
				.encodeParameterName(org.displaytag.tags.TableTagParameters.PARAMETER_PAGE);
		// 当前页
		pageIndex = GenericValidator.isBlankOrNull(request
				.getParameter(pageIndexName)) ? 1 : (Integer.parseInt(request
				.getParameter(pageIndexName)));
		// 页面显示List
	 ...
	 * @return 设置后的PageBean
	 */
	private static PageBean pageProcess(PageBean pageBean,
			HttpServletRequest request) {

		// 页数的参数名
		pageIndexName = new org.displaytag.util.ParamEncoder(displayId)
				.encodeParameterName(org.displaytag.tags.TableTagParameters.PARAMETER_PAGE);
