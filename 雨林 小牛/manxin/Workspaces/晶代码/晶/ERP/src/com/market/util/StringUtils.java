...
public class StringUtils {
	...
	private static char[] XML_SPECIAL_CHAR = new char[] { '&', '\\', '<', '>',
			'\r', '\n', '"' };
	private static String[] XML_CHAR = new String[] { "&amp;", "&quot;",
			"&lt;", "&gt;", "&#10;", "&#13;", "&quot;" };
	...
	/**
	 * Replace char with char in String. oldChar = new char[] {'?', '|', '/'};
	 * newChar = new char[] {'=', '=', '='};
	 * 
	 * @param source
	 * @param oldChar
...
/**
	...
	/**
	 * Provide the String replace operation for the lower JDK version (eg: JDK
	 * 1.4)
	 * 
	 * @param source
	 * @param target
	 ...
	 * requirements of the specified URL pattern; otherwise, return
	 * <code>null</code>.
	 * 
	 * @param urlPattern
	 * @param requestPath
