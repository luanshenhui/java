...
<form name="form1" action="stock!editStock.action" method="post">
	...
	<table cellspacing="1" cellpadding="0" width="98%" align="center"
		...
		<tr class="bgcolor">
			...
			<td width="30%" class="pad2 zi13">
				...
				<input type="text" value="${stock.stockNo}" id="stockNo" name="stock.stockNo"
			...
			<td width="30%" class="pad2 zi13">
				...
				<input class="Wdate"
					value="<s:date name="stock.stockDate" id="stockDate" format="yyyy-MM-dd" />"
		...
		<tr class="bgcolor">
			...
			<td width="30%" class="pad2 zi13">
				...
				<input type="text" value="${stock.totalMoney}" readonly="true"
					name="stock.totalMoney" maxlength="22" class="box1" />
		...
		<tr class="bgcolor">
			...
			<td width="30%" colspan="3" class="pad2 zi13">
				<textarea rows="5" cols="60" name="stock.remark" maxlength="300">${stock.remark}</textarea>
...
<script>
  ...
  function save(){
	 ...
	 document.forms[0].action= "<%=path%>/stock!editStock.action";
