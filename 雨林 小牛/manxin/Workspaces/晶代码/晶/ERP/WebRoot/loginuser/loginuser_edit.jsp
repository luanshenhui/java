	...
	<table cellspacing="1" cellpadding="0" width="98%" align="center"
		...
		<tr class="bgcolor">
			...
			<td width="30%" class="pad2 zi13">
				...
				<input type="text" id="name" value="${loginuser.name}" name="loginuser.name"
			...
			<td width="30%" class="pad2 zi13">
				...
				<input type="password" id="password"  value="${loginuser.password}"
					name="loginuser.password" maxlength="50" class="box1" />
		...
		<tr class="bgcolor">
			...
			<td width="30%" class="pad2 zi13">
				...
				<input type="text" value="${loginuser.phone}" name="loginuser.phone"
...
<script>
 ...
 if($("#name").val() == ""){
          ...
          return;
		   	 ...
		   	 document.forms[0].action= "<%=path%>/loginuser!editLoginuser.action";
