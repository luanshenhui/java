...
<%@ page contentType="text/html;charset=UTF-8" pageEncoding="UTF-8"%>
    <form name="form1" action="salesDetail!editSalesDetail.action" method="post">
    <input type="hidden" name="salesDetail.id" value="${salesDetail.id}"/> 
	    ...
	    <table cellspacing="1" cellpadding="0" width="98%" align="center"  border="0" class="bgcolor2 margb5">
		   ...
		   <td colspan="4" align="left" class="bkuang zi13b bgcolor2 padl5"><bean:message key='salesdetail.title.info' bundle="label" /></td>
			  ...
			  <td width="30%"  class="pad2 zi13">
				      ...
				      <input type="text" value="${salesDetail.salesId}" name="salesDetail.salesId"   maxlength="11" class="box1" />
			  ...
			  <td width="30%"  class="pad2 zi13">
				      ...
				      <input type="text" value="${salesDetail.goodsId}" name="salesDetail.goodsId"   maxlength="11" class="box1" />
			  ...
			  <td width="30%"  class="pad2 zi13">
				      ...
				      <input type="text" value="${salesDetail.num}" name="salesDetail.num"   maxlength="11" class="box1" />
			  ...
			  <td width="30%"  class="pad2 zi13">
				      ...
				      <input type="text" value="${salesDetail.money}" name="salesDetail.money"   maxlength="22" class="box1" />
...
<script>
  ...
  function save(){
		   	 ...
		   	 document.forms[0].action= "<%=path%>/salesDetail!editSalesDetail.action";
