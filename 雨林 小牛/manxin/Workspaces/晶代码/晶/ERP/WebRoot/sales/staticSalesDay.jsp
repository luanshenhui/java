...
<form name="form1" action="sales!querySales.action" method="post">
	...
	<table cellspacing="3" cellpadding="0" width="98%" align="center"
		...
		<tr>
			...
			<td width="40%">
				...
				<input class="Wdate" type="text" name="detail.salesDate" id="salesDate" value="<s:date name="detail.salesDate" format="yyyy-MM-dd" />" 
			...
			<td width="20%">
				...
				<input type="text" name="detail.goodsName"
					value="${detail.goodsName}" class="box1" />
						...
						<s:iterator value="#request.staticList" id="detailTemp"
							...
							<tr class="odd">
								...
								<td style="width: 15%; text-align: center;">
								    ...
								    <fmt:formatDate value="${detailTemp.salesDate}"/>
								...
								<td style="width: 10%; text-align: center;">
									${(detailTemp.price-detailTemp.inCome)*detailTemp.num}
								</td>
								<td style="width: 10%; text-align: center;">
								<fmt:formatNumber pattern="#.##" value="${(detailTemp.price-detailTemp.inCome)*detailTemp.num/detailTemp.money*100}"></fmt:formatNumber>
	...
	<script>
  var title = "销售管理 > 销售金额统计";
  $("#titleLabel").html(title);
  
  function query(){
      var action = "<%=path%>/sales!staticSalesDay.action";
