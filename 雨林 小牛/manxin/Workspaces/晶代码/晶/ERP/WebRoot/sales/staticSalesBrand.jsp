...
<form name="form1" action="sales!querySales.action" method="post">
					...
					<tbody>
						<s:iterator value="#request.staticList" id="detailTemp"
							...
							<tr class="odd">
								...
								<td style="width: 10%; text-align: center;">
									${detailTemp.money-detailTemp.inCome}
								</td>
								
								<td style="width: 10%; text-align: center;">
								<fmt:formatNumber pattern="#.##" value="${(detailTemp.money-detailTemp.inCome)/detailTemp.money*100}"></fmt:formatNumber>
	...
	<script>
  var title = "销售管理 > 销售品牌统计";
  $("#titleLabel").html(title);
  
  function query(){
      var action = "<%=path%>/sales!staticSalesBrand.action";
