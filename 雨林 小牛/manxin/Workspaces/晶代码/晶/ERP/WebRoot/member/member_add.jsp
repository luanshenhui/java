...
<form name="form1" action="member!addMember.action" method="post">
	...
	<table cellspacing="1" cellpadding="0" width="98%" align="center"
		...
		<tr class="bgcolor">
			...
			<td width="30%" class="pad2 zi13">
				...
				<input type="text" name="member.name" maxlength="30" id="name" class="box1" />&nbsp;<font color="red">*</font>
		...
		<tr class="bgcolor">
			...
			<td width="30%" class="pad2 zi13">
				...
				<input type="text" name="member.idno" maxlength="30" class="box1" />
			...
			<td width="30%" class="pad2 zi13">
				<input class="Wdate" type="text" name="member.birthday"
		...
		<tr class="bgcolor">
			...
			<td width="30%" class="pad2 zi13">
				...
				<input type="text" name="member.telphone" id="telphone" maxlength="30" 
					class="box1" />&nbsp;<font color="red">*</font>
			...
			<td width="30%" class="pad2 zi13">
				...
				<input type="text" name="member.address" maxlength="100"
					class="box1" />
 ...
 if($("#name").val() == ""){
     ...
     if($("#telphone").val() == ""){
          ...
          return;
		   	 ...
		   	 document.forms[0].action= "<%=path%>/member!addMember.action";
