...
<form name="form1" action="employee!addEmployee.action" method="post">
	...
	<table cellspacing="1" cellpadding="0" width="98%" align="center"
		...
		<tr class="bgcolor">
			...
			<td width="30%" class="pad2 zi13">
				...
				<input type="text" name="employee.name" id="name" maxlength="30" class="box1" />
&nbsp;<font color="red">*</font>
		...
		<tr class="bgcolor">
			...
			<td width="30%" class="pad2 zi13">
				...
				<input type="text" name="employee.idno" id="idno" maxlength="30" class="box1" />
...
&nbsp;<font color="red">*</font>
			...
			<td width="30%" class="pad2 zi13">
				<input class="Wdate" type="text" name="employee.birthday"
		...
		<tr class="bgcolor">
			...
			<td width="30%" class="pad2 zi13">
				...
				<input type="text" name="employee.telphone" maxlength="30"
					class="box1" />
 ...
 if($("#name").val() == ""){
     ...
     if($("#idno").val() == ""){
          ...
          return;
		   	 ...
		   	 document.forms[0].action= "<%=path%>/employee!addEmployee.action";
