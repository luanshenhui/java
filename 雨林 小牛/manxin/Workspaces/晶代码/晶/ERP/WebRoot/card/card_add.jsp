...
<form name="form1" action="card!addCard.action" method="post">
	...
	<table cellspacing="1" cellpadding="0" width="98%" align="center"
		...
		<tr class="bgcolor">
			...
			<td width="30%" class="pad2 zi13">
				...
				<input type="text" name="card.cardNo" id="cardNo" maxlength="15" class="box1" />
&nbsp;<font color="red">*</font>
...
<s:select list="#request.cardType" theme="simple" name="card.cardType"
		...
		<tr class="bgcolor">
			...
			<td width="30%" class="pad2 zi13">
				...
				<input type="text" name="card.money" maxlength="22" id="money" value="1000" class="box1" />元
&nbsp;<font color="red">*</font>
			...
			<td width="30%" class="pad2 zi13">
				...
				<input type="text" name="card.score" id="score" value="0" maxlength="11" class="box1" />
		...
		<tr class="bgcolor">
			...
			<td width="30%" colspan="3" class="pad2 zi13">
				<s:select list="#request.member" theme="simple" name="card.memberId" id="memberId"
					cssClass="box1" headerKey="" headerValue="请选择" listKey="id" listValue="name"></s:select>&nbsp;<font color="red">*</font>
			</td>
		</tr>
...
if($("#cardNo").val() == ""){
     ...
     if($("#money").val() == ""){
          ...
          return;
		   	 ...
		   	 document.forms[0].action= "<%=path%>/card!addCard.action";
