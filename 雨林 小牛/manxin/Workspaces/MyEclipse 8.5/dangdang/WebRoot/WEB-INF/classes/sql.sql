...
insert into d_user values(null,"103ww@aa.com","name","1234",1,"s","456789",123456789,"124.256.486");
...
select name from d_category where id =(select parent_id from d_category where id = 9)

select * from d_product p join d_book b on p.id=b.id where p.id = 1
...
INSERT INTO d_product VALUES (1,'上课头疼的故事1','上课头疼的故事',1237873000234,200,180,'key',0,'16.jpg');
INSERT INTO d_product VALUES (2,'上课头疼的故事2','上课头疼的故事',1237873000234,200,180,'key',0,'17.jpg');
INSERT INTO d_product VALUES (3,'上课头疼的故事3','上课头疼的故事',1237873000234,200,180,'key',0,'18.jpg');
INSERT INTO d_product VALUES (4,'上课头疼的故事4','上课头疼的故事',1237873000234,200,180,'key',0,'19.jpg');
INSERT INTO d_product VALUES (5,'上课头疼的故事5','上课头疼的故事',1237873000234,200,180,'key',0,'20.jpg');
INSERT INTO d_product VALUES (6,'上课头疼的故事6','上课头疼的故事',1237873000234,200,180,'key',0,'21.jpg');
INSERT INTO d_product VALUES (7,'上课头疼的故事7','上课头疼的故事',1237873000234,200,180,'key',0,'22.jpg');
INSERT INTO d_product VALUES (8,'上课头疼的故事8','上课头疼的故事',1237873000234,200,180,'key',0,'23.jpg');
INSERT INTO d_product VALUES (9,'上课头疼的故事9','上课头疼的故事',1237873000234,200,180,'key',0,'24.jpg');
INSERT INTO d_product VALUES (10,'上课头疼的故事10','上课头疼的故事',1237873000234,200,180,'key',0,'2.jpg');
INSERT INTO d_product VALUES (11,'上课头疼的故事11','上课头疼的故事',1237873000234,200,180,'key',0,'3.jpg');
INSERT INTO d_product VALUES (12,'上课睡觉的故事12','上课睡觉的故事',1237873000234,200,180,'key',0,'4.jpg');
INSERT INTO d_product VALUES (13,'上课睡觉的故事13','上课睡觉的故事',1237873000234,200,180,'key',0,'5.jpg');
INSERT INTO d_product VALUES (14,'上课睡觉的故事14','上课睡觉的故事',1237873000234,200,180,'key',0,'6.jpg');
INSERT INTO d_product VALUES (15,'上课睡觉的故事15','上课睡觉的故事',1237873000234,200,180,'key',0,'7.jpg');
INSERT INTO d_product VALUES (16,'上课睡觉的故事16','上课睡觉的故事',1237873000234,200,180,'key',0,'8.jpg');
INSERT INTO d_product VALUES (17,'上课睡觉的故事17','上课睡觉的故事',1237873000234,200,180,'key',0,'9.jpg');
INSERT INTO d_product VALUES (18,'上课睡觉的故事18','上课睡觉的故事',1237873000234,200,180,'key',0,'10.jpg');
INSERT INTO d_product VALUES (19,'上课睡觉的故事19','上课睡觉的故事',1237873000234,200,180,'key',0,'11.jpg');
INSERT INTO d_product VALUES (20,'上课睡觉的故事20','上课睡觉的故事',1237873000234,200,180,'key',0,'12.jpg');
INSERT INTO d_product VALUES (21,'上课睡觉的故事21','上课睡觉的故事',1237873000234,200,180,'key',0,'13.jpg');
INSERT INTO d_product VALUES (22,'上课睡觉的故事22','上课睡觉的故事',1237873000234,200,180,'key',0,'14.jpg');
INSERT INTO d_product VALUES (23,'上课睡觉的故事23','上课睡觉的故事',1237873000234,200,180,'key',0,'15.jpg');
...
INSERT INTO d_book VALUES (1,'我写的','地球出版社',1337873000234,'1万','1','100',1,NULL,'12345678','作者是好人','这真是一本好书啊');
INSERT INTO d_book VALUES (2,'我写的','地球出版社',1437873000234,'1万','1','100',1,NULL,'12345678','作者是好人','这真是一本好书啊');
INSERT INTO d_book VALUES (3,'我写的','地球出版社',1537873000234,'1万','1','100',1,NULL,'12345678','作者是好人','这真是一本好书啊');
INSERT INTO d_book VALUES (4,'我写的','地球出版社',1637873000234,'1万','1','100',1,NULL,'12345678','作者是好人','这真是一本好书啊');
INSERT INTO d_book VALUES (5,'我写的','地球出版社',1737873000234,'1万','1','100',1,NULL,'12345678','作者是好人','这真是一本好书啊');
INSERT INTO d_book VALUES (6,'我写的','地球出版社',1837873000234,'1万','1','100',1,NULL,'12345678','作者是好人','这真是一本好书啊');
...
select * from d_category_product dcp join d_product dp on dcp.product_id = dp.id join d_category dc on dcp.cat_id = dc.id where;

select * from d_product p join d_book b on p.id = b.id where p.id in (select product_id from d_category_product where cat_id = 9);

select count from d_book;

select * from d_book where id in (select id from d_product where id = 1);
select * from d_product limit 0,5;

delete from d_book;
delete from d_product;

select * from d_book order by publish_time desc limit 0,5;

select * from d_product where id =(select id from d_book order by publish_time desc)limit 0,5;

select * from d_product p join d_book b on p.id=b.id order by publish_time desc limit 0,5

select * from d_user

select * from d_product p join d_book b on p.id=b.id limit 0,5;
...
insert into d_order values(null,1001,1001,11111111111,null,23,null,null,null,null,null)
select * from d_order

select * from d_product p join d_book b on p.id=b.id where p.product_name like '%上课头疼的故事%'
...
insert into d_receive_address values(null, 1001,'Java','sun.cn','10000800','12345','67890');
