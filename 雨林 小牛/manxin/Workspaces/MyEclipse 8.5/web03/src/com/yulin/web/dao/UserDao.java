...
public class UserDao {
	...
	private String update = "update jsp_user set u_pwd = ?,u_name = ?,u_sex = ?,u_age = ?,u_email = ?,"
		+"u_phone = ?,u_city = ? where u_loginid = ?";
...
//		System.out.println(ud.regist(new User("1","1","1","1",1,"1","1","1")));
