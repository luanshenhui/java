...
public class Pet {
	...
	public int age;
	//成长经验、饥饿、清洁、心情、叛逆
	public int level=0;//经验 100点长一岁 自动生长
	public int an=50;//饥饿 0~100
	public int heart=50;//心情 0~100 小于0 心情叛逆下降
	public int clene=50;//清洁 0~100 小于0离家出走
	public int panni=50;//叛逆0~100 小于0 咬死
	...
	private void chengZhang(){//成长
		...
		}, 10000,10000);//延迟3000毫秒之后，每隔1000毫秒运行一次run()
	}
