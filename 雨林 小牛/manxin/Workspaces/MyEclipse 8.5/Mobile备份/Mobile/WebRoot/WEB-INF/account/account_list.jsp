        ...
        <div id="main">
            <form action="findAccount" method="post">
                ...
                <div class="search_add">                        
                    <div>身份证：<input name="idcard_no" type="text"  value="" class="text_search" /></div>                            
                    <div>姓名：<input name="real_name" type="text" class="width70 text_search" value="" /></div>
                    <div>登录名：<input name="login_name" type="text"  value="" class="text_search"" /></div>
                    <div>
                        状态：
                ...
                <div id="data">            
                    ...
                    <tr>
                        ...
                        <td><a href="account_detail.html"><s:property value="real_name"/></a></td>
                        ...
                        <td>1<s:property value="last_login_time"/></td>  
                        <s:if test="status==0">                      
	                        <td class="td_modi">
