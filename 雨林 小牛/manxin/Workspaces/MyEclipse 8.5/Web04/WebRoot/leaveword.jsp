...
<html>
	...
	$(function(){
		$("#words_input1001").click(function(){	
			$("#words_input1001").css("background-color","#000");			
		});
		...
		$("#words_input1002").click(function(){		
			$("#words_input1002").css("background-color","#fff");			
		});
...
#word_tr3 .word_td1 a:HOVER{
	...
	<body id="word_body">
		...
		<DIV class="word_item_tmp">
				<div>留言板</div>
				<form action="sendLeaveWordActionServlet" method="post" class="word_form">
						...
						<tbody id="word_tbody1">
							...
							<tr id="word_tr2">
								...
								<td id="word_leave_content">
									<textarea name="content" id="words_input1001" class="word_input1" >${sessionScope.content}</textarea>
								</td>
							</tr>
							<tr id="word_tr3">
