	...
	protected void service(HttpServletRequest req, HttpServletResponse resp)
		...
		if("/regist".equals(path)){
			...
			if(number.equals(checkCode)){
				...
				session.setAttribute("msg_login", "验证码错误");
...
//					System.out.println("value:" + c.getValue());
			...
			if(u == null){
				...
				String id = u.getLoginId();
					...
					ArrayList<User> list2 = (ArrayList<User>) us.findById(id);
			...
			String id = req.getParameter("loginId");
			ArrayList<User> list = (ArrayList<User>) us.findById(id);
