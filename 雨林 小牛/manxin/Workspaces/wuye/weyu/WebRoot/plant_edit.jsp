...
<body>
<form action="f5pl_update.action" method="get">
    ...
    <td class="STYLE1" colspan="4" bgcolor="#FFFFFF"><table align="center" border="0" cellpadding="0" cellspacing="0" width="70%">
      <tbody><tr>
        ...
        <td class="STYLE1" height="35" width="352"><div align="left">
          <input name="plant_id" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text" value="${plant_id}" readonly></div></td>
      ...
      <tr>
        ...
        <td class="STYLE1" colspan="3" height="35"><div align="left">
          <input name="plant_name" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text" value="${plant_name}"></div></td>
        </tr>
      <tr>
      ...
      <tr>
        ...
        <td class="STYLE1" colspan="3" height="35"><div align="left">
          <input name="plant_factory" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text" value="${plant_factory}"></div></td>
        </tr>
      <tr>
        <td class="STYLE1" height="35" nowrap="nowrap" width="142"><div align="left">生产日期</div></td>
        <td class="STYLE1" colspan="3" height="35"><div align="left">
          <input name="plant_date" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text" value="${plant_date}"></div></td>
      </tr>
      <tr>
        <td class="STYLE1" height="35" nowrap="nowrap" width="142"><div align="left">数量</div></td>
        <td class="STYLE1" colspan="3" height="35"><div align="left">
          <input name="plant_num" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text" value="${plant_num}"></div></td>
       
      </tr>
      <tr>
        <td class="STYLE1" height="35" nowrap="nowrap" width="142"><div align="left">检修周期</div></td>
        <td class="STYLE1" colspan="3" height="35"><div align="left">
          <input name="plant_repaircycle" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text" value="${plant_repaircycle}"></div></td>
