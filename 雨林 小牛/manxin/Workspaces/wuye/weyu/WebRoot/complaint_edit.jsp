...
<body>
<form action="f5comp_update.action" method="get">
    ...
    <td class="STYLE1" colspan="4" bgcolor="#FFFFFF"><table align="center" border="0" cellpadding="0" cellspacing="0" width="70%">
      <tbody><tr>
        ...
        <td class="STYLE1" height="35" width="352"><div align="left">
          <input name="complaint_id" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text" value="${complaint_id}" readonly></div></td>
      ...
      <tr>
        ...
        <td class="STYLE1" colspan="3" height="35"><div align="left">
          <input name="complaint_date" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text" value="${complaint_date}"></div></td>
        </tr>
      <tr>
        <td class="STYLE1" height="35" nowrap="nowrap" width="142"><div align="left"></div>投诉事件</td>
        <td class="STYLE1" colspan="3" height="35"><div align="left">
          <input name="complaint_matter" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text" value="${complaint_matter}"></div></td>
        </tr>
      <tr>
        <td class="STYLE1" height="35" nowrap="nowrap" width="142"><div align="left">处理人员</div></td>
        <td class="STYLE1" colspan="3" height="35"><div align="left">
          <input name="complaint_dealperson" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text" value="${complaint_dealperson}"></div></td>
      </tr>
      <tr>
        <td class="STYLE1" height="35" nowrap="nowrap" width="142"><div align="left">处理方式</div></td>
        <td class="STYLE1" colspan="3" height="35"><div align="left">
          <input name="complaint_way" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text" value="${complaint_way}"></div></td>
       
      </tr>
      <tr>
        <td class="STYLE1" height="35" nowrap="nowrap" width="142"><div align="left">处理结果</div></td>
        <td class="STYLE1" colspan="3" height="35"><div align="left">
          <input name="complaint_result" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text" value="${complaint_result}"></div></td>
