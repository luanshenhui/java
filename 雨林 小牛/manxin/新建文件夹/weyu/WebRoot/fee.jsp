...
<body>
<form action="f5fee_insertFee.action" method="get">
    ...
    <td class="STYLE1" colspan="4" bgcolor="#FFFFFF"><table align="center" border="0" cellpadding="0" cellspacing="0" width="70%">
      <tbody><tr>
        ...
        <td class="STYLE1" height="35" width="352"><div align="left">
          <input name="fee_id" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " onblur="isIdUsed4();" type="text" id="fee_id" ></div></td>
      ...
      <tr>
        ...
        <td class="STYLE1" colspan="3" height="35"><div align="left">
          <input name="fee_name" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text"></div></td>
        </tr>
      <tr>
        <td class="STYLE1" height="35" nowrap="nowrap" width="142"><div align="left"></div>费用标准</td>
        <td class="STYLE1" colspan="3" height="35"><div align="left">
          <input name="fee_standard" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text"></div></td>
        </tr>
      <tr>
        <td class="STYLE1" height="35" nowrap="nowrap" width="142"><div align="left">标准更新时间</div></td>
        <td class="STYLE1" colspan="3" height="35"><div align="left">
          <input name="fee_date" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text"></div></td>
      </tr>
      <tr>
