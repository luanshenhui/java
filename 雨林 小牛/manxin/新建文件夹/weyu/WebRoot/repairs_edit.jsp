...
<body>
<form action="f5rep_update.action" method="get">
    ...
    <td class="STYLE1" colspan="4" bgcolor="#FFFFFF"><table align="center" border="0" cellpadding="0" cellspacing="0" width="70%">
      <tbody><tr>
        ...
        <td class="STYLE1" height="35" width="352"><div align="left">
          <input name="repairs_id" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text" value="${repairs_id}" readonly></div></td>
      ...
      <tr>
        ...
        <td class="STYLE1" colspan="3" height="35"><div align="left">
         ...
         <select name="repairs_plantid">
          	<s:iterator value="plantIdList" id="com">
      ...
      <tr>
        ...
        <td class="STYLE1" colspan="3" height="35"><div align="left">
          <input name="repairs_date" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text" value="${repairs_date}"></div></td>
        </tr>
      <tr>
        <td class="STYLE1" height="35" nowrap="nowrap" width="142"><div align="left"></div>报修原因</td>
        <td class="STYLE1" colspan="3" height="35"><div align="left">
          <input name="repairs_reason" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text" value="${repairs_reason}"></div></td>
        </tr>
      <tr>
        <td class="STYLE1" height="35" nowrap="nowrap" width="142"><div align="left">检修方式</div></td>
        <td class="STYLE1" colspan="3" height="35"><div align="left">
          <input name="repairs_way" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text" value="${repairs_way}"></div></td>
      </tr>
      <tr>
        <td class="STYLE1" height="35" nowrap="nowrap" width="142"><div align="left">检修人员</div></td>
        <td class="STYLE1" colspan="3" height="35"><div align="left">
          <input name="repairs_person" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text" value="${repairs_person}"></div></td>
       
      </tr>
      <tr>
        <td class="STYLE1" height="35" nowrap="nowrap" width="142"><div align="left">检修结果</div></td>
        <td class="STYLE1" colspan="3" height="35"><div align="left">
          <input name="repairs_result" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text" value="${repairs_result}"></div></td>
