...
<body>
<form action="f5car_insertCarport.action" method="get">
    ...
    <td class="STYLE1" colspan="4" bgcolor="#FFFFFF"><table align="center" border="0" cellpadding="0" cellspacing="0" width="70%">
      <tbody><tr>
        ...
        <td class="STYLE1" height="35" width="352"><div align="left">
          <input name="carport_id" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " onblur="isIdUsed6();" type="text" id="carport_id" ></div></td>
      ...
      <tr>
        ...
        <td class="STYLE1" colspan="3" height="35"><div align="left">
          <input name="carport_carnum" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text"></div></td>
        </tr>
      <tr>
        <td class="STYLE1" height="35" nowrap="nowrap" width="142"><div align="left"></div>车类型</td>
        <td class="STYLE1" colspan="3" height="35"><div align="left">
          <input name="carport_cartype" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text"></div></td>
        </tr>
      <tr>
        <td class="STYLE1" height="35" nowrap="nowrap" width="142"><div align="left">车位面积</div></td>
        <td class="STYLE1" colspan="3" height="35"><div align="left">
          <input name="carport_area" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text"></div></td>
      </tr>
      <tr>
