...
$(function()
{
	...
	{	
		...
		{	
			url="user_select?username="+billId;
			//alert(url);
	...
	$("#add").click(function()
	{
		window.location.href ="user_getUser" ;
	})
})
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"><font color="#010E21" size='3'>账户信息清单</font></span></td>      
              </tr>
            </table>
            </td>
            <td>
			<form action="user_selectlike.action" method="get">
            ...
            <div align="right"><span class="STYLE1">  
              ...
              <a  href="user.jsp" target="mFrame">添加</a>  &nbsp; 
  ...
  <tr>
    <td>
    <form action="f5user_delete" method="get" id="formsubmit">
    <table id="infomation" width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
      ...
      <tr>
        <td width="4%" height="20" bgcolor="d3eaef" class="STYLE10"><div align="center">
          <input type="checkbox" name="checkbox" value='<s:property value="username"/>' />
        </div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10"><s:property value="username"></s:property></span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10"><s:property value="password"></s:property></span></div></td>
      </tr>      
      </s:iterator>
