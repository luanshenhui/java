...
<body>
<form action="f5user_update.action" method="get">
    ...
    <td class="STYLE1" colspan="4" bgcolor="#FFFFFF"><table align="center" border="0" cellpadding="0" cellspacing="0" width="70%">
      <tbody><tr>
        ...
        <td class="STYLE1" height="35" width="352"><div align="left">
          <input name="username" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text" value="${username}" readonly></div></td>
      ...
      <tr>
        ...
        <td class="STYLE1" colspan="3" height="35"><div align="left">
          <input name="password"  style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text" value="${password}"></div></td>
        </tr>
      <tr>
