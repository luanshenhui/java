...
<body>
<form action="f5pay_update.action" method="get">
    ...
    <td class="STYLE1" colspan="4" bgcolor="#FFFFFF"><table align="center" border="0" cellpadding="0" cellspacing="0" width="70%">
      <tbody><tr>
        ...
        <td class="STYLE1" height="35" width="352"><div align="left">
          <input name="pay_id" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text" value="${pay_id}" readonly></div></td>
      ...
      <tr>
       ...
       <select name="pay_feeid">
          	<s:iterator value="feeIdList" id="com">
				<option value='<s:property value="com"/>'><s:property value="com"/>
				</option>
			</s:iterator>
		</select>
      ...
      <tr>
        <td class="STYLE1" height="35" nowrap="nowrap" width="142"><div align="left"></div>支付数目</td>
        <td class="STYLE1" colspan="3" height="35"><div align="left">
          <input name="pay_number" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text" value="${pay_number}"></div></td>
        </tr>
      <tr>
        <td class="STYLE1" height="35" nowrap="nowrap" width="142"><div align="left">支付时间</div></td>
        <td class="STYLE1" colspan="3" height="35"><div align="left">
          <input name="pay_date" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text" value="${pay_date}"></div></td>
      </tr>
      <tr>
        <td class="STYLE1" height="35" nowrap="nowrap" width="142"><div align="left">欠费数目</div></td>
        <td class="STYLE1" colspan="3" height="35"><div align="left">
          <input name="pay_overdue" style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " type="text" value="${pay_overdue}"></div></td>
