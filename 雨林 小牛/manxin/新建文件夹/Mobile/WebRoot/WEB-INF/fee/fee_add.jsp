        ...
        <div id="main">            
            ...
            <form action="Add" method="post" class="main_form">
                ...
                <div class="input_info">
                    <input name="name" type="text" class="width300" value="" id="costName"/>
                ...
                <div class="input_info">
                    <input name="base_duration" type="text" value="" class="width100" />
                ...
                <div class="input_info">
                    <input name="unit_cost" type="text" value="" class="width100" />
                ...
                <div class="input_info">
                    <input name="base_cost" type="text" value="" class="width100" />
