...
<html>
	...
	<div class="head_container">
		<div class="head_welcome">
			...
			<div class="head_welcome_right">
				...
				<div class="cart gray4012">
					...
					<form action="serach.do" method="post">
						<input name="key" style="width: 90px" id="key" value="请输入关键字" onclick="kong(id);" onblur="hui(id);"/>
						<input name="min" style="width: 60px" id="min" value="最低价格" onclick="kong(id);"
						 onblur="hui(id);"/>~
						 <input name="max" style="width: 60px" id="max" value="最高价格" onclick="kong(id);"
						 onblur="hui(id);"/>
			...
			[&nbsp;<a href="exit.do" class="b">登出</a>&nbsp;]
			[&nbsp;<a href="#" class="b">${user.nickname}</a>&nbsp;]
			</c:when>
			<c:otherwise>
			[&nbsp;<a href="../user/login_form.jsp" class="b">登录</a>|<a
				href="../user/register_form.jsp" class="b">注册</a>&nbsp;]</c:otherwise>
				</c:choose>
			</span>
		</div>
