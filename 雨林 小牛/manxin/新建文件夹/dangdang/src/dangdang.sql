...
CREATE TABLE d_book (
  id int(12) NOT NULL,
  author varchar(200) NOT NULL,      --书籍作者
  publishing varchar(200) NOT NULL,   --地球出版社    
  publish_time bigint(20) NOT NULL,   --出版时间
  word_number varchar(15) default NULL,  --字数
  which_edtion varchar(15) default NULL, --版次
  total_page varchar(15) default NULL,  --总页数
  print_time int(20) default NULL,      --印刷时间
  print_number varchar(15) default NULL, --印次
  isbn varchar(25) default NULL,    --书籍编号
  author_summary text NOT NULL,     --作者简介
  catalogue text NOT NULL,          --目录
  PRIMARY KEY  (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE d_item (
  id int(12) NOT NULL auto_increment,
  order_id int(10) NOT NULL,         --订单
  product_id int(10) NOT NULL,       --产品
  product_name varchar(100) NOT NULL, --产品名字
  dang_price double NOT NULL,         --当当价格
  product_num int(10) NOT NULL,      --购买产品数量
  amount double NOT NULL,             --小计
  PRIMARY KEY  (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE d_order (
  ...
  user_id int(10) NOT NULL,       --用户
  status int(10) NOT NULL,        -- 用户状态
  order_time bigint(20) NOT NULL, --订单时间
  order_desc varchar(100) default NULL,  --订单描述
  total_price double NOT NULL,    --总价
 
  receive_name varchar(100) default NULL, --送货名字
  full_address varchar(200) default NULL,  --送货地址
...
CREATE TABLE d_receive_address (
  ...
  receive_name varchar(20) NOT NULL,    --送货人
  full_address varchar(200) NOT NULL,   --送货地址
  postal_code varchar(8) NOT NULL,      --邮政编号
...
CREATE TABLE d_user (
  ...
  UNIQUE KEY email (email)
	...
	select * from d_product where id in (select product_id from d_category_product where cat_id = 9
	) limit 0, 5;

select * from d_product p join d_book b on p.id=b.id where p.product_name='上课头疼的故事';
