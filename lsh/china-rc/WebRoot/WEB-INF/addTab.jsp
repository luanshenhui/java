        ...
        <table class="margin-cxjg_table" border="0" cellspacing="0" cellpadding="0">
            <tr class="thead">
                ...
                <td width="20%" height="90" align="center"><input class="required" name="tel" id="tel"/></td>
  				<td>学历</td>
				<td width="20%" height="90" align="center"><input  name="xl"  id="xl"/></td>
            </tr>
            <tr>
                <td>中间电话</td>
				<td width="8%" height="90" align="center"><input name="midetel" id="midetel"/></td>
				<td>姓名</td>
				<td width="8%" height="90" align="center"><input id="name"/></td>
			</tr>
            <tr>
                <td>生日</td>
				<td width="8%" height="90" align="center"><input class="required" name="borth" id="borth"/></td>
                <td>住址</td>
				<td width="8%" height="90" align="center"><input id="city"/></td>
            </tr>
              <tr>
                <td>户口</td>
				<td width="8%" height="90" align="center"><input  name="borth" id="hukou"/></td>
                <td>中间姓名</td>
				<td width="8%" height="90" align="center"><input id="personName"/></td>
            </tr>
        </table>
