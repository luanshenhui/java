...
public class LoginController extends  AbstractController{
	...
	public Map<String, Object> login(HttpServletRequest request,ManagerDomain m){
		...
		/************************** 调用存储过程*****************************************/
		//		调用存储过程
//		AreaDomain ad=new AreaDomain();
//		ad.setId(2);
//		List<AreaDomain> callList=loginService.getCallList(ad);
//		System.err.println(callList);
		/**************************调用存储过程*****************************************/
		
		/**************************主键回填*****************************************/
		//		主键回填
//		RolePersonDomain g=new RolePersonDomain();
//		loginService.insertGroup2(g);
		/**************************主键回填*****************************************/
		
		/**************************oracle 测试*****************************************/
//		List<LshTable> LshTableList=loginService.getLshTableList(new LshTable());
		/**************************oracle 测试*****************************************/
		try {
