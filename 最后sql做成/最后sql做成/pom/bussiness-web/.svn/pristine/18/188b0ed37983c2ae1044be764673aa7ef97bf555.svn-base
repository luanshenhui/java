	        ...
	        <div class="container-fluid">
	          ...
	          <div class="portlet-header">
	          	 <div class="caption"></div>
                     <div class="actions">
                     	  ${role.role_name} 
                          <a href="#" style="float: right;" class="btn btn-xs btn-danger" data-toggle="" data-target="" id="returnBack">
                              &nbsp;返回</a>&nbsp;
                     </div>
              </div>
	          </div>
	            ...
	            <div class="row">
							<div class="form-group">
								...
								<div class="col-lg-2 col-xs-2 col-sm-2 col-md-2">
                                   <img src="/image/${role.role_type}_c_a.png" alt="" class="img-responsive" style="width: 150px;height: 150px;">
                                  <label>${role.c_a}</label> 
								</div>
								...
								<div class="col-lg-2 col-xs-2 col-sm-2 col-md-2">
                                    <img src="/image/${role.role_type}_c_b.png" alt="" class="img-responsive" style="width: 150px;height: 150px;">
                                     <label>${role.c_b}</label> 
								</div>
								...
								<div class="col-lg-2 col-xs-2 col-sm-2 col-md-2">
                                   <img src="/image/${role.role_type}_c_c.png" alt="" class="img-responsive"  style="width: 150px;height: 150px;">
                                    <label>${role.c_c}</label> 
								</div>
								<label for="txtUserName" class="col-lg-1 col-xs-1 col-sm-1 col-md-1 control-label">
									<input type="radio" name="color" value="c_d">颜色4
								</label>
								<div class="col-lg-2 col-xs-2 col-sm-2 col-md-2">
                                   <img src="/image/${role.role_type}_c_d.png" alt="" class="img-responsive"  style="width: 150px;height: 150px;">
                                   <label>${role.c_d}</label> 
								</div>
							</div>
						</div>	
						<div class="portlet-header"></div>
						 <div class="row">
							<div class="form-group">
								...
								<div class="col-lg-2 col-xs-2 col-sm-2 col-md-2">
                                  <img src="/image/${role.role_type}_c_e.png" alt="" class="img-responsive"  style="width: 150px;height: 150px;">
                                  <label>${role.c_e}</label> 
								</div>
								...
								<div class="col-lg-4">
                                    <form id="from" action="/login/uploadimge.action" style="float: right;padding-top: 50px;" method="post" enctype="multipart/form-data">
										...
										<input type="hidden" id="roleType" name="roleType" value="${role.role_type}">
