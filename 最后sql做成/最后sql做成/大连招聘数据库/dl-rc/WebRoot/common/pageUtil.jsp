             ...
             <ul>
                 ...
                 <li>
                 	<%if(Integer.parseInt(currentPages)<=pageCount && Integer.parseInt(currentPages)>1) {%>
				       <a href="javascript:pageUtil('<%=Integer.parseInt(currentPages)-1 %>')">上页</a>
				    <%}
			          else { %>
				           上页
				    <%} %>
                 ...
                 <%
			    	   ...
			    	   for(int pg=p;pg<= (p+9>pageCount?pageCount:p+9);pg++) {
			               ...
			               %>
					           <li><a href="javascript:pageUtil('<%=pg %>')"><%=pg %></a></li>
				       <%
			               }
			           }
			     %>
                 ...
                 <li>
                 	<%if(Integer.parseInt(currentPages)<pageCount) {%>
			           <a href="javascript:pageUtil('<%=Integer.parseInt(currentPages)+1 %>')">下页</a>
			       <%}
		           else { %>
			             下页
			       <%}%>
                 ...
                 <li>
                 	<%if(Integer.parseInt(currentPages)!=pageCount && pageCount!=0) { %>
				       <a href="javascript:pageUtil('<%=pageCount %>')">尾页</a>
				   <%
		            }
		            else {
		           %>
