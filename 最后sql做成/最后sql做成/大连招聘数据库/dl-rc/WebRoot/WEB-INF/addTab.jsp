...
<body>
    <form method="post" action="" id="resForm">
        <table class="margin-cxjg_table" border="0" cellspacing="0" cellpadding="0" style="margin: 0px 40px 0px 40px">
            <tr class="thead">
             	<td>最终电话</td> 
                <td width="20%" height="60" align="center"><input  name="phone" id="phone"/></td>
  				<td>学历</td>
            ...
            <tr>
                ...
                <td>住址</td>
				<td width="20%" height="60" align="center"><input name="city" id="city"/></td>
            </tr>
            <tr>
                <td>职业</td>
				<td width="20%" height="60" align="center"><input  name="age" id="age"/></td>
                <td>中间姓名</td>
				<td width="20%" height="60" align="center"><input name="personName" id="personName"/></td>
            </tr>
              <tr>
                <td>个人信息</td>
				<td width="20%" height="60" align="center"><input  name="hukou" id="hukou"/></td>
                <td>内容</td>
				<td width="20%" height="60" align="center"><input  name="content" id="content"/></td>
            </tr>
        </table>
