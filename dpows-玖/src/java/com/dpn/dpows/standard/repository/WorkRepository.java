...
public class WorkRepository {
    ...
    public Integer getSizeWorkDeclareDto(Map<String,String> map) throws Exception{
        Integer num = (Integer)this.sqlSession.selectOne("SQL.TAB.WORK.getSizeWorkDeclareDto", map);
        if(null == num){
            num = new Integer(0);
        }
    ...
    public void updateWorkDeclareDto(WorkDeclareDto dto) throws Exception{
        this.sqlSession.update("SQL.TAB.WORK.updateWorkDeclareDto", dto);
    }


    public void updateWorkDeclareGoodsDto(WorkDeclareGoodsDto dto) throws Exception{
        this.sqlSession.update("SQL.TAB.WORK.updateWorkDeclareGoodsDto", dto);
    }
