...
$(document).ready(function(){	
	...
	menu.setImagePath(webpath+"/view/base/theme/css/redmond/dhtmlxtree/image/DhtxMenu/");
	menu.setIconsPath(webpath+"/view/base/theme/css/redmond/dhtmlxtree/image/MenuIcon/");
	...
	tree.setXMLAutoLoading(webpath+"/MenuAction.do?method=getElementsByMenuItemID&showAllMenu=true");
	tree.loadXML(webpath+"/MenuAction.do?method=getMenuTree&expandAll=&showAllMenu=true");
	...
	$("#menuDetail").validate({
		...
		messages: {
			menuName: {
				required : MENU_NAME_MANDATORY,
				byteRangeLength : MENU_NAME_LONG
			},				
			menuImg: {
				byteRangeLength : MENU_IMG_LONG
			},
			menuDes: {
				byteRangeLength : MENU_DESC_LONG
			},
			menuLocal: {
				byteRangeLength : MENU_URL_LONG
			}
		}
	});
	$("#pageDetail").validate({
		...
		messages: {
			pageId: {
				required : MENU_PAGE_ID_MANDATORY,
				byteRangeLength : MENU_PAGE_ID_LONG
			},	
			pageName: {
				required : MENU_NAME_MANDATORY,
				byteRangeLength : MENU_NAME_LONG
	...
	$("#elementDetail").validate({
		...
		messages: {
			eleId: {
				required : MENU_ELEMENT_ID_MANDATORY,
				byteRangeLength : MENU_ELEMENT_ID_LONG
			},	
			eleName: {
				required : MENU_ELEMENT_NAME_MANDATORY,
				byteRangeLength : MENU_ELEMENT_NAME_LONG
			},				
			eleImg: {
				byteRangeLength : MENU_IMG_LONG
			},
