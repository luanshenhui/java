...
function menuItemSelected(menuItem,url) {
    ...
    if (menuItemName != undefined && menuItemName != null && menuItemName != "") {
        ...
        if(menuName == ""){
            ...
            $("#breadcrumbL2").html(menuName+"&nbsp;&nbsp;<i class='fa fa-angle-right'>&nbsp;&nbsp;");
        }
        
//        $(".breadcrumb > .active2").html(menuName);
...
//		switch (menuItemName) {
//		case "店铺管理":
//			url = 'views/system/shop/shopList.html';
//			break;
//        case "项目管理":
//            url = 'views/project/projectList.html';
//            break;
//        case "平台订单":
//            url = 'views/ectrade/ecTradeList.html';
//            break;
//        case "分单规则":
//            url = 'views/system/split/splitRule.html';
//            break;
//        case "平台商品v4.1":
//            url = 'views/item/itemList.html';
//            break;
//        case "组织管理":
//        	url = 'views/system/organization/unit/UnitTree.html';
//        	break;
//        case "用户管理":
//        	url = 'views/system/organization/user/UserList.html';
//        	break;
//        case "管理授权":
//        	url = 'views/privilege/PrivilegeMain.html?isAdminRole=true';
//        	break;
//        case "业务授权":
//        	url = 'views/privilege/PrivilegeMain.html?isAdminRole=false';
//        	break;
//        case "角色管理":
//        	url = 'views/system/organization/role/RoleList.html';
////        	url = 'views/system/shop/shopList.html';
//        	break;
//        case "权限委托":
//        	url = 'views/delegate/DelegateList.html';
//        	break;
//        case "菜单管理":
//        	url = 'views/system/organization/menu/MenuMain.html';
//        	break;
//		default:
//
//		}
