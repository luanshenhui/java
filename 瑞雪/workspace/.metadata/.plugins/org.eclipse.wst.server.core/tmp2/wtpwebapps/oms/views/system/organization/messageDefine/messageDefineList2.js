	...
	// 初始化表格控件
        ...
        $("#searchForm").validate({
	        ...
	        messages : {
	            ...
	            retries : "重复从事不能为空，数字0~99999999999!",
...
//    });  
//    validator.resetForm();  
//    $('#NewsForm .state-error').removeClass('state-error');
//    $('#NewsForm .state-success').removeClass('state-success');
//} ||||||| .r499
