...
<head>
	...
	<script type="text/javascript" src="<%=webpath%>/view/workflow/report/processInstanceReport.js"></script>
</head>
<body style="margin: 10px;">
	<form method="post" >
		<div>
			<table  cellpadding="0" cellspacing="0"  >
				<tr>
			   		<td width=80px align="right"><span>流程分类</span></td>
			   		<td ><span style="color:red">&nbsp;*&nbsp;<span></td>
					<td>
						<select id="name" name="name" style="width:137px">
							<option value="">--请选择--</option>
							<ec:options items="bizCategoryMap"></ec:options>
						</select>
					</td>
	...
	<div style="margin-top: 10px;">
		<iframe id="report" width="100%" height="500" border="0px" frameborder="0"></iframe>
	</div>
</body>
</html>