...
public class LogisticsController extends ApolloController {
	...
	public Map<String, Object> getLgstList(String quickSearch, LogisticsVO lgst, String formJson,
		...
		try {
			...
			// 排序语句生成
			String orderStatement = getOrderString(LogisticsDAOImpl.class.getName(), PAGE_SELECT_STATEMENT,
					replaceFieldsMap);
	...
	public Map<String, Object> addLgst(@RequestBody LogisticsVO lgstVO) throws Exception {
		...
		try {
			...
			lgstVO3.setLgstCode(lgstVO.getLgstCode());
			...
			lgstVO2.setLgstName(lgstVO.getLgstName());
			List<LogisticsVO> lgstVOList = logisticsService.getLgstByCondition(lgstVO2);
			if(lgstVOList.size()>= 1){
				returnMap.put(JSON_RESULT, FAILED);
	...
	public Map<String, Object> getStorDetail(String lgstId) {
		Map<String, Object> returnMap = new HashMap<String, Object>();
		try{
			OMS_LGST lgstDetail = logisticsService.selectLgstDetail(lgstId);
