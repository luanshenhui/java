...
public class MessageDefineVo extends OMS_MESSAGE {
	...
	*/
	...
	private static final String OPERATION_BTN_ENABLE = "<button onclick=\"operationEnable(\'%s\',this)\" MessageID=\"%s\" type=\"button\" class=\"btn btn-success btn-xs\"><i class=\"fa fa-edit\"></i>&nbsp;启用</button>";
	private static final String OPERATION_BTN_UNENABLE = "<button onclick=\"operationEnable(\'%s\',this)\" MessageID=\"%s\" type=\"button\" class=\"btn btn-danger btn-xs\"><i class=\"fa fa-edit\"></i>&nbsp;停用</button>";
