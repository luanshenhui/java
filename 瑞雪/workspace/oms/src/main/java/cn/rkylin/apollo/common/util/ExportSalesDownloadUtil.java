...
public class ExportSalesDownloadUtil {
	 ...
	 * @throws Exception
	 */
	public HSSFWorkbook SalesExportExcel(HSSFWorkbook workbook,int sheetNum,List<Map<String, Object>> dataList,String[][] reportTitles,String sheetName) throws Exception {
		try {
			// 创建工作表实例
