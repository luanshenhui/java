...
public interface IUserDAO {
	...
	List getUserByUnitID(UnitVO unitVO) throws Exception;

	List getUserByIDs(WF_ORG_USER userVO) throws Exception;

    List findmaxPerson(WF_ORG_USER orgUser) throws Exception;
