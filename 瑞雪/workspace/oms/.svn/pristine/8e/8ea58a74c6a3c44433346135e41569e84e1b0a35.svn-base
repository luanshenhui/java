...
import cn.rkylin.core.enums.BaseResultEnum;
...
public class ApiExceptionHandler implements HandlerExceptionResolver {
	...
	public ModelAndView resolveException(HttpServletRequest request,
		...
		result.setStatus(BaseResultEnum.INSIDE_ERROR.getC());
		result.setMessage(BaseResultEnum.INSIDE_ERROR.getS());
		result.setResult(errorMap);
	...
	private Map<String, String> createFriendlyErrMsg(Throwable throwable) {
		...
		if (throwable instanceof NumberFormatException) {
			...
			if (throwable instanceof BusinessException) {
				...
				errorMap.put("statusCode", be.getErrorCode());
