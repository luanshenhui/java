...
public class XMLMapperBuilder extends BaseBuilder {
  ...
  private void configurationElement(XNode context) {
    try {
      ...
      buildStatementFromContext(context.evalNodes("select|insert|update|delete|enums|api"));
    } catch (Exception e) {
      throw new RuntimeException("Error parsing Mapper XML. Cause: " + e, e);
    }
  }

  private void buildStatementFromContext(List<XNode> list) throws Exception {
  ...
  private void buildStatementFromContext(List<XNode> list, String requiredDatabaseId) throws Exception {
  ...
  private void parsePendingStatements() throws Exception {
