...
public interface IDictService {
	...
	PageInfo<DictVO> findByWhere(int page, int length, DictVO param) throws Exception;
	...
	List getParamDictByCode(OMS_DICT oms_DICT) throws Exception;
	
	List getDictTypeList(OMS_DICT oms_DICT) throws Exception;
