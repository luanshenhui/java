...
<div class="page-content">
                    ...
                    <div class="portlet box portlet-blue" style="margin-bottom: 15px;">
                        ...
                        <div class="portlet-body">
                            <table id="logTable" class="table table-hover table-striped table-bordered table-advanced tb-sticky-header"
                                ...
                                <thead>
                                    <tr>
                                        <th id="ths" width="10%" colValue="person_id">组编号</th>
                                        <th width="8%" colValue="num">人数</th>
                                        <th width="8%" colValue="c_a">光环颜色1</th>
                                        <th width="8%" colValue="c_b">光环颜色2</th>
                                        <th width="12%" colValue="c_c">光环颜色3</th>
                                        <th width="15%" colValue="c_d">光环颜色4</th>
    ...
    jQuery(document).ready(function(){
    	...
    	logTable = $('#logTable').DataTable({
            ...
            "deferRender": true,
            "ajax": {
                "url": "/login/groupListView.action?provinceid="+provinceid,
            },
    	...
    	$("#download").click(function () {
    		window.location.href='groupDownload.action?provinceid='+provinceid;
    	});
    	
    	 $('#logTable tbody').on('click','td',function () {
    		 var groupId=$(this).parent().children().eq(0).text();
    		 window.location.href='userList.action?groupId='+groupId;
    	 })
