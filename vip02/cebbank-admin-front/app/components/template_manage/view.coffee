...
newShopTemplate = App.templates.template_manage.templates.shop_template_update
editShopTemplate = App.templates.template_manage.templates._shop_template_item
