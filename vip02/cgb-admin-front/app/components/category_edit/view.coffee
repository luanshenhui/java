...
attrValueUpdateTemplate = App.templates["attribute_value_update"]
attrValueViewTemplate = App.templates["attribute_value_view"]
spuPropertiesViewTemplate = App.templates["spu_properties_view"]
attrValueItemTemplate = App.templates["_attribute_value_item"]
spuNewTemplate = App.templates["createSPU"]
attrCreateTemplate = App.templates["attribute_create"]
categoryKeyTemplate = App.templates["_back_category_key"]
spuItemTemplate = App.templates["_spu_item"]
class cateGoryEdit
