...
brandViewTemp = App.templates["pointBrands_authorize_view"]
brandEditTemp = App.templates["pointBrands_authorize_edit"]
        ...
        success: (datas)->
          if datas.data?
            if datas.data.brandInforStatus is "02"
              ...
              $.ajax
                url: Store.context + "/api/admin/pointsAuthorize/audit"
                type: "POST"
                data: data
                success: (data)->
