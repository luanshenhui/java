...
spuTemplate = App.templates["spu_properties"]
skuTemplate = App.templates["sku_properties"]
singleColumnTableTemplate = App.templates["single_column_table"]
tableTemplate = App.templates["table"]
