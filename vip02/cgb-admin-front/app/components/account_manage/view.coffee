...
accountNewTemplate = App.templates["account_add"]
accountAssignTemplate = App.templates["account_assign_role"]
checkAccountTemplate = App.templates["check_account"]
passwordEditTemplate = App.templates["password_edit"]
accountViewTemplate = App.templates["account_view"]
passWordTemplate = App.templates["password"]
