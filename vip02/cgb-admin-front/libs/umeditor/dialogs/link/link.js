(function(){
    ...
    UM.registerWidget('link', {
        ...
        ".edui-dialog-link .edui-link-table{font-size: 12px;margin: 10px;line-height: 30px;width: 388px!important;}" +
        ".edui-dialog-link .edui-link-txt{width:282px;height:25px;line-height:25px;border:1px solid #d7d7d7;padding: 0!important;}" +
        "#edui-link-Jtarget{margin-top:9px}"+
        "</style>" +
        "<table class=\"edui-link-table\">" +
        "<tr>" +
        "<td width=\"22%\"><label for=\"href\"><%=lang_input_url%></label></td>" +
        "<td><input class=\"edui-link-txt\" id=\"edui-link-Jhref\" type=\"text\" /></td>" +
        "</tr>" +
        "<tr>" +
        "<td width=\"22%\"><label for=\"title\"><%=lang_input_title%></label></td>" +
        ...
        "</tr>" +
        "<tr>" +
        "<td colspan=\"2\" id=\"edui-link-Jmsg\"><span  class=\"font-color-red\">若您输入的超链接中不包含http等协议名称，默认将为您添加http://前缀</span></td>" +
        "</tr>" +
        "</table>",
