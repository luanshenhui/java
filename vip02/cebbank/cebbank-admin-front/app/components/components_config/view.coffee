...
class componentConfig
  ...
  constructor: ->
    ...
    @bindEvent()
  componentTemplate = App.templates.components_config.templates["component_new"]
  componentItemTemplate = App.templates.components_config.templates["_component_item"]
  that = this
