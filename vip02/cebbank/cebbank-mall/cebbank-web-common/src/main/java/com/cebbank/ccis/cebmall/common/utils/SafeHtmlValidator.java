package com.cebbank.ccis.cebmall.common.utils;
...
public class SafeHtmlValidator {
	 ...
	 * html元素上的事件
	 */
	private static final Set<String> TAGS_EVENTS_SETS = Sets.newHashSet("onabort", "onblur", "onhelp", "onchange",
			"onclick", "ondbclick", "onerror", "onfocus", "onkeydown", "onkeypress", "onkeyup", "onload", "onmousedown",
			"onmousemove", "onmouseout", "onmouseover", "onmouseup", "onreset", "onresize", "onselect", "onsubmit",
			"onunload");

	/**
	 * 检查html中是否含有script标签脚本 true: 有script, false: 无script
	 */
	...
	/**
	 * 检查html元素上是否有监听事件 true: 有监听事件, false: 无监听事件
	 */
	...
	/**
	 * 检查html内容是否有script或监听事件 包含脚本或事件，返回true, 否则返回false
	 */
