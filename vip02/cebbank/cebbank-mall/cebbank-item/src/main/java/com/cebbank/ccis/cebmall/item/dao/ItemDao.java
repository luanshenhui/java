package com.cebbank.ccis.cebmall.item.dao;
...
public class ItemDao extends SqlSessionDaoSupport {
	 ...
	 * @return
	 */
	public Integer insertBatchPresent(List itemList) {
		return getSqlSession().insert("Item.insertBatchPresent", itemList);
	}
	 ...
	 * 根据goodsCode删除单品
	 *
	 * @param params 商品ID,修改人
	 * @return Integer
	 */
	public Integer deleteByGoodsCode(Map<String, Object> params) {
		return getSqlSession().update("Item.deleteByGoodsCode", params);
	}
