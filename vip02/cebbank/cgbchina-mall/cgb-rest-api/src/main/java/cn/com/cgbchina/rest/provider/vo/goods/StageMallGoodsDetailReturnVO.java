 ...
 */
public class StageMallGoodsDetailReturnVO extends BaseEntityVO implements Serializable {
	...
	@XMLNodeName(value = "goods_base_desc")
	...
	public List<StageMallGoodsDetailStageInfoVO> getStageMallGoodsDetailStageInfos() {
		return stageMallGoodsDetailStageInfos;
	}

	public void setStageMallGoodsDetailStageInfos(
			List<StageMallGoodsDetailStageInfoVO> stageMallGoodsDetailStageInfos) {
		this.stageMallGoodsDetailStageInfos = stageMallGoodsDetailStageInfos;
	}

	public List<StageMallGoodsDetailPrivilegeInfoVO> getStageMallGoodsDetailPrivilegeInfos() {
		return stageMallGoodsDetailPrivilegeInfos;
	}

	public void setStageMallGoodsDetailPrivilegeInfos(
			List<StageMallGoodsDetailPrivilegeInfoVO> stageMallGoodsDetailPrivilegeInfos) {
