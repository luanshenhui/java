 ...
 */
public class StageMallGoodsDetailByAppInfo extends BaseEntity implements Serializable {
	...
	private List<StageMallGoodsDetailAttrInfoByApp> attrInfos = new ArrayList<StageMallGoodsDetailAttrInfoByApp>();
	private List<StageMallGoodsDetailStageInfoByApp> stageInfos = new ArrayList<StageMallGoodsDetailStageInfoByApp>();
	private List<StageMallGoodsDetailPrivilegeInfoByApp> privilegeInfos = new ArrayList<StageMallGoodsDetailPrivilegeInfoByApp>();
	...
	public List<StageMallGoodsDetailAttrInfoByApp> getAttrInfos() {
		return attrInfos;
	}

	public void setAttrInfos(List<StageMallGoodsDetailAttrInfoByApp> attrInfos) {
		this.attrInfos = attrInfos;
	}

	public List<StageMallGoodsDetailStageInfoByApp> getStageInfos() {
		return stageInfos;
	}

	public void setStageInfos(List<StageMallGoodsDetailStageInfoByApp> stageInfos) {
		this.stageInfos = stageInfos;
	}

	public List<StageMallGoodsDetailPrivilegeInfoByApp> getPrivilegeInfos() {
		return privilegeInfos;
	}

	public void setPrivilegeInfos(List<StageMallGoodsDetailPrivilegeInfoByApp> privilegeInfos) {
