...
import cn.com.cgbchina.rest.provider.vo.goods.StageMallGoodsDetailByAPPGoodsInfoVO;
/**
 * MAL313	商品详细信息(分期商城) App
 * @author lizy
 *         2016/4/28.
 */
public class StageMallGoodsDetailByAPP implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 2450611811456865216L;
	...
	private List<StageMallGoodsDetailByAPPStageInfo> stageInfo =new ArrayList<StageMallGoodsDetailByAPPStageInfo>();
	private List<StageMallGoodsDetailByAPPPrivilegeInfo> privilegeInfo = new ArrayList<StageMallGoodsDetailByAPPPrivilegeInfo>();
	private List<StageMallGoodsDetailByAPPGoodsInfo> goodsInfo = new ArrayList<StageMallGoodsDetailByAPPGoodsInfo>();
	private List<StageMallGoodsDetailByAPPBackLogInfo> backlogInfo = new ArrayList<StageMallGoodsDetailByAPPBackLogInfo>();
	
	public List<StageMallGoodsDetailByAPPBackLogInfo> getBacklogInfo() {
		return backlogInfo;
	}
	public void setBacklogInfo(List<StageMallGoodsDetailByAPPBackLogInfo> backlogInfo) {
		this.backlogInfo = backlogInfo;
	}
	public List<StageMallGoodsDetailByAPPGoodsInfo> getGoodsInfo() {
		return goodsInfo;
	}
	public void setGoodsInfo(List<StageMallGoodsDetailByAPPGoodsInfo> goodsInfo) {
	...
	public List<StageMallGoodsDetailByAPPStageInfo> getStageInfo() {
		return stageInfo;
	}
	public void setStageInfo(List<StageMallGoodsDetailByAPPStageInfo> stageInfo) {
		this.stageInfo = stageInfo;
	}
	public List<StageMallGoodsDetailByAPPPrivilegeInfo> getPrivilegeInfo() {
		return privilegeInfo;
	}
	public void setPrivilegeInfo(List<StageMallGoodsDetailByAPPPrivilegeInfo> privilegeInfo) {
