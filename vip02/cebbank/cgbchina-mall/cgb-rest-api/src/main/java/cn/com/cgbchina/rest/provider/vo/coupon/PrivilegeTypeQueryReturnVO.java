 ...
 */
public class PrivilegeTypeQueryReturnVO extends BaseEntityVO implements Serializable {
	private static final long serialVersionUID = -6345689147519711885L;
	private String projectNO;
	private String projectNM;
	@XMLNodeName(value = "type_ids")
	private String typeIds;
	@XMLNodeName(value = "type_pids")
	private String typePids;
	@XMLNodeName(value = "type_nms")
	private String typeNms;
	@XMLNodeName(value = "vendor_ids")
	private String vendorIds;
	@XMLNodeName(value = "vendor_nms")
