 ...
 */
public class PreferentialPriceRetrunVO extends BaseEntityVO implements Serializable {
	...
	@XMLNodeName(value = "goodsPaywaId_bir")
	private String goodsPaywaIdBir;
	@XMLNodeName(value = "goods_point_bir")
	private String goodsPointBir;
	@XMLNodeName(value = "goodsPaywaId_jm")
	private String goodsPaywaIdJm;
	@XMLNodeName(value = "goods_point_jm")
	private String goodsPointJm;
	@XMLNodeName(value = "goods_price_jm")
