...
public class ItemIndexServiceImpl implements ItemIndexService {
    ...
    public void fullItemIndex() {
        try {
            log.debug("Elasticsearch: Start-Add full item index");
            itemBatchIndexer.fullItemIndex();
            log.debug("Elasticsearch: End-Add full item index");
    ...
    public Response<Boolean> deleteAllIndex() {
        ...
        try {
            itemBatchIndexer.deleteAllIndex();
            result.setResult(Boolean.TRUE);
        } catch (Exception e) {
            log.error("failed to deleteAllIndex", e);
    ...
    public void deltaItemIndex(String itemId) {
        try {
            log.debug("Elasticsearch: Start-Add item index");
            itemBatchIndexer.deltaItemIndex(itemId);
            log.debug("Elasticsearch: End-Add item index");
        } catch (Exception e) {
    ...
    public void deleteItemIndex(String itemId) {
        try {
            log.debug("Elasticsearch: Start-Delete item index");
            itemBatchIndexer.deleteItemIndex(itemId);
            log.debug("Elasticsearch: End-Delete item index");
        } catch (Exception e) {
            log.error("failed to deleteItemIndex", e);
        }
    }
}
