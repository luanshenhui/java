...
public class GoodsBrandModel implements Serializable {
	...
	@Getter
	@Setter
	private String brandState;// 是否首页显示
	@Getter
	@Setter
	...
	public int hashCode() {
		return Objects.hashCode(id, ordertypeId, goodsBrand, brandName, brandSeq, brandState, brandImage, brandDesc,
				...
				brandInforStatus, approverId, approveMemo, approveDiff);
	}

	@Override
	public String toString() {
		return Objects.toStringHelper(this).add("id", id).add("ordertypeId", ordertypeId).add("goodsBrand", goodsBrand)
				...
				.add("approveMemo", approveMemo).add("approveDiff", approveDiff).toString();
	}
}