...
public class AuthInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if(requestURI.startsWith("/design/")) {
			if(user == null){
				redirectToCmsLogin(request, response);
			}
	...
	private void redirectToCmsLogin(HttpServletRequest request, HttpServletResponse response) throws IOException{
