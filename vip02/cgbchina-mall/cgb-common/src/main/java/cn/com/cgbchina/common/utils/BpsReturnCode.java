...
public class BpsReturnCode {
    ...
    private static String errorCodeDealing = "04";

    private static String approveResultSucess[] = {"0000", "0010"};// approveResult为支付成功的

    private static String approveResultDealing[] = {"0200", "0210", "04"};// approveResult为处理中
    ...
    public static boolean isBp0005Dealing(String errorCode, String approveResult) {
        boolean falg = false;
        if(errorCodeDealing.equals(errorCode.trim())){
        	return true;
        }
