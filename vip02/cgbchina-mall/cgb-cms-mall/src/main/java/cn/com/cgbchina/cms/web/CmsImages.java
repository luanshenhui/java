...
import cn.com.cgbchina.user.service.ImageService;
import cn.com.cgbchina.web.view.UploadedFile;
...
public class CmsImages {
	...
	@ResponseBody
	public boolean deleteImage(@PathVariable("imageId") Long imageId) {
