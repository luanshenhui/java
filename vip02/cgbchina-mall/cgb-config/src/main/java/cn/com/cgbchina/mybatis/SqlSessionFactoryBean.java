package cn.com.cgbchina.mybatis;
...
public class SqlSessionFactoryBean
	...
	protected SqlSessionFactory buildSqlSessionFactory() throws IOException {
		...
		Document document = this.getMappedConfiguration();
	...
	/**
	 * merge mybatis-config.xml
	 */
	private Document getMappedConfiguration() {
	...
	private void readXML(Resource configXML, final Element elementTypeAlias, final Element elementMapper) {
