...
public class GoodsBrandDao extends SqlSessionDaoSupport {
	...
	public List<GoodsBrandModel> findAllForItemSearch(){
		return getSqlSession().selectList("GoodsBrandModel.findAllForItemSearch");
	}
	...
	public List<Long> findBrandIdListByName(String brandName) {
		return getSqlSession().selectList("GoodsBrandModel.findBrandIdListByName", EscapeUtil.allLikeStr(brandName));
	}
	...
	/**
	 * 根据goodsBrand更新（品牌广告详细页用）
	 *
	 * @param goodsBrandModel
	 * @return
	 */
	public Integer updateByGoodsBrand(GoodsBrandModel goodsBrandModel) {
		return getSqlSession().update("GoodsBrandModel.updateByGoodsBrand", goodsBrandModel);
	}

	/**
	 * 更新品牌分类名
	 */
	public Integer updateBrandCategory(GoodsBrandModel goodsBrandModel) {
		return getSqlSession().update("GoodsBrandModel.updateBrandCategory", goodsBrandModel);
	}
