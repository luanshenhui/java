...
public class BrandAuthorizeDao extends SqlSessionDaoSupport {
	 ...
	 * @param orderType YG广发商城 JF积分商城
	 * @return
	 */
	public Long findIsAuthroizeByName(String brandName, String orderType) {
	 ...
	 *查询品牌授权数量
	 */
	public Long findBrandAuthorizeCount(Map<String, Object> params){
		Long total = getSqlSession().selectOne("BrandAuthorizeModel.count", params);
		return total;
	}

	public Long checkBrandAuthorize(Map<String,Object> params){
		return getSqlSession().selectOne("BrandAuthorizeModel.checkBrandAuthorize",params);
	}
	public List<String> findVendorIdsByBrandId(Integer goods_brand_id,String channel,Boolean editFlag){
		return getSqlSession().selectList("BrandAuthorizeModel.findVendorIdsByBrandId", ImmutableMap.of("ordertypeId",channel,"goodsBrandId",goods_brand_id,"editFlag",editFlag));
	}
