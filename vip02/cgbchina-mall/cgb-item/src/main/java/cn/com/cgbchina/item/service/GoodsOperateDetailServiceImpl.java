...
public class GoodsOperateDetailServiceImpl implements GoodsOperateDetailService {
    ...
    public Response<Boolean> createGoodsOperate(GoodsOperateDetailModel goodsOperateDetailModel) {
        ...
        try {
            ...
            Response<BackCategory> backCategory1Response = backCategoryService.findById(goodsOperateDetailModel.getBackCategory1Id());
            ...
            Response<BackCategory> backCategory2Response = backCategoryService.findById(goodsOperateDetailModel.getBackCategory2Id());
            ...
            Response<BackCategory> backCategory3Response = backCategoryService.findById(goodsOperateDetailModel.getBackCategory3Id());
