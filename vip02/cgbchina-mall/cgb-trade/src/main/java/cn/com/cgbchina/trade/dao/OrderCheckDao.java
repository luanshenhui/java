...
public class OrderCheckDao extends SqlSessionDaoSupport {
    ...
    public List<OrderCheckModel> findOrderChecks(String create_date) {
        return getSqlSession().selectList("OrderCheckModel.findOrderChecks", create_date);
    }
    public List<OrderCheckModel> findOrderChecks1(String create_date) {
        return getSqlSession().selectList("OrderCheckModel.findOrderChecks1", create_date);
    }
    public Integer updatePoint(Map<String, Object> params) {
        return getSqlSession().update("OrderCheckModel.updatePoint", params);
    }
    public Integer updatePoint1(Map<String, Object> params) {
        return getSqlSession().update("OrderCheckModel.updatePoint1", params);
    }
    public List<OrderCheckModel> findDoDate() {
        return getSqlSession().selectList("OrderCheckModel.findDoDate");
    }
}