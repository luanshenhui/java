...
public class TblOrderDao2 extends SqlSessionDaoSupport {
	...
	public List<OrderQueryModel> findSubOrderNum(List<String> orderMainIds) {
		if(orderMainIds!=null&&orderMainIds.size()>0){
			return getSqlSession().selectList("OrderSub.findSubOrderNum", orderMainIds);
		}
		return null;
	}
}
