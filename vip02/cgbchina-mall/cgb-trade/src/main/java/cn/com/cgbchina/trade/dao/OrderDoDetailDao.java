...
public class OrderDoDetailDao extends SqlSessionDaoSupport {
	...
	public List<OrderDoDetailModel> findByOrderStatusId(String orderId) {
		return getSqlSession().selectList("OrderDoDetail.findByOrderStatusId", orderId);
	}

	public OrderDoDetailModel findByStatusAndOrderId(String orderId) {
		return getSqlSession().selectOne("OrderDoDetail.findByStatusAndOrderId",orderId);
	}

	public List<OrderDoDetailModel> findByOrderIds(List<String> orderIds) {
		return getSqlSession().selectList("OrderDoDetail.findByOrderIds", orderIds);
	}
}