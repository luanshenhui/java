...
public class EspPublishInfDto implements Serializable {

	private static final long serialVersionUID = 1003495630283175L;
	@Getter
	@Setter
	private Long id;//
	@Getter
	...
	@Getter
	@Setter
	private String publishTypeName;// 公告类型名称
	@Getter
	@Setter
	private String curStatusName;// 发布状态名称
}