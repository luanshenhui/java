 ...
 */
public class MyIntergalPresents implements Serializable {
	private static final long serialVersionUID = -5727879197570351996L;
	private String goodsId;// 礼品id
	private String goodsXid;// 礼品编码 显示给用户看的
	private String goodsNm;// 礼品名称
	private String jpBonus;// 金普价积分
	private String vendorFnm;// 供应商全称
	private String pictureUrl;// 图片url
	private String goodsUrl;// 详细页面url
