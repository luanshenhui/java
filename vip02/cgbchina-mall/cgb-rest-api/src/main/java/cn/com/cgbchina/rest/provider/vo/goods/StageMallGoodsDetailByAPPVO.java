...
import cn.com.cgbchina.rest.provider.model.goods.StageMallGoodsDetailByAPPBackLogInfo;
import cn.com.cgbchina.rest.provider.model.goods.StageMallGoodsDetailByAPPPrivilegeInfo;
import cn.com.cgbchina.rest.provider.model.goods.StageMallGoodsDetailByAPPStageInfo;
/**
 * MAL313 商品详细信息(分期商城)
 * 
 * @author lizy 2016/4/28.
 */
public class StageMallGoodsDetailByAPPVO implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 139317245069691841L;
	...
	@XMLNodeName(value="area_code")
	private String areaCode;
	@XMLNodeName(value="jf_type")
	private String jfType;
	@XMLNodeName(value="jf_type_nm")
	...
	@XMLNodeName(value="goods_prop1")
	private String goodsProp1;
	@XMLNodeName(value="goods_prop2")
	private String goodsProp2;
	@XMLNodeName(value="market_price")
	private String marketPrice;
	@XMLNodeName(value="count_limit")
	private String countLimit;
	@XMLNodeName(value="wechat_status")
	private String wechatStatus;
	@XMLNodeName(value="wechat_a_status")
	...
	@XMLNodeName(value="app_status")
	private String appStatus;
	@XMLNodeName(value="act_id")
	private String actId;
	private List<StageMallGoodsDetailByAPPStageInfoVO> stageInfo =new ArrayList<StageMallGoodsDetailByAPPStageInfoVO>();
	private List<StageMallGoodsDetailByAPPPrivilegeInfoVO> privilegeInfo = new ArrayList<StageMallGoodsDetailByAPPPrivilegeInfoVO>();
	private List<StageMallGoodsDetailByAPPGoodsInfoVO> goodsInfo = new ArrayList<StageMallGoodsDetailByAPPGoodsInfoVO>();
	private List<StageMallGoodsDetailByAPPBackLogInfoVO> backlogInfo = new ArrayList<StageMallGoodsDetailByAPPBackLogInfoVO>();
	public List<StageMallGoodsDetailByAPPBackLogInfoVO> getBacklogInfo() {
		return backlogInfo;
	}
	public void setBacklogInfo(
			List<StageMallGoodsDetailByAPPBackLogInfoVO> backlogInfo) {
		this.backlogInfo = backlogInfo;
	}
	public List<StageMallGoodsDetailByAPPGoodsInfoVO> getGoodsInfo() {
		return goodsInfo;
	}
	public void setGoodsInfo(List<StageMallGoodsDetailByAPPGoodsInfoVO> goodsInfo) {
	...
	public List<StageMallGoodsDetailByAPPStageInfoVO> getStageInfo() {
		return stageInfo;
	}
	public void setStageInfo(List<StageMallGoodsDetailByAPPStageInfoVO> stageInfo) {
		this.stageInfo = stageInfo;
	}
	public List<StageMallGoodsDetailByAPPPrivilegeInfoVO> getPrivilegeInfo() {
		return privilegeInfo;
	}
	public void setPrivilegeInfo(List<StageMallGoodsDetailByAPPPrivilegeInfoVO> privilegeInfo) {
