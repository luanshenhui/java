 ...
 */
public class QueryPointsInfoResultVO implements Serializable {
	@XMLNodeName("card_no")
	private String cardNo;
	@XMLNodeName("card_end")
	private String cardEnd;
	private String jgId;
	private String jgtype;
	private BigDecimal account;
	private String status;
	@XMLNodeName("valid_date")
	private String validDate;
	@XMLNodeName("cust_summary")
	private String custSummary;
	@XMLNodeName("product_code")
	private String productCode;
	@XMLNodeName("card_desc")
	private String cardDesc;
	@XMLNodeName("cfpr_code")
	private String cfprCode;
	@XMLNodeName("prod_code")
	private String prodCode;
	@XMLNodeName("promotion_pgm")
	private String promotionPgm;
	@XMLNodeName("level_code")
