...
public interface OrderFQMainService {
	Response<OrderMainDto> checkCreateOrderArgumentAndGetInfos_new(
			OrderCommitSubmitDto orderCommitSubmitDto, UserAccount selectedCardInfo, User user);
	Response<PagePaymentReqDto> getReturnObjForPay_new(OrderMainModel orderMain, List<OrderSubModel> orderSubModelList);
}
