...
public interface BrandService {
	 ...
	 * @return
	 */
	public Response<Boolean> createGoodsBrandDetail(GoodsBrandAdvertiseDto model, User user);
	...
	/**
	 * 根据渠道获取品牌信息
	 * @param channel 渠道 （YG,广发商城 |　JF，积分商城）
	 * @return
	 */
    Response<List<GoodsBrandModel>> allBrandsByChannel(String channel);
