...
public class ItemSearchFactDto implements Serializable {
    ...
    @Getter
    @Setter
    private List<BrandPair> brands = Collections.emptyList();
    @Getter
    @Setter
    private List<BrandPair> allBrands = Collections.emptyList();
    @Getter
    @Setter
    private List<BrandPair> chosenBrands = Collections.emptyList();
    @Getter
    @Setter
