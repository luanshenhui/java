...
public class PromotionModel implements Serializable {
	...
	@Getter
	@Setter
	private String workStatus;// 活动进行状态（0:进行中 1:待开始 2:已结束）

	@Getter
	@Setter
	private Integer checkStatus;// (活动状态(添加(未提交审批) 0; 编辑(未提交审批) 1;待初审 2;已通过初审3;未通过初审 4;待复审 5;未通过复审 6;
	// 全部通过复审 7;部分通过复审8;正在进行9;已停止[活动执行过&结束时间小于当前时间]10;已取消11;已失效12;已删除13)
