...
public class BatchGenerateTestCase {
	 ...
	 * 单元测试需要继承的基类
	 */
	private static final String BASE_TEST_CASE_NAME = "cn.com.cgbchina.item.BaseTestCase";
	/**
	 * 要生成单元测试的service的包名,请写到impl一级
	 */
	private static final String PACKAGE_NAME = "cn.com.cgbchina.item.service";
