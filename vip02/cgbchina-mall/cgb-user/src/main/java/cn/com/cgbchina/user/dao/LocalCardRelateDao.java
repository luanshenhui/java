...
public class LocalCardRelateDao extends SqlSessionDaoSupport {
	 ...
	 * @return
	 */
	public List<LocalCardRelateModel> findLocalCardByParams(Map<String,Object> paramMap){
		return getSqlSession().selectList("LocalCardRelateModel.findLocalCardByParams", paramMap);
	}
}