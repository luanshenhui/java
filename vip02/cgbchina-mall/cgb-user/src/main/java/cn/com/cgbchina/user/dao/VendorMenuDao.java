...
public class VendorMenuDao extends SqlSessionDaoSupport {
	...
	public List<VendorMenuModel> findChildById(Map<String, Object> params) {
		return getSqlSession().selectList("VendorMenu.findChildById", params);
	}
	...
	public List<VendorMenuModel> getResourcesByNotOrderType(String shopType){
		return getSqlSession().selectList("VendorMenu.getResourcesByNotOrderType",shopType);
	}

	public List<Long> getLongResourcesByNotOrderType(String shopType){
		return getSqlSession().selectList("VendorMenu.getLongResourcesByNotOrderType",shopType);
	}
}