...
public class LocalProcode {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/detele/{id}", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping(value = "/findAllCardPro", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseBody
