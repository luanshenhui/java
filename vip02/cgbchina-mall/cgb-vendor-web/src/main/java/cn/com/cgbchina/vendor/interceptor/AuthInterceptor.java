...
import com.spirit.core.exception.UnAuthorize401Exception;
...
public class AuthInterceptor extends HandlerInterceptorAdapter {
    ...
    public AuthInterceptor(final String mainSite, final String context) throws Exception {
...
//            return true;
        ...
        if (!isProtect) {
            log.info("authInterceptor.request.url:{}", requestURI);
//            return true;
            throw new UnAuthorize401Exception("没有权限");
        }
        return false;
    }
