...
@ActiveProfiles("dev")
public class OpsOrderProgressSearchTest {
    @Autowired
    private OpsOrderProgressSearchService opsOrderProgressSearchService;

    @Test
    public void test1() {
        opsOrderProgressSearchService.sendOPSOrderToBPS();
    }
}
