 ...
 */
@Slf4j
public class CountHotVendorControl extends BaseControl {
    /**
     * 供应商热销商品统计
     * @param args
     */
    public static void main(String[] args) {
        CountHotVendorControl synControl = new CountHotVendorControl();
        synControl.setBatchName("供应商销量统计");
    ...
    protected Response execService() throws BatchException {
        ...
        return hotRankService.countHotVendor();
    }
}
