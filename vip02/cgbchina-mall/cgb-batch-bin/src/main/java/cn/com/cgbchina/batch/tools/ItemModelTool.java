...
@EqualsAndHashCode
@ToString
public class ItemModelTool implements Indexable {


	/**
	 * 
	 */
	private static final long serialVersionUID = -125569916858640171L;
	@Getter
	@Setter
	...
	@Getter
	@Setter
	private java.math.BigDecimal marketPrice;// 市场价格get
	@Getter
	@Setter
