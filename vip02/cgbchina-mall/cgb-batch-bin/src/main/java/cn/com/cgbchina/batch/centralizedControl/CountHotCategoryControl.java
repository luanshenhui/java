 ...
 */
@Slf4j
public class CountHotCategoryControl extends BaseControl {
    /**
     * 供应商热销商品统计
     * @param args
     */
    public static void main(String[] args) {
        CountHotCategoryControl synControl = new CountHotCategoryControl();
        synControl.setBatchName("热销品类统计");
    ...
    protected Response execService() throws BatchException {
        ...
        return hotRankService.countHotCategory();
    }
}
