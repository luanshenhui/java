 ...
 */
@Slf4j
public class CountVendorWeekSaleControl extends BaseControl {
    /**
     * 供应商热销商品统计
     * @param args
     */
    public static void main(String[] args) {
        CountVendorWeekSaleControl synControl = new CountVendorWeekSaleControl();
        synControl.setBatchName("供应商一周数据统计");
    ...
    protected Response execService() throws BatchException {
        ...
        return hotRankService.countVendorWeekSale();
    }
}
