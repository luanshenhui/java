...
public class OrderSubModel implements Serializable {
	...
	@Getter
	@Setter
	private Long id; // tbl_order_check中自增id
	@Getter
	@Setter
	private String serialNo;// 流水号(tbl_order_main)
	@Getter
	@Setter
	private String doDate;//操作日期 (tbl_order_check)
	@Getter
	@Setter
	private String doTime;//操作时间 (tbl_order_check)
	@Getter
	@Setter
	private String jfRefundSerialno;//积分退货流水号 (tbl_order_check)
	@Getter
	@Setter
