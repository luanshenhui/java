...
@Getter
@ToString
public class OrderStatusQueryModel extends BaseModel {
    private static final long serialVersionUID = -4057090091108613727L;
    ...
    //昨日日期E
    private String paramPrevDate;
    //年月日
    private String paramSubdate;
    //时分秒PSS
    private String paramSubtime;
    //订单种类
    private String paramOrdertypeId;
    private Integer isCancelNetbank;
