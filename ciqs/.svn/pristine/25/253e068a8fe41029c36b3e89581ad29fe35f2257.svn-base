...
<table width="100%" border="0" class="table-xqlb">
	  <tr>
    	...
    	<td align='left' style="padding-left:25px" id="jdnote">
		    <input type="hidden" id="yqdate" value="<fmt:formatDate value="${licenseeventdto2.opr_date}" type="both" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
		    <input type="hidden" id="yquser" value="${licenseeventdto2.opr_psn}"/>
    	操作时间 :	
		<span class='blue'>
