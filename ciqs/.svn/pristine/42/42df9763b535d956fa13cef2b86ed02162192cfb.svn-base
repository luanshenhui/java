...
<!--     <td height="25" align="left" valign="middle">抵/离境日期</td> -->
  ...
  <tr>
    ...
    <td width="200" height="50" align="left" valign="middle"><input name="cardNo" id="consignee_name" size="14"  value="${obj.cardNo}" class="search-input input-175px" /></td>
    <td width="200" height="50" align="left" valign="middle">
   ...
   <tr>
    ...
    <td height="25" align="left" valign="middle" >抵境日期</td>
    <td height="25" align="left" valign="middle" >离境日期</td>
  </tr>
  <tr>
    <td width="200" height="50" align="left" valign="middle" >
...
<!-- 			</c:if>  -->
   ...
   <td width="200" height="50" align="left" valign="middle">
     ...
     <td width="200" height="50" align="left" valign="middle" ><input name="enterExpDate_begin" type="text" id="enterExpDate_begin" class="search-input input-175px datepick " value="${obj.enterExpDate_begin}"/></td>
     <td width="200" height="50" align="left" valign="middle" ><input name="enterExpDate_over" type="text" id="enterExpDate_over" class="search-input input-175px datepick " value="${obj.enterExpDate_over}"/></td>
  </tr>
  <tr>
	<td></td>
	<td></td>
...
<div class="margin-cxjg">
    ...
    <c:if test="${not empty list }">
		<c:forEach items="${list}" var="row">
			<tr>
			  <td width="120" height="90" align="center" ><strong>${row.cardType}</strong> 
