...
<!-- 									</select> -->
							...
							<tr>
								...
								<td width="25%">
									<c:if test="${'0' == model.step_1_status || '0' == model.step_2_status}">
									...
									<c:if test="${'1' == model.step_2_status }">
										<a href='javascript:openNewPage("/ciqs/generalPunishment/toPage?id=${model.id}&step=1&page=gp_shexiananjian_sbd&update=update&subStep=0");'>查看</a>
									</c:if>
								</td>
								<th width="25%">
									附件：
