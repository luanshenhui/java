...
<%@ include file="/common/headMenu_Sys.jsp"%>
	<div class="dpn-content">
		...
		<div class="form">
			<div class="main">
				<form action="/ciqs/users/updateRes" method="post" id="resForm">
					<table id="form_table">
						<tbody>
							<tr>
								...
								<td width="25%">
									<input type="hidden" id="id" name="id" value="${resDto.id }"/>
									<input type="text" id="resname" value="${resDto.name }"
									name="resname" size="14" class="required text" />
									<p></p>
								</td>
								<th width="25%">
									<span class="need">*</span>资源描述：
								</th>
								<td width="25%">
									<input type="text" id="resdesc" name="resdesc" size="30"  class="text"  value="${resDto.res_desc }"/>
									<p></p>
								</td>
							</tr>
							<tr>
								...
								<td colspan="3" >
									<input type="text"
									id="resstring" name="resstring"  value="${resDto.res_string }"
