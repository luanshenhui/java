		...
		<c:forEach items="${list}" var="details" begin="0" end="0">
		 ...
		 <div class="margin-chx">
 		 <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table-xqlb">
		    ...
		    <tr class="table_xqlbnr">
		      <td height="90" align="center">${details.decl_no}</td>
		      <td height="90" align="center">${details.ciq_code}</td>
		      <td height="90" align="center">${details.cag_name}</td>
		      <td height="90" align="center"></td>
		      <td height="90" align="center">${details.enter_port}</td>
		      <td height="90" align="center">${details.enter_date}</td>
		      <td height="90" align="center"></td>
		      <td height="90" align="center"></td>
		    </tr>
		    <tr class="table_xqlbbj">
		    ...
		    <tr class="table_xqlbnr">
		      <td width="180" height="90" align="center">${details.ori_plc}</td>
		      <td width="150" height="90" align="center"></td>
		      <td width="150" height="90" align="center"></td>
		      <td width="150" height="90" align="center"></td>
		      <td width="150" height="90" align="center"></td>
		      <td width="150" height="90" align="center"></td>
		      <td width="150" height="90" align="center">${details.deal_meth}</td>
		      <td width="150" height="90" align="center"></td>
		    </tr>
		    <tr class="table_xqlbbj">
