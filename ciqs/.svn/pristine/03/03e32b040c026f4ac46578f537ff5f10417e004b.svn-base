...
/* 	   	var nowate =new Date();
	...
	$(function(){
		...
		if($("#employee_num").val() == ""){
            ...
            if($("#approval_users_name_hide2").val()!=null){
            	approval_users_name =$("#approval_users_name_hide2").val();
            }
...
<input type ="hidden" id="approval_users_name_hide2" value="${approval_users_name2}" />
	<div id="content">
    <table width="763" align="center">
        ...
        <tr>
          <td style="height:40px;text-align:left">申请分支机构：<input id="torg" style="text-align:left;padding-left:5px;width:150px" type ="text" value="${doc.option1}" name="option1"/></td>
          <td style="text-align:left">填报人：<input id="tuser" style="text-align:left;padding-left:5px;width:120px" type ="text" value="${doc.option2}" name="option2"/></td>
          <td style="text-align:left">日期：<input id="tdate" style="text-align:left;padding-left:5px;width:150px" type ="text" value="${doc.option3}" name="option3"/></td>
        </tr>
        <tr>
          <td style="height:40px;text-align:left" width="257">联系电话：
            <input style="text-align:left;padding-left:5px;width:120px;margin-left:24px;" type ="text" value="${doc.option4}" name="option4"/>
          </td>
          <td style="text-align:left" width="191">传  真：
          	<input style="text-align:left;width:120px;margin-left:2px;" type ="text" value="${doc.option5}" name="option5"/>
          </td>
    ...
    <table width="760"  border="0" align="center" style="font-size: 14px; line-height: 30px; text-align: left;" cellpadding="0" cellspacing="0"   class="tableLine">
      <tr>
        ...
        <td colspan="3" align="center" class="tableLine" style="text-align:left;padding-left:10px;">
        	<input id="comp_name" style="text-align:left;padding-left:5px;width:500px" type ="text" value="${doc.option6}" name="option6"/>
        </td>
      </tr>
      <tr>
         <td width="195" height="44" align="center" class="tableLine">单位地址</td>
         <td colspan="3" align="center" class="tableLine" style="text-align:left;padding-left:10px;">
           <input id="comp_addr" style="text-align:left;padding-left:5px;width:500px" type ="text" value="${doc.option7}" name="option7"/>
         </td>
      </tr>
      <tr>
         <td height="44" align="center" class="tableLine">经营地址及办公电话</td>
         <td colspan="3" align="center" class="tableLine" style="text-align:left;padding-left:10px;">
           <input id="management_addr" style="text-align:left;padding-left:5px;width:500px" type ="text" value="${doc.option8}" name="option8"/>
         </td>
      </tr>
      <tr>
        <td height="44" align="center" class="tableLine">联系人</td>
        <td width="176" align="center" class="tableLine">
        	<input id="contacts_name" style="text-align:left;padding-left:5px;width:150px" type ="text" value="${doc.option9}" name="option9"/>
        </td>
        <td width="187" align="center" class="tableLine">联系人电话</td>
        <td width="202" align="center" class="tableLine">
        	<input id="contacts_phone" style="text-align:left;padding-left:5px;width:180px" type ="text" value="${doc.option10}" name="option10"/>
        </td>
      </tr>
      <tr>
        <td height="44" align="center" class="tableLine">传  真</td>
        <td align="center" class="tableLine">
        	<input id="fax" style="text-align:left;padding-left:5px;width:150px" type ="text" value="${doc.option11}" name="option11"/>
        </td>
        <td align="center" class="tableLine">电子邮箱</td>
        <td align="center" class="tableLine">
        	<input id="mailbox" style="text-align:left;padding-left:5px;width:180px" type ="text" value="${doc.option12}" name="option12"/>
        </td>
      </tr>
      <tr>
        <td height="44" align="center" class="tableLine">从业人员人数</td>
        <td align="center" class="tableLine">
        	<input id="employee_num" style="text-align:left;padding-left:5px;width:150px" type ="text" value="${doc.option13}" name="option13"/>
        </td>
        <td align="center" class="tableLine">应体检人数</td>
        <td align="center" class="tableLine">
       		<input style="text-align:left;padding-left:5px;width:180px" type ="text" value="${doc.option14}" name="option14"/>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="44" colspan="4" style="text-align:left;padding-left:50px" class="tableLine">
        	申请性质：
        	<input type="radio" name="option16" value="1" <c:if test="${dto.apply_type == 1}">checked="checked"</c:if> />初次申请   
        	<input type="radio" name="option16" value="2" <c:if test="${dto.apply_type == 2}">checked="checked"</c:if> />变更申请   
        	<input type="radio" name="option16" value="3" <c:if test="${dto.apply_type == 3}">checked="checked"</c:if> />延续申请    
        	<input type="radio" name="option16" value="4" <c:if test="${dto.apply_type == 4}">checked="checked"</c:if> />评级申请
        </td>
      </tr>
      <tr>
        <td colspan="4" style="text-align:left;padding:20px 50px 20px 50px" height="30" class="tableLine">
        	...
        	<p>请审查组成员做好审查前的准备工作，并按审查组组长的安排准时到被审查单位报到，审查组成员的交通费、食宿费由所在单位承担。 </p>
	        	...
	        	卫生处/科负责人签字：<input style="margin-right:50px;text-align:left;padding-left:5px;width:100px" type ="text" value="${doc.option17}" name="option17"/>
	        	<input style="text-align:left;padding-left:5px;width:60px" type ="text" value="${doc.option18}" name="option18"/>年<input style="text-align:left;padding-left:5px;width:60px" type ="text" value="${doc.option19}" name="option19"/>月<input style="text-align:left;padding-left:5px;width:60px" type ="text" value="${doc.option20}" name="option20"/>日
	        	</p>
