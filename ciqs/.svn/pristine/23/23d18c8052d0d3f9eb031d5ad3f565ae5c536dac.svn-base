						...
						<tbody>
							<tr>
								<th width="50%" id="left_noline">
									<span class="need"></span>是否预警：
								</th>
								<td width="50%">
<!-- 									<input type="text" id="warning" name="warning" size="14" class="required text" value="${not empty bean ? bean.warning:''}"/> -->
									否<input id="warning" name="warning" type="radio" class="required" <c:if test="${bean.warning == 0}"> checked="checked" </c:if> value="0"/>
									是<input id="warning" name="warning" type="radio" class="required" <c:if test="${bean.warning == 1}"> checked="checked" </c:if> value="1"/>
									<p></p>
								</td>
							</tr>
							<tr>
								<th width="50%">
									<span class="need"></span>图片数量：
								</th>
								<td >
									<input type="text" id="dicNum" name="dicNum" size="100" class="text" value="${not empty bean ? bean.dicNum:''}"/>
									 <p></p>
								</td>
							</tr>
						</tbody>
