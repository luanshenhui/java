...
public class VslDecIo implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3067392363302610597L;
...
//	@Pattern(regexp="[0-9]{4}-[0-9]{2}-[0-9]{2}",message="EST_ARRIV_DATE:时间格式错误 ")
	...
	/** 不可为空	监管局名称 */
	@NotEmpty(message="INSP_ORG_NAME:不能为空")
