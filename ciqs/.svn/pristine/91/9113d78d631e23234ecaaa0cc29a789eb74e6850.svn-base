    ...
    <form action="/ciqs/origplace/origList" method="post" id="orig_place">
        <table width="100%" border="0" class="table-search margin-auto">
            <tr>
                ...
                <td height="25" align="left" valign="middle" >企业备案号</td>
                <td height="25" align="left" valign="middle" >证书号</td>
                <td height="25">&nbsp;</td>
            </tr>
            <tr>
                <td  height="50" align="left" valign="middle"><input name="dec_org_name" type="text"
                                                                     class="search-input input-140px"
                                                                     id="dec_org_name"
                                                                     value="${obj.dec_org_name}"/></td>
                <td  height="50" align="left" valign="middle"><input name="apply_date_begin" type="text"
                                        class="search-input input-140px datepick" id="apply_date_begin"
                                        value="${obj.apply_date_begin}"/></td>
                <td  height="50" align="left" valign="middle"><input name="apply_date_over" type="text"
                                        class="search-input input-140px datepick" id="apply_date_over"
                                        value="${obj.apply_date_over}"/></td>
                <td  height="50" align="left" valign="middle"><input name="org_reg_no" type="text" class="search-input input-140px"
                                        id="org_reg_no" value="${obj.org_reg_no}"/></td>
                <td  height="50" align="left" valign="middle"><input name="cert_no" type="text" class="search-input input-140px"
                                                   id="cert_no" value="${obj.cert_no}"/></td>
            </tr>
            <tr>
                <td height="25" align="left" valign="middle">直属局</td>
                <td height="25" align="left" valign="middle">分支机构</td>
                <td height="25" align="left" valign="middle" >目的国家</td>
                <td height="25" align="left" valign="middle" >证书种类</td>
                <td height="25"></td>
                <td height="25"></td>
                <td height="25">&nbsp;</td>
            </tr>
            <tr>
                <td  height="50" align="left" valign="middle">
                    <select id="org_code" class="search-input input-175px" name="org_code" style="width:160px">
                ...
                <td height="50" align="left" valign="middle">
                    <select id="dept_code" class="search-input input-175px" name="dept_code" style="width:160px">
                ...
                <td height="50" align="left" valign="middle">
                    <select id="dest_country" class="search-input input-145px" name="dest_country" style="width:160px">
                        <option value="">全部</option>
                ...
                <td  height="50" align="left" valign="middle">
                    <select id="cert_type" class="search-input input-145px" name="cert_type" style="width:160px">
                        <option value="">全部</option>
        ...
        <table class="margin-cxjg_table" border="0" cellspacing="0" cellpadding="0">
            ...
            <c:if test="${not empty list }">
                <c:forEach items="${list}" var="row">
                    <tr class="thead_nr">
                        <td width="8%" height="90" align="center"><strong> ${row.dec_org_name}</strong></td>
