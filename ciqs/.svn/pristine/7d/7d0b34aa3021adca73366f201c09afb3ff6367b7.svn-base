...
<body>
	<div style="width: 1000px; margin: 0 auto;">
		...
		<input type="button" style="margin: 40px 40px 0px 540px; width: 80px;height: 30px;" value="返回" onclick="javascript:window.location.href='localepunishinfojsp?punish_id=${result.PUNISH_ID}';">
	</div>
</body>
</html>