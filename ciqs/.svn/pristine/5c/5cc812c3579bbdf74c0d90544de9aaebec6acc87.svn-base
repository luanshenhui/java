    			...
    			success:function(data){
   			        if(data.status=="OK"){
             			...
             			// 设置第一行数据
   			             ...
   			             childTwo.eq(4).text(results.est_arriv_date==null?"":results.est_arriv_date);
   			            ...
   			            /*  childTwo.eq(7).html(results.traf_cert==null?"":(results.traf_cert.split(",")[0]+"</br>"+results.traf_cert.split(",")[1])); */
   			             childTwo.eq(7).html(results.traf_cert==null||results.traf_cert =="NULL"?"":results.traf_cert);
   			             
   			       // 设置第三行数据
   			             var childThree=$("table").eq(0).find("tr").eq(5).children();
   			             childThree.eq(0).text(results.having_patient == "有" ? results.having_patient:"无");
   			             childThree.eq(1).text(results.having_corpse == "有" ? results.having_corpse:"无");
   			             childThree.eq(2).text(results.having_mdk_mdi_cps == "有" ? results.having_mdk_mdi_cps:"无");
   			       ...
   			       // 设置第四行数据
   			             ...
   			             childFour.eq(2).text(results.check_type_dec==null||results.check_type_dec=="NULL"?"":results.check_type_dec);
   			       ...
   			       // 设置第五行数据
   			             ...
   			             childFive.eq(2).text(results.check_type_aprv==null?"":results.check_type_aprv);
    			             
   			       // 循环找id所匹配的图片或视频
   			             var transportFiles=data.transportFiles;
		                 if(transportFiles!=""){
                            for(var i=0;i<transportFiles.length;i++){
                            	var bot = "border-bottom:1px solid #CCC";
                            	bot = "";
/*                             	if(transportFiles.length == (i+1)){
                            		bot = "";
                            	} */
                            	var html_content="<div style='width:100%;height:60px;line-height:60px;"+bot+"'>"+
		               ...
		               // 循环找所匹配的文件
		                  if(transportDocs!=""){
 			               ...
 			               ///控制双线问题	
	  			            $(".table-xqlb tr td").each(function(i){
	  			            	var _t = this;	
						        $(_t).children("div").each(function(j){
						        	 if($(_t).children("div").length != (i+1) && $(_t).children("div").length>1){
 			                  ...
 			                  var addHour = 0;
								...
								if(data.doc1 != null){
									...
									$("#V_JC_T_T_24").prepend(data.doc1.option_3 == "0" ? "<span style='float:left;padding-left:40px; line-height:60px;'>是</span>" : "<span style='float:left;padding-left:40px; line-height:60px;'>否</span>");
									...
									$("#V_JC_T_T_23").html($("#V_JC_T_T_23").html().replace(/float\:left;margin-left\:80px;width\:200px;height\:60px;line-height\:60px;/, "float:left;margin-left:26px;width:200px;height:60px;line-height:60px;"));
									$("#V_JC_T_T_24").html($("#V_JC_T_T_24").html().replace(/float\:left;margin-left\:80px;width\:200px;height\:60px;line-height\:60px;/, "float:left;margin-left:26px;width:200px;height:60px;line-height:60px;"));
									$("#V_JC_T_T_25").html($("#V_JC_T_T_25").html().replace(/float\:left;margin-left\:80px;width\:200px;height\:60px;line-height\:60px;/, "float:left;margin-left:26px;width:200px;height:60px;line-height:60px;"));
								}
								if(data.doc2 != null){
									jycyFlag = true;
   ...
   <div class="margin-chx">
	   <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table-xqlb">
		    <tr class="table_xqlbbj">
		      <td width="148px"  align="center">中文船名</td>
		      <td width="148px"  align="center">英文船名</td>
		      <td width="148px"  align="center">中文国籍</td>
		      <td width="148px"  align="center">英文国籍</td>
		      <td width="148px"  align="center">呼号</td>
		      <td width="148px"  align="center">总吨</td>
		      <td width="148px"  align="center">净吨</td>
		      <td width="148px"  align="center">载货种类数量及预靠泊地点</td>
		    </tr>
		    ...
		    <tr class="table_xqlbbj">
		      ...
		      <td width="148px"  align="center" >船员人数</td>
		      <td width="148px"  align="center" >旅客人数</td>
		      <td width="148px"  align="center" >发航港及出发日期</td>
		      <td width="148px"  align="center" >预计抵达日期及时间</td>
		      <td width="148px"  align="center" >近四周寄港及日期</td>
		      <td width="148px"  align="center" >船舶免予卫生控制措施证书/船舶卫生控制措施证书签发港及日期</td>
		      <td width="148px"  align="center" >交通工具卫生证书签发港及日期</td>
		    </tr>
		    <tr class="table_xqlbnr">
		      <td width="200" height="90" align="center"></td>
		      <td width="100" height="90" align="center"></td>
		    ...
		    <tr class="table_xqlbbj">
		      <td width="148px"  align="center" >船上有无病人</td>
		      <td width="148px"  align="center" >船上是否有人非因意外死亡</td>
		      <td width="148px"  align="center" >在航海中船上是否有鼠类或其它医学媒介生物反常死亡</td>
		      <td width="148px"  align="center" ></td>
		      <td width="148px"  align="center" ></td>
		      <td width="148px"  align="center" ></td>
		      <td width="148px"  align="center" ></td>
		      <td width="148px"  align="center" ></td>
	...
	<div class="margin-chx" id="dlhwjsh_div">
