...
// 							  	$(this)[0].before($("#"+$(this)[0].getAttribute("orgid")).html());
	...
	<div style="text-align: center;margin: auto;margin-top: 10px;padding-bottom: 10px;" id="mhid">
					<input type="button" class="abutton" style="margin-left:0px" value="返回"  onclick="JavaScript:history.go(-1);"/>
				</div>
</body>
</html>