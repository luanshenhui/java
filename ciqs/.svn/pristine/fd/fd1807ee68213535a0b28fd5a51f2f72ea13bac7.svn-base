...
<script type="text/javascript"> 
		...
		var url="/ciqs/expFoodProd/peson?page="+page;
			if(apply_no){
		...
		function downExcel() {
			...
			window.location.href = "/ciqs/expFoodProd/downExcel"+param;
		}
...
<!-- 		<div class="title">查询条件</div> -->
		...
		<div class="table">
			<div class="menu">
				<ul>
					<li><a href="javascript:jumpPage('/ciqs/expFoodProd/pesoninit?no=${obj.apply_no}');"><img 
...
<!-- 									<td> -->
<!-- 										<a href='javascript:jumpPage("/ciqs/expFoodProd/downExcel?id=1");'> -->
<!-- 											导出EXCEL -->
<!-- 										</a> -->
<!-- 									</td> -->
								</tr>
