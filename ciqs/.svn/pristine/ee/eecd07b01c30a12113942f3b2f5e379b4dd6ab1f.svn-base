	...
	<div id="content">
      ...
      <div style="text-align: left;padding-left:400px" class="noprint">
		...
		<div style="text-align: center;margin-top:5px" class="noprint">
		    <span>
		    	<input type="submit" value="保存" type="button" />
		    	<input type="button" value="提交" type="button" onclick="tjiao()"/>
				<input type="button" value="打印" type="button" onclick="javascript:window.print()" />
				<input type="button" value="返回" type="button" onclick="javascript:window.close()" />
		    </span>
		</div>
	</div>
</form>
