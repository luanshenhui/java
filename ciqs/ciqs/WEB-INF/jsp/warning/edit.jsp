...
<div class="freeze_div_list">
    <div class="title-bg">
        <div class=" title-position margin-auto white">
            <div class="title">
                <span class="font-24px" style="color:white;">预警时长规则维护 /编辑</span>
            </div>
...
<div class="blank_div_list">
	<div class="margin-auto width-1200" style="height: 50px;margin-top: 20px">当前位置：预警时长规则维护 - 编辑</div>
</div>
        ...
        <table class="margin-cxjg_table" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td height="25"><input type="text" class="search-input input-440px" style="width:250px"
                                    name="good_type" id="good_type" value="${obj.good_type}"/></td>
                <td height="25">
                <select name="good_category" id="good_category"  class="search-input input-440px" style="width:250px">
	                <c:if test="${obj.good_category == 0}">
	                	<option selected="selected" value="0">出口</option>
	                	<option value="1">进口</option>
                    </c:if>
                    <c:if test="${obj.good_category == 1}">
                    	<option value="0">出口</option>
	                	<option selected="selected" value="1">进口</option>
                    </c:if>
	            </select>                  
                </td>
                <td height="25"><input type="text" class="search-input input-440px" style="width:250px"
                                      name="min_time"  id="min_time" value="${obj.min_time}"/></td>
            </tr>
  			<tr class="thead">                
                <td height="25">标准平均时长:</td>
                <td height="25">最大平均时长:</td>
                <td height="25"><input id="ruld_id" value="${ruld_id}" type="hidden"/></td>
            </tr>
             <tr>
                <td height="25"><input type="text" class="search-input input-440px" style="width:250px"
                                         name="average_time" id="average_time" value="${obj.average_time}"/></td>
                <td height="25"><input type="text" class="search-input input-440px" style="width:250px"
                                         name="max_time" id="max_time" value="${obj.max_time}"/></td>
                <td height="25"></td>
            </tr>
