...
<input type ="hidden" name="DocType" value="D_SDHZ5" />
...
<input type ="hidden" id="ws_type" value="${ws_type}" />
    ...
    <table width="700"  border="0" align="center" style="font-size: 14px;line-height: 30px;" cellpadding="0" cellspacing="0"   class="tableLine">
      ...
      <tr>
        ...
        <td width="576" class="tableLine"><input type="text" style="text-align:left;width:500px;height:30px;" value="${doc.option_9}" id="option_9" name="option9" style="width:20px;border-bottom:0px" /></td>
      </tr>
        <tr>
