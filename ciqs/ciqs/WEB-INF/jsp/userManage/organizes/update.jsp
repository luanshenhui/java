    ...
    <script type="text/javascript">
		...
		jQuery(function(){
			$(document).ready(function() {
				isSelected('orgtype','${orgDto.type }');
...
<%@ include file="/common/headMenu_Sys.jsp"%>
	<div class="dpn-content">
		...
		<div class="form">
			<div class="main">
				<form action="/ciqs/users/updateOrganizes" method="post" id="orgForm">
					<table id="form_table">
						<tbody>
							<tr>
								<th id="left_noline">
								...
								<td>
									<input type="text" id="orgcode" value="${orgDto.org_code }"
								...
								<td>
									<input type="text" value="${orgDto.name }"
