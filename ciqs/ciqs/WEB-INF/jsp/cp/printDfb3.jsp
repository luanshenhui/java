    ...
    <table width="700px" align="center">
        <tr>
          <td style="text-align:center;">
          	<span style="text-align:center;font-size:30px"><strong > 国境口岸餐饮服务单位卫生许可现场审查表（三）</strong></span>
          </td>
        </tr>
        <tr>
          <td style="text-align:center;">
          	<span>（ 适用于小型餐馆，小吃店，饮品店，供餐人数50人以下食堂）</span><br>
		  </td>
        </tr>
        <tr>
          <td >
...
<tr>
  ...
  <td style="text-align:center" class="tableLine" width="80px">
    <c:forEach items="${volist}" var="items" varStatus="aa">
    	<c:if test="${items.file_type == 1 && items.proc_type == 'V_PT_H_L_30'}">
    		<a href="#" onclick="toImgDetail('${items.file_name}')">查看图片</a><br/>
    	</c:if>
    	<c:if test="${items.file_type == 2 && items.proc_type == 'V_PT_H_L_30'}">
...
<tr>
  <td rowspan="8" align="center" valign="middle" class="tableLine" style="text-align: center"><p align="center">场所设置、布局、分隔和面积 </p>
（12分）</td>
  ...
  <td align="center" class="tableLine">&nbsp;</td>
  <td rowspan="8" style="text-align:center" class="tableLine" width="80px">
    <c:forEach items="${volist}" var="items" varStatus="aa">
    	<c:if test="${items.file_type == 1 && items.proc_type == 'V_PT_H_L_31'}">
    		<a href="#" onclick="toImgDetail('${items.file_name}')">查看图片</a><br/>
    	</c:if>
    	<c:if test="${items.file_type == 2 && items.proc_type == 'V_PT_H_L_31'}">
    		<a href="#" onclick="showVideo('${items.file_name}')" >查看视频</a><br/>
    	</c:if>
    </c:forEach>
  </td>
...
<tr>
  <td align="center" class="tableLine">4.各加工操作场所按照原料进入、原料处理、半成品加工、成品供应的顺序合理布局，并能防止食品在存放、操作中产生交叉污染。</td>
...
<tr>
  <td align="center" class="tableLine">5.用于原料、半成品、成品的工具、用具和容器，有明显的区分标识，存放区域分开设置。</td>
  <td align="center" class="tableLine" style="text-align: center">※</td>
  <td align="center" class="tableLine" style="text-align: center">${dto.option_5}</td>
  <td align="center" class="tableLine">&nbsp;</td>
</tr>
<tr>
  <td align="center" class="tableLine">6.食品处理区面积与就餐场所面积之比满足特大型餐馆≥1:3.0，大型餐馆≥1:2.5。</td>
  <td align="center" class="tableLine" style="text-align: center">5</td>
  <td align="center" class="tableLine" style="text-align: center">${dto.option_6}</td>
  <td align="center" class="tableLine">&nbsp;</td>
</tr>
<tr>
  <td align="center" class="tableLine">7.小吃店使用面积≥30㎡；小型餐馆使用面积≥50㎡。</td>
  <td align="center" class="tableLine" style="text-align: center">※</td>
...
<tr>
  <td align="center" class="tableLine">9.凉菜间面积≥4㎡；凉菜间面积≥食品处理区面积10%。</td>
  <td align="center" class="tableLine" style="text-align: center">※</td>
  <td align="center" class="tableLine" style="text-align: center">${dto.option_9}</td>
  <td align="center" class="tableLine">&nbsp;</td>
</tr>
<tr>
  <td rowspan="6" align="center" valign="middle" class="tableLine" style="text-align: center"><p align="center">食品处理区地面、墙壁、门窗、天花板与排水</p>
（10分）</td>
  ...
  <td rowspan="6" style="text-align:center" class="tableLine" width="80px">
    <c:forEach items="${volist}" var="items" varStatus="aa">
    	<c:if test="${items.file_type == 1 && items.proc_type == 'V_PT_H_L_32'}">
    		<a href="#" onclick="toImgDetail('${items.file_name}')">查看图片</a><br/>
    	</c:if>
    	<c:if test="${items.file_type == 2 && items.proc_type == 'V_PT_H_L_32'}">
    		<a href="#" onclick="showVideo('${items.file_name}')" >查看视频</a><br/>
    	</c:if>
    </c:forEach>
  </td>
...
<tr>
  <td align="center" class="tableLine">10.排水沟出口有网眼孔径小于6mm的金属隔栅或网罩。</td>
  <td align="center" class="tableLine" style="text-align: center">5</td>
  <td align="center" class="tableLine" style="text-align: center">${dto.option_10}</td>
  <td align="center" class="tableLine">&nbsp;</td>
</tr>
<tr>
  <td align="center" class="tableLine">11.墙壁采用无毒、无异味、不透水、平滑、不易积垢的浅色材料，粗加工、切配、餐用具清洗消毒和烹调等场所有1.5m以上光滑、不吸水、浅色、耐用和易清洗的材料制成的墙裙。</td>
  <td align="center" class="tableLine" style="text-align: center">5</td>
  <td align="center" class="tableLine" style="text-align: center">${dto.option_11}</td>
  <td align="center" class="tableLine">&nbsp;</td>
</tr>
<tr>
  <td align="center" class="tableLine">12.门、窗装配严密，与外界直接相通的门和窗设有易于拆洗且不生锈的防蝇纱网或设置空气幕，与外界直接相通的门能自动关闭。</td>
  <td align="center" class="tableLine" style="text-align: center">5</td>
  <td align="center" class="tableLine" style="text-align: center">${dto.option_12}</td>
  <td align="center" class="tableLine">&nbsp;</td>
</tr>
<tr>
  <td align="center" class="tableLine">13.粗加工、切配、餐用具清洗消毒、烹调等场所如设门，采用易清洗、不吸水的坚固材料制作。</td>
  <td align="center" class="tableLine" style="text-align: center">2</td>
  <td align="center" class="tableLine" style="text-align: center">${dto.option_13}</td>
  <td align="center" class="tableLine">&nbsp;</td>
</tr>
<tr>
  <td align="center" class="tableLine">14.天花板采用无毒、无异味、不吸水、表面光洁、耐腐蚀、耐温、浅色材料涂覆或装修。</td>
  <td align="center" class="tableLine" style="text-align: center">5</td>
  <td align="center" class="tableLine" style="text-align: center">${dto.option_14}</td>
  <td align="center" class="tableLine">&nbsp;</td>
</tr>
<tr>
  <td rowspan="3" align="center" valign="middle" class="tableLine" style="text-align: center"><p align="center">餐用具清洗消毒保洁 <br>
    设施 </p>
（5分）</td>
  <td align="center" class="tableLine">15.配备能正常运转的清洗、消毒、保洁设备设施。</td>
  <td align="center" class="tableLine" style="text-align: center">※</td>
  ...
  <td rowspan="3" style="text-align:center" class="tableLine" width="80px">
    <c:forEach items="${volist}" var="items" varStatus="aa">
    	<c:if test="${items.file_type == 1 && items.proc_type == 'V_PT_H_L_33'}">
    		<a href="#" onclick="toImgDetail('${items.file_name}')">查看图片</a><br/>
    	</c:if>
    	<c:if test="${items.file_type == 2 && items.proc_type == 'V_PT_H_L_33'}">
    		<a href="#" onclick="showVideo('${items.file_name}')" >查看视频</a><br/>
    	</c:if>
    </c:forEach>
  </td>
...
<tr>
  <td align="center" class="tableLine">16.各类清洗消毒方式设专用水池的最低数量：采用化学消毒的，至少设有3个专用水池。采用人工清洗热力消毒的，可设置２个专用水池。各类水池以明显标识标明其用途。</td>
  <td align="center" class="tableLine" style="text-align: center">※</td>
  <td align="center" class="tableLine" style="text-align: center">${dto.option_16}</td>
  <td align="center" class="tableLine">&nbsp;</td>
</tr>
<tr>
  <td align="center" class="tableLine">17.餐用具清洗消毒水池专用，与食品原料、清洁用具及接触非直接入口食品的工具、容器清洗水池分开。</td>
  <td align="center" class="tableLine" style="text-align: center">※</td>
...
（7分）</td>
  <td align="center" class="tableLine">18.粗加工操作场所分别设动物性食品、植物性食品、水产品3类食品原料的清洗水池，水池数量或容量与加工食品的数量相适应。各类水池以明显标识标明其用途。</td>
  <td align="center" class="tableLine" style="text-align: center">5</td>
  ...
  <td rowspan="2" style="text-align:center" class="tableLine" width="80px">
    <c:forEach items="${volist}" var="items" varStatus="aa">
    	<c:if test="${items.file_type == 1 && items.proc_type == 'V_PT_H_L_34'}">
    		<a href="#" onclick="toImgDetail('${items.file_name}')">查看图片</a><br/>
    	</c:if>
    	<c:if test="${items.file_type == 2 && items.proc_type == 'V_PT_H_L_34'}">
    		<a href="#" onclick="showVideo('${items.file_name}')" >查看视频</a><br/>
    	</c:if>
    </c:forEach>
  </td>
...
<tr>
  <td align="center" class="tableLine">19.设专用于拖把等清洁工具、用具的清洗水池，其位置不会污染食品及其加工制作过程。</td>
  <td align="center" class="tableLine" style="text-align: center">5</td>
...
（7分）</td>
  <td align="center" class="tableLine">20.接触食品的设备、工具、容器、包装材料等符合食品安全标准或要求。</td>
  <td align="center" class="tableLine" style="text-align: center">5</td>
  <td align="center" class="tableLine" style="text-align: center">${dto.option_20}</td>
  <td align="center" class="tableLine">&nbsp;</td>
  <td rowspan="2" style="text-align:center" class="tableLine" width="80px">
    <c:forEach items="${volist}" var="items" varStatus="aa">
    	<c:if test="${items.file_type == 1 && items.proc_type == 'V_PT_H_L_35'}">
    		<a href="#" onclick="toImgDetail('${items.file_name}')">查看图片</a><br/>
    	</c:if>
    	<c:if test="${items.file_type == 2 && items.proc_type == 'V_PT_H_L_35'}">
    		<a href="#" onclick="showVideo('${items.file_name}')" >查看视频</a><br/>
    	</c:if>
    </c:forEach>
  </td>
...
<tr>
  <td align="center" class="tableLine">21.接触食品的设备、工具和容器易于清洗消毒。</td>
  <td align="center" class="tableLine" style="text-align: center">2</td>
...
<tr>
  <td rowspan="2" align="center" valign="middle" class="tableLine" style="text-align: center"><p align="center">通风排烟 <br>
    设施 </p>
（7分）</td>
  <td align="center" class="tableLine">22.烹调场所采用机械排风。产生油烟的设备上部加设附有机械排风及油烟过滤的排气装置，过滤器便于清洗和更换。</td>
  <td align="center" class="tableLine" style="text-align: center">5</td>
  <td align="center" class="tableLine" style="text-align: center">${dto.option_22}</td>
  <td align="center" class="tableLine">&nbsp;</td>
  <td rowspan="2" style="text-align:center" class="tableLine" width="80px">
    <c:forEach items="${volist}" var="items" varStatus="aa">
    	<c:if test="${items.file_type == 1 && items.proc_type == 'V_PT_H_L_36'}">
    		<a href="#" onclick="toImgDetail('${items.file_name}')">查看图片</a><br/>
    	</c:if>
    	<c:if test="${items.file_type == 2 && items.proc_type == 'V_PT_H_L_36'}">
    		<a href="#" onclick="showVideo('${items.file_name}')" >查看视频</a><br/>
    	</c:if>
    </c:forEach>
  </td>
...
<tr>
  <td align="center" class="tableLine">23.排气口装有网眼孔径小于6mm的金属网罩。</td>
  <td align="center" class="tableLine" style="text-align: center">5</td>
...
（7分）</td>
  <td align="center" class="tableLine">24.食品处理区设存放废弃物或垃圾的容器。废弃物容器与加工用容器有明显区分的标识。</td>
  <td align="center" class="tableLine" style="text-align: center">2</td>
  <td align="center" class="tableLine" style="text-align: center">${dto.option_24}</td>
  <td align="center" class="tableLine">&nbsp;</td>
  <td rowspan="2" style="text-align:center" class="tableLine" width="80px">
    <c:forEach items="${volist}" var="items" varStatus="aa">
    	<c:if test="${items.file_type == 1 && items.proc_type == 'V_PT_H_L_37'}">
    		<a href="#" onclick="toImgDetail('${items.file_name}')">查看图片</a><br/>
    	</c:if>
    	<c:if test="${items.file_type == 2 && items.proc_type == 'V_PT_H_L_37'}">
    		<a href="#" onclick="showVideo('${items.file_name}')" >查看视频</a><br/>
    	</c:if>
    </c:forEach>
  </td>
...
<tr>
  <td align="center" class="tableLine">25.废弃物容器配有盖子，以坚固及不透水的材料制造，内壁光滑便于清洗。专间内的废弃物容器盖子为非手动开启式。</td>
  <td align="center" class="tableLine" style="text-align: center">2</td>
...
（10分）</td>
  <td align="center" class="tableLine">26.食品和非食品（不会导致食品污染的食品容器、包装材料、工具等物品除外）库房分开设置。</td>
  <td align="center" class="tableLine" style="text-align: center">5</td>
  <td align="center" class="tableLine" style="text-align: center">${dto.option_26}</td>
  <td align="center" class="tableLine">&nbsp;</td>
  <td rowspan="2" style="text-align:center" class="tableLine" width="80px">
    <c:forEach items="${volist}" var="items" varStatus="aa">
    	<c:if test="${items.file_type == 1 && items.proc_type == 'V_PT_H_L_38'}">
    		<a href="#" onclick="toImgDetail('${items.file_name}')">查看图片</a><br/>
    	</c:if>
    	<c:if test="${items.file_type == 2 && items.proc_type == 'V_PT_H_L_38'}">
    		<a href="#" onclick="showVideo('${items.file_name}')" >查看视频</a><br/>
    	</c:if>
    </c:forEach>
  </td>
...
<tr>
  <td align="center" class="tableLine">27.冷藏、冷冻柜（库）数量和结构能使原料、半成品和成品分开存放，有明显区分标识。</td>
  <td align="center" class="tableLine" style="text-align: center">5</td>
...
（10分）</td>
  <td align="center" class="tableLine">28.专间内无明沟，地漏带水封。食品传递窗为开闭式，其他窗封闭。专间墙裙铺设到顶。</td>
  <td align="center" class="tableLine" style="text-align: center">5</td>
  ...
  <td rowspan="4" style="text-align:center" class="tableLine" width="80px">
    <c:forEach items="${volist}" var="items" varStatus="aa">
    	<c:if test="${items.file_type == 1 && items.proc_type == 'V_PT_H_L_39'}">
    		<a href="#" onclick="toImgDetail('${items.file_name}')">查看图片</a><br/>
    	</c:if>
    	<c:if test="${items.file_type == 2 && items.proc_type == 'V_PT_H_L_39'}">
    		<a href="#" onclick="showVideo('${items.file_name}')" >查看视频</a><br/>
    	</c:if>
    </c:forEach>
  </td>
...
<tr>
  <td align="center" class="tableLine">29.专间门采用易清洗、不吸水的坚固材质，能够自动关闭。</td>
  <td align="center" class="tableLine" style="text-align: center">5</td>
  <td align="center" class="tableLine" style="text-align: center">${dto.option_29}</td>
  <td align="center" class="tableLine">&nbsp;</td>
</tr>
<tr>
  <td align="center" class="tableLine">30.专间内设独立空调设施、专用工具清洗消毒设施和空气消毒设施以及专用冷藏设施。</td>
  <td align="center" class="tableLine" style="text-align: center">※</td>
  <td align="center" class="tableLine" style="text-align: center">${dto.option_30}</td>
  <td align="center" class="tableLine">&nbsp;</td>
</tr>
<tr>
  <td align="center" class="tableLine">31.专间入口处设置有非手动式洗手、消毒、更衣设施的通过式预进间。</td>
  <td align="center" class="tableLine" style="text-align: center">※</td>
      ...
      <tr>
        <td>          
          ...
          4. 根据得分，做出审查结论，标化分90分以上者，现场审查合格。 </p>
            <p><span style="margin-right:200px">得分：${dto.option_33}</span><span>检查时间：${dto.option_35}</span><p/>
            <p>标化分：${dto.option_34}<p/>
            <p> 
            	<span style="margin-right:148px">陪同检查人：
	            <c:if test="${not empty dto.option_38}">
	      			<img src="/ciqs/showVideo?imgPath=${dto.option_38}" width="50px" height="50px" />
	      		</c:if> 
	      		</span>
	      		<span>
	      		监督员：
