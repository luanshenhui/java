	...
	<div class="freeze_div_list">
		<div class="title-bg">
			<div class=" title-position margin-auto white">
				<div class="title">
				<span class="font-24px" style="color:white;">行政检查 /</span><a id="title_a" href="/ciqs/expFoodProd/list">出口食品生产企业监督检查</a>
				</div>
...
<div class="blank_div_dtl" style="height: 70px">
	...
	<div class="margin-auto width-1200  data-box">
  	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="gary">
	   <tr>
	      <td height="70" width="5%" align="center"  class="flow-td-bord" valign="middle"><strong>序号</strong></td>
	      <td height="70" width="70%" align="center" style="font-size: 30px;color: #333;" class="flow-td-bord" valign="middle">企业监督检查表</td>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table-data">
			<c:if test="${not empty list }">
				<c:forEach items="${list}" var="row" begin="0" varStatus="st">
					<tr>
						...
						<a href='javascript:jumpPage("/ciqs/extxz/toTextView?apply_no=${apply_no}&check_menu_type=${row.check_menu_type}&type=2");'>
		...
		<tr>
			...
			<td width="25%" height="70"  class="flow-td-bord" align="center" valign="middle">
			<a href='javascript:jumpPage("/ciqs/extxz/toTextViewQt?apply_no=${apply_no}&check_menu_type=${compName}&type=2");'>
			<span class="data-btn margin-auto">详细+</span></a></td> 
		</tr>
<!-- 		<tr> -->
...
<!-- 			<td width="25%" height="70"  class="flow-td-bord" align="center" valign="middle"> -->
<!-- 			<a href='javascript:jumpPage("/ciqs/extxz/unPassable?apply_no=${apply_no}&compName=${compName}&type=2");'> -->
<!-- 			<span class="data-btn margin-auto">详细+</span></a></td>  -->
<!-- 		</tr> -->
	 </table>
</div>
...
<div style="text-align: center;margin: auto;margin-top: 10px;width:200px;padding-bottom: 10px;">
		<input type="button" class="search-btn" value="返回"  onclick="window.close();"/>
	</div>
</body>
</html>
