...
<div id="content">
  ...
  <table>
    ...
    <tr>
      <td colspan="9" class="tableLine_2"><h1>行政处罚案件办理审批表</h1></td>
    </tr>
    <tr>
      <td colspan="9" class="tableLine_3">（<span><input name="option_1" value="${doc.option_1 }" style="width:100px;"/></span>）检案审批[<span><input name="option_2" value="${doc.option_2 }" style="width:100px;"/></span>]号</td>
    </tr>
    <tr style="height:120px;">
      <td><span>案由</span></td>
      <td colspan="8">
      	<textarea id="option_11_ta" style="width:580px;height:110px;"></textarea>
		<input type="hidden" id="option_11" name="option_11" value="${doc.option_11 }"/>
	  </td>
    </tr>
    <tr style="height:120px;">
      <td><span>申报事由</span></td>
      <td colspan="8" style="padding-top:10px;">
      	<textarea id="option_14_ta" style="width:580px;height:110px;"></textarea>
		<input type="hidden" id="option_14" name="option_14" value="${doc.option_14 }"/>
      </td>
    </tr>
    <tr style="height:120px;">
      <td rowspan="3"><span>请批建议</span></td>
      <td colspan="8" style="padding-top:10px;">
      	<textarea id="option_15_ta" style="width:580px;height:110px;"></textarea>
    ...
    <tr>
      ...
      <td colspan="4" style="text-align:left; border-top: hidden;border-bottom:hidden;border-left:hidden;">
      	审查人：<input id="option_20" name="option_20" value="${doc.option_20 }" style="width:100px;"/>
	  </td>
    </tr>
    <tr>
    ...
    <tr style="width:120px;">
      <td rowspan="3"><span>审批意见</span></td>
      <td colspan="8" style="padding-top:10px;">
      	<textarea id="option_24_ta" style="width:580px;height:110px;"></textarea>
    ...
    <tr>
      ...
      <td colspan="4" style="text-align:left; border-top: hidden;border-bottom:hidden;border-left:hidden;">
      	局领导：<input id="option_80" name="option_30" value="${doc.option_30 }" style="width:100px;"/>
	  </td>
    </tr>
    <tr>
      <td colspan="4" class="tableLine_13_2">
      	<%-- <span class="tableLeft"><input id="option_27" name="option_27" value="${doc.option_27 }" style="width:80px;"/> 年     <input id="option_28" name="option_28" value="${doc.option_28 }" style="width:40px;"/>   月   <input id="option_29" name="option_29" value="${doc.option_29 }" style="width:40px;"/>   日</span> --%>
      </td>
    ...
    <tr style="width:120px;">
      <td><span>备注</span></td>
      <td colspan="8" style="padding-top:10px;">
      	本表用于行政处罚审批、案件移送、指定管辖、登记保存（查封、扣押、封存）、案件调查延期、撤案、延（分）期缴纳罚款、撤销（变更）行政处罚等有关内部工作流程事项的审批。
      </td>
    </tr>
  </table>
  </form>
