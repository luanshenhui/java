	...
	<form id="form" action="/ciqs/generalPunishment/updateDoc" method="post">
        ...
        <input type="hidden" name ="pre_report_no" value="${gpDTO.pre_report_no}"/>
  		...
  		<table>
		    ...
		    <tr>
		      	<td colspan="7" class="table_2_1">大检申【<span><input name="option_1" value="${doc.option_1 }" style="width:100px;"/></span>】号</td>
		    </tr>	
		    <tr>
		      	<td rowspan="4" style="width:90px;"><span>违法当事人基本情况</span></td>
		      	<td style="width:90px;">姓名</td>
		      	<td style="width:90px;"><input name="option_2" value="${doc.option_2 }" style="width:80px;"/></td>
		    ...
		    <tr>
		      	<td>住址</td>
		      	<td colspan="5"><input name="option_5" value="${doc.option_5 }" style="width:400px;"/></td>
		    </tr>
		    <tr>
		      	<td>违法单位</td>
		      	<td colspan="5"><input name="option_6" value="${doc.option_6 }" style="width:400px;"/></td>
		    </tr>
		    <tr>
		      	<td style="width:90px;">法定代表人</td>
		      	<td style="width:90px;"><input name="option_7" value="${doc.option_7 }" style="width:80px;"/></td>
		      	<td style="width:90px;">单位地址</td>
		      	<td style="width:90px;" colspan="3"><input name="option_8" value="${doc.option_8 }" style="width:250px;"/></td>
		    </tr>
		    ...
		    <tr style="border-top: hidden;">
		    	...
		    	<td colspan="2" style="width:90px;border-right: hidden;"><input name="option_12" value="${doc.option_12 }" style="width:80px;"/></td>
		    	<td colspan="3">
		    		<input name="option_13" value="${doc.option_13 }" style="width:50px;"/>年
		    		<input name="option_14" value="${doc.option_14 }" style="width:40px;"/>月
		    		<input name="option_15" value="${doc.option_15 }" style="width:40px;"/>日
		    	</td>
		    </tr>
		    <tr style="height: 140px;">
		      	<td style="width:90px;" rowspan="2"><span>承办部门意见</span></td>
		      	<td colspan="6">
