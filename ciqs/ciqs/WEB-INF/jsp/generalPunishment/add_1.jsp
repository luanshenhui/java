...
<title>一般处罚/立案申报</title>
<%@ include file="/common/resource_show.jsp"%>
<script type="text/javascript"> 
		function submit() {
			if($("#id").val()){
				$("#search_form").attr("action", "/ciqs/generalPunishment/update");
			}else{
				$("#search_form").attr("action", "/ciqs/generalPunishment/add");
			}
			$("#search_form").submit();
		}
</script>
...
<div class="title"><a href="nav.html" class="white"><span  class="font-24px">一般处罚</span>/立案申报</a></div>
...
<form action="/ciqs/generalPunishment/add"  method="post" id="search_form">
<table width="100%" border="0" class="table-search margin-auto">
  ...
  <tr>
  	<td width="195" height="50" align="left" valign="middle">
		<select id="belong_org" class="search-input input-175px" name="belong_org">
			<option selected="selected" value="0">大连局</option>
		</select>
	</td>
    <td width="195" height="50" align="left" valign="middle"></td>
    <td width="195" height="50" align="left" valign="middle"></td>
    <td width="195" height="50" align="left" valign="middle"></td>
  </tr>
  <tr>
