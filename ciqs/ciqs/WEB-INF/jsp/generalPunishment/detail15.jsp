	...
	$(".writeHour").each(function(){
		...
		if(index > 1){
			...
			var dateText0 = $("#date"+(index-1)).text();
 			if(dateText0.trim()==""){
				var int1 = (index-1);
				for (var int = int1; int > 0; int--) {
					dateText0 = $("#date"+(int-1)).text();
					if(dateText0.trim()!=""){
						index = int
					    break;
					}
...
<ul class="flow-info" >
	<li>
    	...
    	<span class="font-10px" ><span id="date1" ><fmt:formatDate value="${date1}" type="both" pattern="yyyy-MM-dd HH:mm"/></span></span>
	</li>
	<li>
	  ...
	  <span class="font-10px" ><span id="date2" ><fmt:formatDate value="${date3}" type="both" pattern="yyyy-MM-dd HH:mm"/></span></span>
	</li>
	<li>
	  ...
	  <span class="font-10px" ><span id="date3" ><fmt:formatDate value="${date9}" type="both" pattern="yyyy-MM-dd HH:mm"/></span></span>
	</li>
	<li>
	  ...
	  <span class="font-10px" ><span id="date4" ><fmt:formatDate value="${date10}" type="both" pattern="yyyy-MM-dd HH:mm"/></span></span>
	</li>
	<li><span id="psn9" >${model.step_13_psn }</span><br />
	  <span class="font-10px" ><span id="date5" >
	  <c:if test="${not empty model.step_13_psn }"><fmt:formatDate value="${model.step_13_date}" type="both" pattern="yyyy-MM-dd HH:mm"/></c:if></span></span>
	</li>
	<li><span id="psn11" >${model.step_14_psn }</span><br /> 
	  <span class="font-10px" ><span id="date6" ><c:if test="${not empty model.step_14_status && model.step_14_status != '0' }"><fmt:formatDate value="${model.step_14_date}" type="both" pattern="yyyy-MM-dd HH:mm"/></c:if></span></span>
	</li>
...
<c:if test="${not empty model.step_1_status  && model.step_1_status != '0'}">
	...
	<table id="tab1" width="100%" border="0" cellpadding="0" cellspacing="0" class="table-xqlb">
	  ...
	  <tr class="table_xqlbnr">
	    <td width="220" height="35" align="center"><fmt:formatDate value="${model.step_1_date}" type="both" pattern="yyyy-MM-dd HH:mm:ss"/></td>
	...
	<table id="tab2" width="100%" border="0" cellpadding="0" cellspacing="0" class="table-xqlb">
	  ...
	  <tr class="table_xqlbnr">
	    <td width="220" height="35" align="center"><fmt:formatDate value="${model.step_2_date}" type="both" pattern="yyyy-MM-dd HH:mm:ss"/></td>
...
<c:if test="${not empty model.step_2_status  && model.step_2_status != '0'}">
	...
	<table id="tab5" width="100%" border="0" cellpadding="0" cellspacing="0" class="table-xqlb">
	  ...
	  <tr class="table_xqlbnr">
	    <td width="220" height="35" align="center"><fmt:formatDate value="${model.step_3_date}" type="both" pattern="yyyy-MM-dd HH:mm:ss"/></td>
	  ...
	  <tr>
	    <td width="220" height="35" align="center"><fmt:formatDate value="${model.step_16_date}" type="both" pattern="yyyy-MM-dd HH:mm:ss"/></td>
	  ...
	  <tr>
	    <td width="220" height="35" align="center"><fmt:formatDate value="${model.step_4_date}" type="both" pattern="yyyy-MM-dd HH:mm:ss"/></td>
	...
	<table id="tab5" width="100%" border="0" cellpadding="0" cellspacing="0" class="table-xqlb">
	  ...
	  <tr class="table_xqlbnr">
	    <td width="220" height="35" align="center"><fmt:formatDate value="${model.step_5_date}" type="both" pattern="yyyy-MM-dd HH:mm:ss"/></td>
	  ...
	  <tr class="table_xqlbnr">
	    <td width="220" height="35" align="center"><fmt:formatDate value="${model.step_17_date}" type="both" pattern="yyyy-MM-dd HH:mm:ss"/></td>
	  ...
	  <tr class="table_xqlbnr">
	    <td width="220" height="35" align="center"><fmt:formatDate value="${model.step_6_date}" type="both" pattern="yyyy-MM-dd HH:mm:ss"/></td>
	...
	<table id="tab7" width="100%" border="0" cellpadding="0" cellspacing="0" class="table-xqlb">
	  ...
	  <tr class="table_xqlbnr">
	    <td width="220" height="35" align="center"><fmt:formatDate value="${model.step_7_date}" type="both" pattern="yyyy-MM-dd HH:mm:ss"/></td>
	  ...
	  <tr class="table_xqlbnr">
	    <td width="220" height="35" align="center">
	    	<c:if test="${not empty gp_file_ajjzsl }">
				<a href="/ciqs/generalPunishment/downloadFile?fileName=${gp_file_ajjzsl.file_location }">
					<span  class="data-btn margin-auto">附件查看</span>
				</a>
	    	</c:if>
	    </td>
	    ...
	    <c:if test="${not empty gp_file_sdhz }">
			<a href="/ciqs/generalPunishment/downloadFile?fileName=${gp_file_sdhz.file_location }">
				<span  class="data-btn margin-auto">附件查看</span>
			</a>
			</c:if>
	    </td>
	    <td width="220" height="35" align="center">
	    	<c:if test="${not empty gp_file_tzcx }">
				<a href="/ciqs/generalPunishment/downloadFile?fileName=${gp_file_tzcx.file_location }">
					<span  class="data-btn margin-auto">附件查看</span>
				</a>
			</c:if>
	    </td>
...
<c:if test="${not empty model.step_13_status && model.step_13_status != '0'}">
	...
	<table id="tab8" width="100%" border="0" cellpadding="0" cellspacing="0" class="table-xqlb">
	  ...
	  <tr class="table_xqlbnr">
	    ...
	    <td width="220" height="35" align="center">
	    	<c:if test="${not empty gp_file_sdhz_sdzx}">
				<a style="cursor:pointer;" href="/ciqs/generalPunishment/downloadFile?fileName=${gp_file_sdhz_sdzx.file_location }">
		...
		<td width="220" height="35" align="center">
	    	<c:if test="${not empty gp_file_qt_sdzx}">
					<a style="cursor:pointer;" href="/ciqs/generalPunishment/downloadFile?fileName=${gp_file_qt_sdzx.file_location }">
					<span  class="data-btn margin-auto">附件查看</span></a>
	    	</c:if>
		</td>
	  </tr>
