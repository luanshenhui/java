...
<div style="width:100%; height:80px; padding-top:25px;"><div class="loge" style="width:600px; float:left; padding-left:30px;">
        ...
        <a href="/ciqs/"><img src="static/login/images/name.png" /></a>
</div>
...
<div style="background-color:#FFF; text-align: center; margin-top:20px; height:618px; "><img src="static/login/images/PAGE1.png" width="1001" height="618" usemap="#Map" border="0" />
  <map name="Map" id="Map">
    <area shape="rect" coords="215,21,403,71" href="index_warning1.jsp" />
    <area shape="rect" coords="419,24,607,73" href="index_warning2.jsp" />
  </map>
</div>
