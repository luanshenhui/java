...
<div style="background-color:#FFF; text-align: center; margin-top:20px; height:618px; "><img src="static/login/images/PAGE2.png" width="1001" height="618" usemap="#Map" border="0" />
  <map name="Map" id="Map">
    <area shape="rect" coords="10,22,198,72" href="index_warning.jsp" />
