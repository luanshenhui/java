...
<div class="container">
  ...
  <div class="grid" >
        <figure class="effect-lily">
            ...
            <figcaption >
                <div class="mainname" style="display: block">
                    <h2 style="color: #000000;font-size: 20px;font-weight:600;margin-bottom: 5px;margin-top: -75px;opacity: 1">行政确认</h2>
                </div>
        ...
        <figure class="effect-lily">
            ...
            <figcaption  style="height:35%">
                <div class="PERMISSION">
                    <h2 style="color: #000000;font-size: 20px;font-weight:600;margin-bottom: 5px;margin-top: -75px;opacity: 1">行政许可</h2>
                </div>
                <div style="padding-top:20px;">
                <h2>行政许可</h2>
        ...
        <figure class="effect-lily">
            ...
            <figcaption style="height:35%">
                <div class="INSPECT">
                    <h2 style="color: #000000;font-size: 20px;font-weight:600;margin-bottom: 5px;margin-top: -75px;opacity: 1">行政检查</h2>
                </div>
                <div style="padding-top:20px;">
                <h2>行政检查</h2>
        ...
        <figure class="effect-lily">
            ...
            <figcaption style="height:35%">
                <div class="PUNISH">
                    <h2 style="color: #000000;font-size: 20px;font-weight:600;margin-bottom: 5px;margin-top: -75px;opacity: 1">行政处罚</h2>
                </div>
                <div style="padding-top:20px;">
                <h2>行政处罚</h2>
