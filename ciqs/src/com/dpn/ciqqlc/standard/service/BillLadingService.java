...
public interface BillLadingService {
	...
	List<WarningDto> getWarningDto(WarningDto w) throws Exception;
	
	List<TfSysProcessLog> queryTfSysProcessLog(String declNo) throws Exception;
	
	List<TfSysProcessLog> queryTfSysProcessLogByDecl_no(String declNo) throws Exception;
