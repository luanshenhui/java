...
<input type ="hidden" id="sq_status" value="${sq_status}" />
    ...
    <table width="700"  border="0" align="center" style="font-size: 14px;line-height: 30px;" cellpadding="0" cellspacing="0"   class="tableLine">
      ...
      <tr>
        ...
        <td class="tableLine"><input id="ws2" onclick="acceptFormShow('${license_dno}')" type="text" style="cursor:pointer;text-align:left;width:500px;height:30px;" value="${doc.option_4}" id="option_4" name="option4" style="width:20px;border-bottom:0px"/></td>
      </tr>
      <tr>
