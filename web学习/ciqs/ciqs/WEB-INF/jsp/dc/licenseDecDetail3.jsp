...
<div class="dpn-content">
    <div class="crumb">
	             当前位置：卫生许可证 &gt;<span class="tpinfo">补发  </span>
    </div>
     <jsp:include page="/common/message.jsp" flush="true"/>
    <div class="form">
		<div class="main">
    <form action="<%=request.getContextPath()%>/dc/wsFileUpload3" method="post" id="licenseDecForm"  enctype="multipart/form-data">
	<%-- <html:form styleId="LicenseDecForm" action="/addLicenseDec.do?doType=addLicenseDec" enctype="multipart/form-data" method="post"> --%>
		...
		<table id="form_table">
			...
			<tr>
				<th style="width:30%;" id="left_noline">提示内容：</th>
				<td id="right_noline" colspan="3">
					<span style="color:red">补发申请情况说明、遗失/毁损后60日内的公开声明佐证材料</span>
				</td>
			</tr>
		</table>
