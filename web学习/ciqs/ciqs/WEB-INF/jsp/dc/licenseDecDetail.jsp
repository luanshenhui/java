...
<div class="dpn-content">
    <div class="crumb">
	             当前位置：卫生许可证 &gt;<span class="tpinfo">许可证申报详情  </span>
    </div>
     <jsp:include page="/common/message.jsp" flush="true"/>
    <div class="form">
		<div class="main">
    <form action="<%=request.getContextPath()%>/dc/wsFileUpload" method="post" id="licenseDecForm"  enctype="multipart/form-data">
	<%-- <html:form styleId="LicenseDecForm" action="/addLicenseDec.do?doType=addLicenseDec" enctype="multipart/form-data" method="post"> --%>
        ...
        <input type="hidden" name="approval_result" value="${dto.approval_result}"/>
		...
		<table id="form_table">
		    <tr>
				...
				<td id="right_noline" style="width:20%;">
					${dto.comp_addr}
				</td>
			</tr>
			<tr>
				<th style="width:20%;" id="left_noline">经营地址：</th>
				<td style="width:25%;">
					${dto.management_addr}
				</td>
		    ...
		    <tr>
				<th style="width:20%;" id="left_noline">法定代表人（负责人或业主）：</th>
				<td style="width:25%;">
					${dto.legal_name}
				</td>
		    ...
		    <tr>
				<th style="width:20%;" id="left_noline">联系电话：</th>
				<td style="width:25%;">
					${dto.contacts_phone}
				</td>
			...
			<tr>
				<th style="width:20%;" id="left_noline">传真：</th>
				<td style="width:25%;">
					${dto.fax}
				</td>
			...
			<tr>
				<th style="width:20%;" id="left_noline">是否通过体系认证、验证（证书号）：</th>
				<td style="width:25%;">
			...
			<tr>
				<th style="width:20%;" id="left_noline">经营类别：</th>
			...
			<tr>
				<th style="width:20%;" id="left_noline">申请类型：</th>
				<td id="right_noline" colspan="3">				
			...
			<tr>
				<th style="width:20%;" id="left_noline">受理局：</th>
				<td id="right_noline" colspan="3">
					${dto.admissible_org_name}	
				</td>
			</tr>
			<tr>
				<th style="width:20%;" id="left_noline"><span id="hygieneLicenseSpan" class="tpinfo"></span>原卫生许可证证号：</th>
				<td id="right_noline" colspan="3">
					${dto.hygiene_license_number}
				</td>
			</tr>
			<tr>
				<th style="width:20%;" id="left_noline">受理结果</th>
				<td id="right_noline" colspan="3">
			...
			<c:if test="${not empty dto.filePath}">
				<tr>
					<th style = "width:20%;" id="left_noline">查看附件：</th>
					<td id="right_noline" colspan="2">
						<input type = "button" value="查看附件" onclick="downloadFile(1)"/>
					</td>
				</tr>
			</c:if>
			<c:if test="${dto.approval_result != 3 && dto.approval_result != 4}">
			<tr>
				<th style="width:20%;" id="left_noline">上传附件(文件请打包上传)：</th>
				<td id="right_noline" colspan="3">
			...
			<c:if test="${dto.approval_result == 1}">
				<tr>
					<th style="width:20%;" id="left_noline">申请材料补正告知书：</th>
					<td id="right_noline" colspan="3">
						<input type = "button" value="点击查看" onclick="winShow('${dto.license_dno}','D_SQ_BZ')"/>
					</td>
				</tr>						
			</c:if>						
			<c:if test="${dto.approval_result == 3}">
				<tr>
					<th style="width:20%;" id="left_noline">准予受理决定书：</th>
					<td id="right_noline" colspan="3">
						<input type = "button" value="点击查看" onclick="winShow('${dto.license_dno}','D_SL_GZ')"/>
					</td>
				</tr>
			</c:if>
			<c:if test="${dto.approval_result == 2}">
				<tr>
					<th style="width:20%;" id="left_noline">不予受理决定书：</th>
					<td id="right_noline" colspan="3">
						<input type = "button" value="点击查看" onclick="winShow('${dto.license_dno}','D_BY_GZ')"/>
					</td>
				</tr>
			</c:if>
