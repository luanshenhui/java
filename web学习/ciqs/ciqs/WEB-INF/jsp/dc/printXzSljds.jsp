...
<%   
   ...
   String management_addr = request.getParameter("management_addr"); 
...
<script language="javascript" type="text/javascript">
	...
	var management_addr = "<%=management_addr%>";
	var contacts_name = "<%=contacts_name%>";
	var contacts_phone = "<%=contacts_phone%>";
	function dayin() {
		window.print();
	}
	$(function(){
		...
		$("#management_addr").text(management_addr);
		$("#contacts_name").text(contacts_name);
		$("#contacts_phone").text(contacts_phone);
	})
</script>
