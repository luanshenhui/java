...
<div>
	...
	<div class="basicInformation">
		<div>
			<span>船名：</span>${results.option_1} 
			<span style="margin-left:220px;">船籍：</span>${results.option_2}
			<span style="margin-left:220px;">IMO号：</span>${results.option_3}
		</div>
		<div>
			<span>船型：${results.option_4 }
			<span style="margin-left:220px;">港口：</span>${results.option_6}
		</div>
		<div>
			检查类型：${results.option_7}
		</div>
		<div>
			<span>检查人：</span>${results.option_8}<span style="margin-left:320px;">船舶代理：</span>${results.option_9}
		</div>
		<table width="980"  border="0" align="center" style="font-size: 14px;line-height: 30px;" cellpadding="0" cellspacing="0"   class="tableLine">
			...
			<tr>
				<td height="44" align="left" class="tableLine" colspan="5" rowspan="3" >
					 建议  <br/><br/>
					<div>${results.option_78}</div>
					整改要求<br/><br/>
					<div>${results.option_79}</div>
				</td>
			</tr>
		</table>
		<div style="border: 1px solid #000;margin-top:0px;width:330px;float:left;height:50px">
				陪同检查人员签字：
					<img style="width:28px" src="/ciqs/showVideo?imgPath=${results.option_80}" />
				<br/>
		</div>
		<div style="border: 1px solid #000;margin-top:0px;float:left; width:330px; margin-left:0px;height:50px">
					检查日期：
				${results.option_81}				
				<br/>
		</div>
		<div style="border: 1px solid #000;margin-top:0px;width:335px;margin-left:665px;height:50px">
				船长签字及船章：
					<img style="width:28px" src="/ciqs/showVideo?imgPath=${results.option_82}" />
				<br/>
		</div>
	</div>
