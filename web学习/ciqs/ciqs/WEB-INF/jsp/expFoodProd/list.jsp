...
<table width="100%" border="0" class="table-search margin-auto">
  <tr>
    ...
    <td height="25" align="left" valign="middle">计划制定时间（起）</td>
    <td height="25" align="left" valign="middle">计划制定时间（止）</td>
    <td height="25" align="left" >监管类型</td>
    <td height="25" align="left" >监管人员</td>
    <td height="25">&nbsp;</td>
  </tr>
...
<div class="margin-cxjg">
    ...
    <c:if test="${not empty list }">
		<c:forEach items="${list}" var="row">
			<tr>
			  <td width="130" height="90" align="center">${row.enterprisesname}</td>
