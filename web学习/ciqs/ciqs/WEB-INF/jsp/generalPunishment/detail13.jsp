	...
	<div class="dpn-content">
		<div class="crumb">
			当前位置：<a href="#">一般处罚</a> &gt; <a
				href="${cxt}/ciqs/generalPunishment/list?step=13">送达执行</a>
		</div>
		...
		<div class="form">
			<div class="main">
				<form action="/ciqs/generalPunishment/update" method="post" id="form" enctype="multipart/form-data">
			    	...
			    	<input type="hidden" id="step" name="step" value="13"/>
					<table id="form_table">
						<tbody>
							<tr>
				      			<th width="25%">
							...
							<tr>
								...
								<td width="25%">
									<a href='javascript:openNewPage("/ciqs/generalPunishment/toPage?id=${model.id}&step=13&page=gp_lian_spb_input&subStep=0");'>
							...
							<tr>
								...
								<td width="25%">
									<a href='javascript:openNewPage("/ciqs/generalPunishment/toPage?id=${model.id}&step=13&page=gp_shexiananjian_sbd_input&subStep=0");'>检验检疫涉嫌案件申报单</a>
								</td>
								<th width="25%">
									附件：
							  	</th>
							...
							<tr>
								...
								<td width="25%">
									<a href='javascript:openNewPage("/ciqs/generalPunishment/toPage?id=${model.id}&step=13&page=gp_anjian_spb_input&subStep=0");'>
								...
								<td width="25%">
									<a href='javascript:openNewPage("/ciqs/generalPunishment/toPage?id=${model.id}&step=13&page=gp_anjian_ysh_input&subStep=0");'>
							...
							<tr>
								...
								<td width="25%">
									<a href='javascript:openNewPage("/ciqs/generalPunishment/toPage?id=${model.id}&step=13&page=gp_diaochabaogao&subStep=0");'>
							...
							<tr>
								...
								<td width="25%">
									<c:choose>
							      		<c:when test="${not empty gp_file_jfsj_sdzx }">
							      			<a style="cursor:pointer;" href="/ciqs/generalPunishment/downloadFile?fileName=${gp_file_jfsj_sdzx.file_location }">${gp_file_jfsj_sdzx.file_name }</a><br/>
							      		</c:when>
							      		<c:otherwise>暂无</c:otherwise>
							      	</c:choose>
							      	<c:if test="${'0' == model.step_13_status }">
