	...
	<div class="dpn-content">
		<div class="crumb">
			当前位置：<a href="#">一般处罚</a> &gt; <a
				href="${cxt}/ciqs/generalPunishment/list?step=12">调查报告审批</a>
		</div>
					...
					<table id="form_table">
						<tbody>
							...
							<tr>
								...
								<td width="25%">
									<a href='javascript:openNewPage("/ciqs/generalPunishment/toPage?id=${model.id}&step=12&page=gp_lian_spb_input&subStep=0");'>
							...
							<tr>
								...
								<td width="25%">
									<a href='javascript:openNewPage("/ciqs/generalPunishment/toPage?id=${model.id}&step=12&page=gp_shexiananjian_sbd_input&subStep=0");'>检验检疫涉嫌案件申报单</a>
								</td>
								<th width="25%">
									附件：
							  	</th>
							...
							<tr>
								...
								<td width="25%">
									<a href='javascript:openNewPage("/ciqs/generalPunishment/toPage?id=${model.id}&step=12&page=gp_diaochabaogao&subStep=0");'>
