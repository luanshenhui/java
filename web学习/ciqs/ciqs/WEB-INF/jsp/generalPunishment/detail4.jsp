	...
	<div class="dpn-content">
		<div class="crumb">
			当前位置：<a href="#">一般处罚</a> &gt; <a
				href="${cxt}/ciqs/generalPunishment/list?step=4">稽查审批</a>
		</div>
					...
					<table id="form_table">
						<tbody>
							...
							<tr>
								...
								<td width="25%">
									<a href='javascript:jumpPage("/ciqs/generalPunishment/toPage?id=${row.id}&step=4&page=gp_anjian_ysh");'>
							...
							<tr>
								...
								<td width="25%">
									<a href='javascript:jumpPage("/ciqs/generalPunishment/toPage?id=${row.id}&step=4&page=gp_lian_spb");'>
							      		<span class="data-btn margin-auto">立案审批表</span>
							      	</a>
								</td>
								<th width="25%">延期审批表：</th>
								<td width="25%">
									<a href='javascript:jumpPage("/ciqs/generalPunishment/toPage?id=${row.id}&step=4&page=gp_yanqi_spb");'>
							      		<span class="data-btn margin-auto">延期审批表</span>
							      	</a>
								</td>
							</tr>
						</tbody>
