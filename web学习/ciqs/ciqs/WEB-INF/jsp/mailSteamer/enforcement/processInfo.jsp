	...
	<div class="title-bg" >
     ...
     <div class="flow-bg"  style=" height:235px;" >
		...
		<ul class="flow-icon">
		  ...
		  <li id="icon5" class="icongreen"><div class="hour white font-12px"><span id="hour5" class="writeHour"></span></div><a href="#tab5"><img src="${ctx}/static/show/images/mailSteamer/mailSteamer5.png" width="80" height="80" onclick="getPlace('module_5')"/></a></li>
...
<div class="blank_div_dtl" style="margin-top:306px;">
	...
	<div class="margin-chx">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr class="table_xqlbbj">
				<td width="150" height="35" align="center" valign="bottom">中文船名</td>
				<td width="100" height="35" align="center" valign="bottom">英文船名</td>
				<td width="150" height="35" align="center" valign="bottom">呼号</td>
				<td width="100" height="35" align="center" valign="bottom">近四周寄港及日期</td>
				<td width="100" height="35" align="center" valign="bottom">船舶免予卫生控制措施证书/船舶卫生控制措施证书签发港及日期</td>
				<td width="100" height="35" align="center" valign="bottom">交通工具卫生证书签发港及日期</td>
				<td width="150" height="35" align="center" valign="bottom">检疫方式</td>
				<td width="150" height="35" align="center" valign="bottom">直属局</td>
				<td width="150" height="35" align="center" valign="bottom">分支机构</td>
			</tr>
	...
	<div class="margin-chx">
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			class="table-xqlb">
			<tr class="table_xqlbbj">
				<td width="150" height="35" align="center" valign="bottom">申报时间</td>
				<td width="100" height="35" align="center" valign="bottom">申报单位</td>
				<td width="150" height="35" align="center" valign="bottom">申请检疫方式</td>
			</tr>
			<tr class="table_xqlbnr">
	...
	<div class="margin-chx">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table-xqlb">
			<c:if test="${not empty D_OC_PAGE_1 }">
				<tr>
					<td width='250' class="table_xqlbbj2">申报无异常事项</td>
					<td align="left" style="padding-left:100px">
						操作时间:&nbsp;&nbsp;&nbsp;&nbsp; <span class='blue'> <fmt:formatDate
			...
			<c:if test="${not empty D_OC_PAGE_2}">
				<tr>
					<td width='250' class="table_xqlbbj2">有无可疑病例</td>
					<td align="left" style="padding-left:100px">
						操作时间:&nbsp;&nbsp;&nbsp;&nbsp; <span class='blue'> <fmt:formatDate
		...
		<c:if test="${not empty V_JC_T_Y_D_10 }">	
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table-xqlb">
				<c:forEach items="${V_JC_T_Y_D_10 }" var="v" varStatus="status">
					<tr>
						<c:if test="${status.index==0 }">
							<td rowspan="${fn:length(V_JC_T_Y_D_10)}" width="250" class="table_xqlbbj2">突发公共卫生事件</td>
						</c:if>
						<td align="left" style="padding-left:100px">
		...
		<c:if test="${resultCheck.CREATE_DATE }">
	...
	<div class="margin-chx" id="isSpacal1">
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			class="table-xqlb">
			<tr class="table_xqlbbj">
				<td width="50%" height="35" align="center" valign="bottom">上报通报</td>
				<td height="35" align="center" valign="bottom"><a target="_blank" href="http://10.239.31.5/mainwan.asp">疫情上报系统</a></td>
			</tr>
		</table>
	</div>
	...
	<div class="margin-chx" id="isSpacal2">
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			class="table-xqlb">
			<tr class="table_xqlbbj">
				<td width="50%" height="35" align="center" valign="bottom">行政处罚</td>
				<td height="35" align="center" valign="bottom"><a target="_blank" href="/ciqs/generalPunishment/pnIndex">行政处罚系统</a></td>
			</tr>
		</table>
	</div>
