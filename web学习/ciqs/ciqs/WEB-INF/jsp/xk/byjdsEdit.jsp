...
<div>
	...
	（<input type="text" value="${doc.option1}" name="Option1" style="width:110px;border-bottom:0px"/>）<span style="text-decoration:line-through;">质</span>检
	 ...
	 〔<input type="text" value="${doc.option3}" name="Option3" style="width:20px;border-bottom:0px"/>〕<input type="text" value="${doc.option60}" style="width:120px;border-bottom:0px" name="Option60"/>号</span></div>
	...
	<div style="text-align: left;margin-top: 40px;">
		...
		<input type="text" value="${doc.option22}" style="width: 30px;" name="Option22"/>
		 ...
		 向本局提出<div style="border-bottom:1px solid #000;height:22px;width: 270px;display: inline-block"><input id="o8" type="text" value="${doc.option8}" name="Option8"/><!-- 制造计量器具许可证核发 --></div>行政许可申请。
		本局于
		...
		<!-- 制造计量器具许可证核发行政许可 -->
		<input id="o13" type="text" value="${doc.option13}" name="Option13"/></div>。
		<!-- 行政许可有效期至  -->
	...
	<div>
		<div style="padding-left:200px;width: 260px;">
			<span id="nowate_text"></span>
			<input type="text" value="${doc.option18}" style="width:50px" id="o18" name="Option18"/>年
