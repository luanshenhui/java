...
<script language="javascript" type="text/javascript">
	...
	$(function(){
	   ...
	   if($("#ws_type").val() =="1" && $("#ws").val() ==""){
	   	$("#ws").val("行政许可申请材料补正告知书");
	   }
	   else if($("#ws_type").val() =="2" && $("#ws").val() ==""){
	   	$("#ws").val("行政许可不予受理决定书");
	   }
	   else if($("#ws_type").val() =="3" && $("#ws").val() ==""){
	   	$("#ws").val("质量监督检验检疫行政许可受理单");
	   	$("#ws2").val("质量监督检验检疫行政许可申请材料接受清单");
	   }
	   else if($("#ws_type").val() =="4" && $("#ws").val() ==""){
	   	$("#ws").val("质量监督检验检疫准予行政许可决定书");
	   }
	   else if($("#ws_type").val() =="5" && $("#ws").val() ==""){
	   	$("#ws").val("质量监督检验检疫不予行政许可决定书");
	   }
	   if($("#option_2").val() =="整改通知书"){
		   $("#option_2").val("");
		   $("#ws").val("整改通知书");
	   }
	});
...
<input type ="hidden" name="DocType" value="D_PT_H_L_13" />
...
<input type ="hidden" id="ws_type" value="${ws_type}" />
    ...
    <table width="700"  border="0" align="center" style="font-size: 14px;line-height: 30px;" cellpadding="0" cellspacing="0"   class="tableLine">
      ...
      <tr>
        ...
        <td class="tableLine"><input id="ws" type="text" style="text-align:left;width:500px;height:30px;" value="${doc.option_9}" id="option_9" name="option9" style="width:20px;border-bottom:0px" /></td>
      </tr>
      <tr>
        <td height="39" align="center" class="tableLine">2</td>
        <td class="tableLine"><input id="ws2" type="text" onclick="acceptFormShow('${license_dno}')" style="cursor:pointer;text-align:left;width:500px;height:30px;" value="${doc.option_10}" id="option_10" name="option10" style="width:20px;border-bottom:0px" /></td>
      </tr>
      <tr>
        <td height="38" align="center" class="tableLine">3</td>
        <td class="tableLine"><input type="text" style="text-align:left;width:500px;height:30px;" value="${doc.option_11}" id="option_11" name="option11" style="width:20px;border-bottom:0px" /></td>
      </tr>
      <tr>
        <td height="42" align="center" class="tableLine">送达方式</td>
        <td class="tableLine"><input type="text" style="text-align:left;width:500px;height:30px;" value="${doc.option_4}" id="option_4" name="option4" style="width:20px;border-bottom:0px" /></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td width="576" class="tableLine"><input type="text" style="text-align:left;width:500px;height:30px;" value="${doc.option_7}" id="option_7" name="option7" style="width:20px;border-bottom:0px" /></td>
      </tr>
        <tr>
