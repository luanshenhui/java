...
<div>
	...
	<div style="border-bottom:1px solid #000;height:20px;width: 525px;margin-left: 40px;margin-bottom: 15px;">           </div>
	<div style="margin-bottom: 15px;">
	...
	<div style="text-align: left;margin-top: 40px;">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;申请人于 <span id="declare_date_text"></span>
		 向本局提出<div style="border-bottom:1px solid #000;height:22px;width: 270px;display: inline-block">制造计量器具许可证核发</div>行政许可申请。
		本局于<span id="approval_date_text"></span>受理。经审查，该申请不符合法定条件、标准，依照
	...
	<div style="text-align: left;">
		...
		<div style="border-bottom:1px solid #000;margin-top:15px;width: 80px;height:22px;display: inline-block"></div> 局或 
		<div style="border-bottom:1px solid #000;margin-top:8px;width: 80px;height:22px;display: inline-block"></div>人民政府申请行政复议，或自收到本决定之日起六个月内向 
		<div style="border-bottom:1px solid #000;margin-top:8px;width: 80px;height:22px;display: inline-block"></div> 人民法院提起行政诉讼。 
	</div>
