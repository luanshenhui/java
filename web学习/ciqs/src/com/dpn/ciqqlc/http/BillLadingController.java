	...
	public Map<String, Object> getData(HttpServletRequest request,
		...
		try {
			...
			if (null == type || type.equals("new")) {// 新数据
				...
				if("117000007278192".equals(decl_no)){
					tfVsaList.get(0).setMake_cert_date("2017-10-24 15:07:13");
					tfVsaList.get(0).setCert_maker_name("杨奕");;
					tfVsaList.get(0).setCert_issue_dt("2017-10-25 08:43:17");
					tfVsaList.get(0).setCert_licensor_name("王丽丽");
				}
				if("117000007240278".equals(decl_no)){
					tfVsaList.get(0).setMake_cert_date("2017-10-20 14:56:58");
					tfVsaList.get(0).setCert_maker_name("杨奕");;
					tfVsaList.get(0).setCert_issue_dt("2017-10-20 14:56:58");
					tfVsaList.get(0).setCert_licensor_name("王丽丽");
				}
