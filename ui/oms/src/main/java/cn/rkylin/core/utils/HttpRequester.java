...
public class HttpRequester {
    ...
    public HttpRespons sendGetApi(String index,String urlString, Map<String, String> params) throws IOException {
    ...
    public HttpRespons sendPostApi(String index,String urlString, Map<String, String> params) throws IOException {
    ...
    private HttpRespons send(String urlString, String method, Map<String, String> parameters, Map<String, String> propertys) throws IOException {
        ...
        if (method.equalsIgnoreCase("POST") && parameters != null) {
            ...
            for (String key : parameters.keySet()) {
                param.append("&");
                param.append(key).append("=").append(parameters.get(key)==null?"":URLEncoder.encode(parameters.get(key), "utf-8"));
            }
