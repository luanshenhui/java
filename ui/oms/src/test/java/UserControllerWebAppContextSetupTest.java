...
//@WebAppConfiguration(value = "/oms/target/oms")
//@ContextHierarchy({ @ContextConfiguration(name = "parent", locations = "classpath:spring/applicationContext.xml"),
//		@ContextConfiguration(name = "child", locations = "classpath:spring/applicationContext-*.xml") })
...
//		MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("/shop/shopDetail?shopId=13241324"))
