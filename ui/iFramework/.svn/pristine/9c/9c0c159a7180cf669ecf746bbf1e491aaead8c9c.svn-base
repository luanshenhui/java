...
<body onload="window.parent.location='<%=path %>/login.jsp';" class="error_body">
<div class="error_info_bg">
  <div class="error_info_title"><bean:message key="common.exception.error.security"/>.</div>
...
<span class="info3"> ● &nbsp;<a href="javascript:history.go(-1)"><bean:message key="common.exception.error.info4"/></span></a><br>  	 
