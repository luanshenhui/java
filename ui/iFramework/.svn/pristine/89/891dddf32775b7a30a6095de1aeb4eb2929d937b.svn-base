...
import com.dhc.base.security.SecurityValidationException;

public class CustomAuthenticationProcessingFilter extends AbstractProcessingFilter {
	...
	public Authentication attemptAuthentication(HttpServletRequest request) throws AuthenticationException {
		...
		if (!SecurityUtil.validate(password) || !SecurityUtil.validate(username)) {
			request.getSession().setAttribute(SECURITY_VALIDATE, "error");
			throw new SecurityValidationException("Security validate failed");
		}
