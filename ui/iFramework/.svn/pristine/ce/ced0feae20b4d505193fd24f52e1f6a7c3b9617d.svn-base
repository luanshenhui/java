...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=webpath%>/view/workflow/management/monitor/ApplicationMonitor.js"></script>
	</head>
	<body style="margin:10px;">
		...
		<div id="tabs" style="width:804px;height:400px;">
			<ul>    
				<li><a href="#1" >流程应用程序</a></li>    
				<li><a href="#2" >活动应用程序</a></li> 
				<li><a href="#3" >工作项应用程序</a></li> 
			</ul>
			<div id="1" class="menu">
				<ec:table
					items="recordList" var="record" style="table-layout:fixed"
					toolbarContent="status" minHeight="290" height="290" width="765"
					action="${pageContext.request.contextPath}/ApplicationMonitorAction.do?method=getLCApplicationMonitor"
					listWidth="100%" classic="true">
					<ec:row>  
						<ec:column property="_0" width="98" title="序号" value="${GLOBALROWCOUNT}" />
						<ec:column style="text-align:center;" width="110" property="appStatus" title="应用程序状态"  mappingItem="statusMap"/>
						<ec:column style="text-align:center;" width="110" property="instName" title="模板名称"/>
						<ec:column style="text-align:center;" width="110" property="instStatus" title="流程状态" />
						<ec:column style="text-align:center;" width="110" property="bizCategoryName" title="业务分类"/>
						<ec:column style="text-align:center;" width="110" property="instStartTime" cell="date" sortable="true" title="开始时间" format="yyyy-MM-dd HH:mm:ss" />
						<ec:column style="text-align:center;" width="110" property="instCompleteTime" cell="date" sortable="true" title="完成时间" format="yyyy-MM-dd HH:mm:ss" />
			...
			<div id="2">
				<ec:table tableId="ec2"
					...
					toolbarContent="status" minHeight="290" height="290" width="765"
					action="${pageContext.request.contextPath}/ApplicationMonitorAction.do?method=getHDApplicationMonitor"
					listWidth="100%" classic="true">
					<ec:row>  
						<ec:column property="_0" width="98" title="序号" value="${GLOBALROWCOUNT}" />
						<ec:column style="text-align:center;" width="110" property="appStatus" title="应用程序状态"  mappingItem="statusMap"/>
						<ec:column style="text-align:center;" width="110" property="instName" title="模板名称"/>
						<ec:column style="text-align:center;" width="110" property="instStatus" title="活动状态" />
						<ec:column style="text-align:center;" width="110" property="bizCategoryName" title="业务分类"/>
						<ec:column style="text-align:center;" width="110" property="instStartTime" cell="date" sortable="true" title="开始时间" format="yyyy-MM-dd HH:mm:ss" />
						<ec:column style="text-align:center;" width="110" property="instCompleteTime" cell="date" sortable="true" title="完成时间" format="yyyy-MM-dd HH:mm:ss" />
						<ec:column style="display: none;" width="0%" headerStyle="display: none;" property="instID" title="主键" />
						<ec:column style="display: none;" width="0%" headerStyle="display: none;" property="jobName" title="作业名称" />
					</ec:row>
				</ec:table>
			</div>
			<div id="3">
				<ec:table tableId="ec3"
					...
					toolbarContent="status" minHeight="290" height="290" width="765"
					action="${pageContext.request.contextPath}/ApplicationMonitorAction.do?method=getGZXApplicationMonitor"
					listWidth="100%" classic="true">
					<ec:row>  
						<ec:column property="_0" width="98" title="序号" value="${GLOBALROWCOUNT}" />
						<ec:column style="text-align:center;" width="110" property="appStatus" title="应用程序状态"  mappingItem="statusMap"/>
						<ec:column style="text-align:center;" width="110" property="instName" title="模板名称"/>
						<ec:column style="text-align:center;" width="110" property="instStatus" title="作业项状态" />
						<ec:column style="text-align:center;" width="110" property="bizCategoryName" title="业务分类"/>
						<ec:column style="text-align:center;" width="110" property="instStartTime" cell="date" sortable="true" title="开始时间" format="yyyy-MM-dd HH:mm:ss" />
						<ec:column style="text-align:center;" width="110" property="instCompleteTime" cell="date" sortable="true" title="完成时间" format="yyyy-MM-dd HH:mm:ss" />
						<ec:column style="display: none;" width="0%" headerStyle="display: none;" property="instID" title="主键" />
