package com.dhc.base.security.filter;
 ...
 * via the {@link AuthenticationProcessingFilter}. This object holds the
 ...
 * @author Omri Spector
 * @version $Id: AuthenticationProcessingFilterEntryPoint.java 2686 2008-03-03
 *          21:57:59Z luke_t $
 */
public class CustomerAuthenticationProcessingFilterEntryPoint implements AuthenticationEntryPoint, InitializingBean {
	// ~ Static fields/initializers
	// =====================================================================================

	private static final Log logger = LogFactory.getLog(CustomerAuthenticationProcessingFilterEntryPoint.class);
	...
	private String securityFormUrl;
	...
	public void commence(ServletRequest request, ServletResponse response, AuthenticationException authException)
		...
		// LicenseStatusVO licenseStatus = (LicenseStatusVO) httpRequest
		// .getSession().getServletContext().getAttribute(
		// "licenseStatusVO");
		// String status = licenseStatus.getStatus();
		// if (!status.equals(licenseStatus.LICENSE_VALID)) {
		// redirectUrl = buildRedirectUrlToSecurityPage(httpRequest,
		// httpResponse, authException);
		// }
		httpResponse.sendRedirect(httpResponse.encodeRedirectURL(redirectUrl));
	}

	protected String buildRedirectUrlToSecurityPage(HttpServletRequest request, HttpServletResponse response,
			AuthenticationException authException) {

		String securityForm = getSecurityFormUrl();
		...
		urlBuilder.setPathInfo(securityForm);
	...
	public void setSecurityFormUrl(String securityFormUrl) {
		try {
			this.securityFormUrl = securityFormUrl;
		} catch (Exception e) {
		}
	}

	public String getSecurityFormUrl() {
		try {
			return securityFormUrl;
		} catch (Exception e) {
			return "/security.jsp";
		}
	}
