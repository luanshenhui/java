	    ...
	    <td style='padding-left:3px;padding-top:8px' valign="top">
	      <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items1_1'>
	          <ul class='sitemu'>
	              <li><a target='main' href="web/page/personview.jsp">查看信息</a> </li>
	              <li><a target='main' href="web/page/personedit.jsp">修改信息</a> </li>
	              <li><a target='main' href="web/page/passwordedit.jsp">修改密码</a> </li>
	              <li><a target="_parent" href="ValidateAction" onclick="return validateclose();">注销退出</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      ...
	      <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items1_2'>
	          <ul class='sitemu'>
	              <li><a target='main' href="CategoryList">类别管理</a> </li>
	              <li><a target='main' href="ProductList">商品管理</a> </li>
	      ...
	      <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items1_3'>
	          <ul class='sitemu'>
	              <li><a target='main' href="StockList">进货管理</a> </li>
