...
<html>
	...
	<body leftmargin="2" topmargin="9" background='web/img/allbg.gif'>
			<pg:pager maxPageItems="2" url="ProductList" maxIndexPages="2">  
			...
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<tr align='center' bgcolor="#FFFFFF" onmouseover="this.style.backgroundColor='#f5f5f5'" onmouseout="this.style.backgroundColor='#FFFFFF'" height="22">
					...
					<td align="center">
						<a href="ProductOperate?aname=View&pid=<%=list.get(i).getId()%>" class="pn-loperator">查看</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="ProductToEdit?aname=Edit&pid=<%=list.get(i).getId()%>" class="pn-loperator">编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="ProductOperate?aname=Delete&pid=<%=list.get(i).getId()%>" class="pn-loperator" >删除</a>
					</td>
				</tr>
				</pg:item>
			<%} %> 
			...
			<table width='98%'  border='0'style="margin-top:8px;margin-left: 5px;">
			  <tr>
			    <td>
			      <input type="button" value="添加" style="width: 80px;" onclick="window.location.href='ProductToAdd'"/>
			    </td>
			  </tr>
		    </table>
   </body>
