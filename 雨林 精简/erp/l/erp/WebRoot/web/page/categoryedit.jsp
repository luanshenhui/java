...
<%
Category cate=(Category)request.getAttribute("category2");
%>
	
	<body leftmargin="2" topmargin="9" background='web/img/allbg.gif'>
			<form action="cateupdate" name="formAdd" method="post">&nbsp; 
			 			 <input type="hidden" name="id" value="<%=cate.getId()%>">
				     <table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
						<tr bgcolor="#EEF4EA">
					        <td colspan="3" background="web/img/wbg.gif" class='title'><span>修改单个类别</span>
					        </td>
					    </tr>
						...
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">       
						         <input type="text" name="info" value="<%=cate.getInfo() %>"/>
						    </td>
						</tr>
