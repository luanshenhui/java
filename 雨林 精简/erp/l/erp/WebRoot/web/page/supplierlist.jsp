	...
	<body leftmargin="2" topmargin="9" background='web/img/allbg.gif'>
      ...
      <pg:pager maxPageItems="2" url="catelist" maxIndexPages="2">
			...
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="7" background="web/img/tbg.gif">&nbsp; 查看全部供应商&nbsp;</td>
				</tr>
				<tr bgcolor="#FAFAF1">
				...
				<tr align='center' bgcolor="#FFFFFF" onmouseover="this.style.backgroundColor='#f5f5f5'" onmouseout="this.style.backgroundColor='#FFFFFF'" height="22">
					...
					<td align="center">
						<a href="cateview?id=" class="pn-loperator">查看</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="cateedit?id=" class="pn-loperator">编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="catedelt?id=" class="pn-loperator" onclick="return m()">删除</a>
					</td>
