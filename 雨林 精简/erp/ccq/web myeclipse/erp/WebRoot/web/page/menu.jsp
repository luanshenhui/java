	    ...
	    <td style='padding-left:3px;padding-top:8px' valign="top">
	      <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items1_1'>
	          <ul class='sitemu'>
	              ...
	              <li><a target='main' href="web/page/passwordidet.jsp">修改密码</a> </li>
	              <li><a target="_parent" href="zhuxiaotuichu">注销退出</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      ...
	      <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items1_2'>
	          <ul class='sitemu'>
	              <li><a target='main' href="cation">类别管理</a> </li>
	              <li><a target='main' href="productaction">商品管理</a> </li>
