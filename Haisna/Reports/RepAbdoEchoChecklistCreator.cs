...
{
    /// <summary>
    /// 成績表CL：腹部超音波チェックリスト生成クラス
    /// </summary>
    public class RepAbdoEchoChecklistCreator : PdfCreator
    {

        /// <summary>
        /// 帳票コード
        /// </summary>
        public override string ReportCd { get; } = "002240";

        /// <summary>
        /// 使用検査項目コード
        /// </summary>
        private const string CNST_ITEMCD01 = "24020";
        private const string CNST_ITEMCD02 = "24070";
        private const string CNST_ITEMCD03 = "24080";
        private const string CNST_ITEMCD04 = "24120";
        private const string CNST_ITEMCD05 = "24140";
        private const string CNST_ITEMCD06 = "24220";
        private const string CNST_ITEMCD07 = "24320";
        private const string CNST_ITEMCD08 = "24420";
        private const string CNST_ITEMCD09 = "24520";
        private const string CNST_ITEMCD10 = "24620";
        ...
        /// <summary>
        /// 成績表CL：腹部超音波チェックリストデータを読み込む
        /// </summary>
        /// <returns>成績表CL：腹部超音波チェックリストデータ</returns>
        protected override List<dynamic> GetData()
        {
                        ...
                        select
                            ...
                            , decode( 
                                ...
                                , decode( 
                                    rslcmtcd2
                                    , null
                                    , decode(result, null, '▲腹部超音波検査待ち', '●腹部超音波自動判定待ち')
                                    , '×腹部超音波キャンセル'
                                ) 
                                , decode( 
                                    result
            ...
            var sqlParam = new
            {
                ...
                para_itemcd04 = CNST_ITEMCD04,
                para_itemcd05 = CNST_ITEMCD05,
                para_itemcd06 = CNST_ITEMCD06,
                para_itemcd07 = CNST_ITEMCD07,
                para_itemcd08 = CNST_ITEMCD08,
                para_itemcd09 = CNST_ITEMCD09,
                para_itemcd10 = CNST_ITEMCD10,
        ...
        /// <param name="data">成績表CL：腹部超音波チェックリストデータ</param>
