...
namespace Hainsi.Reports
{
    ...
    /// 健診スケジュール表生成クラス
    /// </summary>
    public class Schedule_breastCreator : PdfCreator
    {
        /// <summary>
        /// 帳票コード
        /// </summary>
        ...
        protected override void SetFieldValue(CnForms cnForms, List<dynamic> data)
        {
            ...
            // Ｂ部屋名称
            bRoomField[0].Text = "Ｂホールカウンター";

            // Ｂ部屋番号・Ｂ部屋名称色

            // Ｃ部屋名称
            cRoomField[0].Text = "聴診/触診";
            cRoomField[1].Text = "乳房Ｘ線";
            cRoomField[2].Text = "Ｃホール２カウンター";

            // Ｃ部屋番号・Ｃ部屋名称色
            if (Util.ConvertToString(kensaBunrui.SHINSATU).Equals("1"))
            {
                cRoomNoField[0].Text = "２０";
            }
            else
            {
            ...
            msgListField.ListCell(0, 3).Text = "＊婦人科診察の前にお手洗を済ませていただくようお願い致します。";
