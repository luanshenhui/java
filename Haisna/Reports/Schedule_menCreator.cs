...
namespace Hainsi.Reports
{
    ...
    /// 健診スケジュール表生成クラス
    /// </summary>
    public class Schedule_menCreator : PdfCreator
    {
        /// <summary>
        /// 帳票コード
        /// </summary>
        ...
        protected override void SetFieldValue(CnForms cnForms, List<dynamic> data)
        {
            ...
            cRoomField[1].Text = "聴診/触診";
            cRoomField[2].Text = "聴力";
            cRoomField[3].Text = "視力";
            cRoomField[4].Text = "眼圧・眼底";
            cRoomField[5].Text = "メンタルチェック";
            cRoomField[6].Text = "胃透視前チェック";
            cRoomField[7].Text = "胃Ｘ線";
            cRoomField[8].Text = "Ｃホール２カウンター";
            cRoomField[9].Text = "内視鏡";
            cRoomField[10].Text = "超音波(頸動脈)";
            cRoomField[11].Text = "動脈硬化";

            // Ｃ部屋番号・Ｃ部屋名称色
            if (Util.ConvertToString(kensaBunrui.SHINSATU).Equals("1"))
            {
                cRoomNoField[1].Text = "２０";
            }
            else
            {
