...
namespace Hainsi.Reports
{
    ...
    /// 健診スケジュール表生成クラス
    /// </summary>
    public class Schedule_men_1SCreator : PdfCreator
    {
        /// <summary>
        /// 帳票コード
        /// </summary>
        ...
        protected override void SetFieldValue(CnForms cnForms, List<dynamic> data)
        {
            ...
            // Ｂ部屋名称
            bRoomField[0].Text = "オリエンテーション";
            bRoomField[1].Text = "身体測定・腹囲";
            bRoomField[2].Text = "血圧";
            bRoomField[3].Text = "採血";
            bRoomField[4].Text = "超音波(腹部)";
            bRoomField[5].Text = "胸部Ｘ線";
            bRoomField[6].Text = "胸部ＣＴ";
            bRoomField[7].Text = "内臓脂肪面積";
            bRoomField[8].Text = "心電図";
            bRoomField[9].Text = "骨密度";
            bRoomField[10].Text = "肺機能";

            // Ｂ部屋番号・Ｂ部屋名称色            
            if (Util.ConvertToString(kensaBunrui.SHINTAI).Equals("1"))
            {
                bRoomNoField[1].Text = "１";
            }
            else
            {
            ...
            if (Util.ConvertToString(kensaBunrui.HUKUECHO).Equals("1"))
            {
                bRoomNoField[4].Text = "４";
            }
            else
            {
            ...
            {
                bRoomNoField[5].Text = "５";
            }
            else
            {
                bRoomNoField[5].Text = NOT_ROOMNO_MARK;
                bRoomField[5].TextColor = NOT_ROOMNAME_COLOR;
            }

            if (Util.ConvertToString(kensaBunrui.HUKUCT).Equals("1"))
            {
                bRoomNoField[6].Text = "";
            }
            else
            {
                bRoomNoField[6].Text = NOT_ROOMNO_MARK;
                bRoomField[6].TextColor = NOT_ROOMNAME_COLOR;
            }

            if (Util.ConvertToString(kensaBunrui.SHIBOU).Equals("1"))
            {
                bRoomNoField[7].Text = "";
            }
            else
            {
                bRoomNoField[7].Text = NOT_ROOMNO_MARK;
                bRoomField[7].TextColor = NOT_ROOMNAME_COLOR;
            }

            if (Util.ConvertToString(kensaBunrui.SHINDENZU).Equals("1"))
            {
                bRoomNoField[8].Text = "９";
            }
            else
            {
                bRoomNoField[8].Text = NOT_ROOMNO_MARK;
                bRoomField[8].TextColor = NOT_ROOMNAME_COLOR;
            }

            if (Util.ConvertToString(kensaBunrui.GOTU).Equals("1"))
            {
                bRoomNoField[9].Text = "１０";
            }
            else
            {
                bRoomNoField[9].Text = NOT_ROOMNO_MARK;
                bRoomField[9].TextColor = NOT_ROOMNAME_COLOR;
            }

            if (Util.ConvertToString(kensaBunrui.HAI).Equals("1"))
            {
                bRoomNoField[10].Text = "１１";
            }
            else
            {
                bRoomNoField[10].Text = NOT_ROOMNO_MARK;
                bRoomField[10].TextColor = NOT_ROOMNAME_COLOR;
            }

            // Ｃ部屋名称
            cRoomField[0].Text = "Ｃホール１カウンター";
            cRoomField[1].Text = "乳房Ｘ線";
            cRoomField[2].Text = "聴診/触診";
            cRoomField[3].Text = "聴力";
            cRoomField[4].Text = "視力";
            cRoomField[5].Text = "眼圧・眼底";
            cRoomField[6].Text = "メンタルチェック";
            cRoomField[7].Text = "胃透視前チェック";
            cRoomField[8].Text = "胃Ｘ線";
            cRoomField[9].Text = "Ｃホール２カウンター";
            cRoomField[10].Text = "内視鏡";
            cRoomField[11].Text = "超音波(頸動脈)";
            cRoomField[12].Text = "動脈硬化";

            // Ｃ部屋番号・Ｃ部屋名称色
            if (Util.ConvertToString(kensaBunrui.YUBOUX).Equals("1"))
            {
                cRoomNoField[1].Text = "１３";
            }
            else
            {
            ...
            {
                cRoomNoField[5].Text = "１９";
            }
            else
            {
                cRoomNoField[5].Text = NOT_ROOMNO_MARK;
                cRoomField[5].TextColor = NOT_ROOMNAME_COLOR;
            }

            if (Util.ConvertToString(kensaBunrui.MENTARU).Equals("1"))
            {
                cRoomNoField[6].Text = "１８";
            }
            else
            {
                cRoomNoField[6].Text = NOT_ROOMNO_MARK;
                cRoomField[6].TextColor = NOT_ROOMNAME_COLOR;
            }

            if (Util.ConvertToString(kensaBunrui.ICHECK).Equals("1"))
            {
                cRoomNoField[7].Text = "１７";
            }
            else
            {
                cRoomNoField[7].Text = NOT_ROOMNO_MARK;
                cRoomField[7].TextColor = NOT_ROOMNAME_COLOR;
            }

            if (Util.ConvertToString(kensaBunrui.IX).Equals("1"))
            {
                cRoomNoField[8].Text = "";
            }
            else
            {
                cRoomNoField[8].Text = NOT_ROOMNO_MARK;
                cRoomField[8].TextColor = NOT_ROOMNAME_COLOR;                
            }

            if (Util.ConvertToString(kensaBunrui.NAISI).Equals("1"))
            {
                cRoomNoField[10].Text = "当日";
            }
            else
            {
                cRoomNoField[10].Text = "当日";
                cRoomNoField[10].TextColor = NOT_ROOMNAME_COLOR;
                cRoomField[10].TextColor = NOT_ROOMNAME_COLOR;
            }

            if (Util.ConvertToString(kensaBunrui.KEIDOU).Equals("1"))
            {
                cRoomNoField[11].Text = "４";
            }
            else
            {
                cRoomNoField[11].Text = NOT_ROOMNO_MARK;
                cRoomField[11].TextColor = NOT_ROOMNAME_COLOR;
            }

            if (Util.ConvertToString(kensaBunrui.CAVI).Equals("1"))
            {
                cRoomNoField[12].Text = "";
            }
            else
            {
                cRoomNoField[12].Text = NOT_ROOMNO_MARK;
                cRoomField[12].TextColor = NOT_ROOMNAME_COLOR;
            }
            ...
            msgListField.ListCell(0, 3).Text = "＊検査の混み具合により、検査の順番を変更する場合がごさいます。";
