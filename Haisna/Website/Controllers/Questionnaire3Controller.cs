...
{
    /// <summary>
    /// Questionnaire3コントローラ
    /// </summary>
    //[Authorize]
    [Route("api/v1/ocrnyuryoku3")]
    public class Questionnaire3Controller : Controller
    {
        /// <summary>
        /// Questionnaire3オブジェクト
        /// </summary>
        readonly Questionnaire3Dao questionnaire3Dao;

        /// <summary>
        /// コンストラクタ
        /// </summary>
        /// <param name="questionnaire3Dao">Questionnaire3オブジェクト</param>
        public Questionnaire3Controller(Questionnaire3Dao questionnaire3Dao)
        {
            this.questionnaire3Dao = questionnaire3Dao;
        }
        ...
        [HttpGet("~/api/v1/consultations/{rsvNo}/ocr3results")]
        public IActionResult GetOcrNyuryoku(int rsvNo, string grpCd, int lastDspMode, string csGrp)
        {
            ...
            // ＯＣＲ入力結果を取得
            List<dynamic> ocrresult = questionnaire3Dao.SelectOcrNyuryoku(rsvNo, grpCd, lastDspMode, csGrp, ref errCount, ref arrErrNo, ref arrErrState, ref arrErrMsg);
        ...
        [HttpPut("~/api/v1/consultations/{rsvNo}/validation3")]
                                                 ...
                                                 [FromBody] JToken data)
        {
            ...
            int count = questionnaire3Dao.CheckOcrNyuryoku(rsvNo,
                                                          grpCd,
                                                          lastDspMode,
                                                          csGrp,
                                                          ref itemCd,
        ...
        /// <response code="400">リクエスト不正</response>
        [HttpPut("~/api/v1/consultations/{rsvNo}/ocr3results")]
                                      ...
                                      bool skipNoRec = false)
        {
            ...
            //更新実行
            bool ret = questionnaire3Dao.UpdateOcrNyuryoku(rsvNo,
                                                          ipAddress,
                                                          updUser,
                                                          itemCd,
                                                          suffix,
        ...
        /// <response code="200">成功</response>
        /// <response code="404">データなし</response>
        [HttpGet("~/api/v1/consultations/{rsvNo}/orc3date")]
        public IActionResult GetEditOcrDate(int rsvNo)
        {
            dynamic data = questionnaire3Dao.SelectEditOcrDate(rsvNo);
