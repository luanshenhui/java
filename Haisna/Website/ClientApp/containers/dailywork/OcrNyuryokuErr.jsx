...
import { changeOcrNyuryokuErrInfo } from '../../modules/dailywork/questionnaire1Module';
...
class ocrNyuryokuErr extends React.Component {
  constructor(props) {
    super(props);
...
const mapStateToProps = (state) => {
  ...
  return {
    changeflag: state.app.dailywork.questionnaire1.ocrNyuryokuErr.changeflag,
...
const mapDispatchToProps = (dispatch) => ({
  // 画面値変更後の処理
  onChange: (params) => {
    dispatch(changeOcrNyuryokuErrInfo(params));
  },
});

export default connect(mapStateToProps, mapDispatchToProps)(ocrNyuryokuErr);
