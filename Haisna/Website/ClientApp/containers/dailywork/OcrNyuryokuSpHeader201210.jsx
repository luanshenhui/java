...
class OcrNyuryokuSpHeader201210 extends React.Component {
  constructor(props) {
    super(props);
      ...
      <form>
        ...
        <div style={{ width: 1400 }}>
          ...
          <FieldSet>
            ...
            <div style={{ width: 600, hight: 30, float: 'right' }}>
...
// propTypesの定義
OcrNyuryokuSpHeader201210.propTypes = {
...
OcrNyuryokuSpHeader201210.defaultProps = {
  consultdata: {},
  message: [],
  body: {},
};
...
export default connect(mapStateToProps, mapDispatchToProps)(OcrNyuryokuSpHeader201210);
