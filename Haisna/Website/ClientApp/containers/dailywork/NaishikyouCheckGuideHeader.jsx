...
const NaishikyouCheckGuideHeader = ({ data, realage }) => (
  <div>
...
// propTypesの定義
NaishikyouCheckGuideHeader.propTypes = {
  data: PropTypes.shape().isRequired,
  realage: PropTypes.number,
};

// defaultPropsの定義
NaishikyouCheckGuideHeader.defaultProps = {
  realage: null,
};

export default NaishikyouCheckGuideHeader;
