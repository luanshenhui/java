...
class OcrNyuryokuHeader extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <form>
        ...
        <div style={{ width: 1400 }}>
          <FieldSet>
            <OcrNyuryokuComHeade rsvno={rsvno} titlename="OCR入力結果確認" />
          </FieldSet>
          <FieldSet>
            ...
            <div style={{ width: 500, hight: 30, float: 'right' }}>
              ...
              <div style={{ width: 170, hight: 30, float: 'right' }}>
                <Button type="submit" onClick={this.handleOpenNaishikyou} value="内視鏡チェックリスト" />
              </div>
              <div style={{ width: 110, hight: 30, float: 'right' }}>
                <Button type="submit" onClick={this.handleOpenMonshinChangeOption} value="検査項目変更" />
              </div>
            </div>
          </FieldSet>
        </div>
...
OcrNyuryokuHeader.defaultProps = {
  consultdata: {},
  message: [],
  body: {},
};
...
export default connect(mapStateToProps, mapDispatchToProps)(OcrNyuryokuHeader);
