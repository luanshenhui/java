...
const initialValues = {
  ...
  // ファイル名
  fileName: '判定 標準FPD.csv',
};

// フォーム名
const formName = 'AbsenceListJudForm';

// 団体別判定結果CSV出力レイアウト
const AbsenceListJud = (props) => (
  <div>
...
export default reduxForm({
  form: formName,
  initialValues,
})(ReportForm(AbsenceListJud, TITLE, 'absencelistjud'));
