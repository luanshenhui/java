...
import { getUserList } from '../../modules/preference/hainsUserModule';

class UserGuideHeaderForm extends React.Component {
...
// propTypesの定義
UserGuideHeaderForm.propTypes = {
  reset: PropTypes.func.isRequired,
  location: PropTypes.shape().isRequired,
  onSearch: PropTypes.func.isRequired,
};

const UserGuideHeader = reduxForm({
  // form情報をstateで管理するためにアプリケーションで一意に名前を定義
  form: 'userGuideHeader',
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(UserGuideHeader));
