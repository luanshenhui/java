...
#pragma warning disable RECS0143
                ...
                if (param.CollectionType != null)
                {
                    ...
                    if (param.DbType == OracleDbType.Varchar2)
                    {
                        if (param.ParameterDirection == ParameterDirection.Output)
                        {
                            if (param.Size == null)
                            {
                                throw new ArgumentNullException("OracleDynamicParameters Size");
                            }
                            if (param.AssociateiveArrayCount == null)
                            {
                                throw new ArgumentNullException("OracleDynamicParameters AssociateiveArrayCount");
                            }
