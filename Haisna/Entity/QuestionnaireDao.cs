...
{
    /// <summary>
    /// QuestionnaireDaoデータアクセスオブジェクト
    /// </summary>
    public class QuestionnaireDao : AbstractDao
    {
        /// <summary>
        /// Person処理アクセスオブジェクト
        /// </summary>
        ...
        public QuestionnaireDao(IDbConnection connection, PersonDao personDao, ResultDao resultDao) : base(connection)
        {
            this.personDao = personDao;
            this.resultDao = resultDao;
        }

        private Dictionary<string, RslOcr> mcolOcrNyuryoku;     // OCR入力結果レコードのコレクション
        ...
        private const string OCR_ITEM525 = "XXXXX-XX"; //OCR入力担当者
        ...
        ///                                     ＝2のとき、コースグループコード
        /// </param>
        /// <param name="errCount">エラー数</param>
                                               ...
                                               ref List<string> arrErrMsg)
        {
            ...
            {
                mcolOcrNyuryoku = new Dictionary<string, RslOcr>();

                int index = 0;

                foreach (dynamic rec in dataResult)
                {
                    RslOcr rslOcr = new RslOcr
                    {
                    ...
                    index++;
                    UniqueKey = rec.ITEMCD + "-" + rec.SUFFIX;
                    mcolOcrNyuryoku.Add(UniqueKey, rslOcr);
                }
