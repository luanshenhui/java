 ...
 *
 * @author J. David Eisenberg, modified by Tomek Zielinski
 * @version 1.4, 31 March 2000; modified at February 2002 and later
 */
...
public class PngEncoder extends Object
{
     ...
     * @see java.awt.Image
     */
    public PngEncoder( int sourcearray[], int width, boolean encodeAlpha, int whichFilter,
       int compLevel)
    {
    ...
    public byte[] pngEncode( boolean encodeAlpha )
    {
        ...
        // width = image.getWidth( null );  already known
        height = sourcearray.length / width;
