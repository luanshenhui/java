        ...
        If strAction = "save" Then
                ...
                Else
                        ...
                        If Ret = INSERT_DUPLICATE Then
                                strArrMessage = Array("同一発病年月，既往症の既往歴情報がすでに存在します。")
                                Exit Do
                        End If
                ...
                If Ret = ALERT_FKEY2 Then
                        strArrMessage = Array("存在しない既往症です。")
                        Exit Do
                End If
...
<FORM NAME="entrydisease" ACTION="<%= Request.ServerVariables("SCRIPT_NAME") %>" METHOD="post">
	<BLOCKQUOTE>
...
%>
		...
		<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="2" WIDTH="100%">
			<TR VALIGN="bottom">
				<TD COLSPAN="2"><FONT SIZE="+2"><B>既往歴の入力</B></FONT></TD>
			</TR>
			<TR HEIGHT="2">
...
%>
			...
			<TR>
				<TD><FONT color="#666666">■</FONT>既往症</TD>
				<TD>：</TD>
				<TD>
<%
					'修正時はキー項目変更不可（表示のみ）
...
%>
			...
			<TR>
				<TD><FONT color="#666666">■</FONT>医療機関</TD>
				<TD>：</TD>
				<TD>
					<INPUT TYPE="text" NAME="medical" SIZE="<%= TextLength(50) %>" MAXLENGTH="<%= TextMaxLength(50) %>" VALUE="<%= strMedical %>" >
				</TD>
			</TR>
			<TR>
