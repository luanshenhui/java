...
'web予約情報を読み、状態を取得
If objWebRsv.SelectWebRsv(dtmCslDate, lngWebNo, strRegFlg) = False Then
...
function replaceOptionFrame( ctrPtCd, optCd, optBranchNo ) {
	...
	// URL編集
	var url = '/webHains/contents/webReserve/webRsvOption.asp';
