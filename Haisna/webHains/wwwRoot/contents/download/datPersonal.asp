...
Do
	...
	If strMode = "edit" Then
		...
		'CSVファイルの編集
'## 2003.6.3 Modify Start NSC(ITO
'		lngCount = objPerson.EditCSVDatPerson(strFileName, _
'											  strCase, strStrDate, strEndDate, _ 
'											  strCsCd, strOrgCd1, strOrgCd2, _
'											  strStrAge, strEndAge, lngGender, _ 
'											  strZipCd1, strZipCd2  _
'											 )
		strDownloadFile = CsvobjPerson.EditCSVDatPerson(strFileName, strCase, strStrDate, strEndDate, _
				                                             strCsCd, strOrgCd1, strOrgCd2, strStrAge, _
				                                             strEndAge, lngGender, strZipCd1, strZipCd2 _
				                                             )
...
'			Response.Redirect strDownloadFile
		...
		If strDownloadFile <> "" Then

			'情報漏えい対策用ログ書き出し
			Call putPrivacyInfoLog("PH101", "データ抽出　個人情報抽出よりファイル出力を行った")
...
'## 2003.6.3 Modify Start NSC(ITO
			strDownloadFile = CSV_DATAPATH & strDownloadFile	
'## 2003.6.3 Modify End
