...
Function Print()
	...
	Dim objBillDetail			'請求明細情報出力用COMコンポーネント
	...
	'オブジェクトのインスタンス作成
	Set objBillDetail = Server.CreateObject("HainsBillDetailList.BillDetailList")
	...
	'情報漏えい対策用ログ書き出し
	Call putPrivacyInfoLog("PH104", "データ抽出 請求書明細情報抽出よりファイル出力を行った")

	'請求明細情報ドキュメントファイル作成処理
	Ret = objBillDetail.PrintBillDetailList(Session("USERID"), dtmStrCslDate, dtmEndCslDate, strBillNo, strParaOrgCd1, strParaOrgCd2)
...
<FORM NAME="entryForm" ACTION="<%= Request.ServerVariables("SCRIPT_NAME") %>">
	...
	<TABLE BORDER="0" CELLPADDING="2" CELLSPACING="1" BGCOLOR="#999999" WIDTH="650">
		<TR>
			<TD HEIGHT="15" BGCOLOR="#ffffff" NOWRAP><B><SPAN CLASS="print">■</SPAN><FONT COLOR="#000000">請求書明細情報抽出</FONT></B></TD>
		</TR>
	</TABLE>
<%
	'エラーメッセージ表示
