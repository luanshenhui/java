...
Function Print()
	...
	Dim objAfterCareClsList		'個人受診金額一覧出力用COMコンポーネント
	...
	'オブジェクトのインスタンス作成
	Set objAfterCareClsList = Server.CreateObject("HainsAfterCareClsList.AfterCareClsList")
	...
	Ret = objAfterCareClsList.PrintAfterCareClsList(Session("USERID"), dtmStrCslDate, dtmEndCslDate, strParaOrgCd1, strParaOrgCd2, strBillNo)
...
<FORM NAME="entryForm" ACTION="<%= Request.ServerVariables("SCRIPT_NAME") %>">
	...
	<TABLE BORDER="0" CELLPADDING="2" CELLSPACING="1" BGCOLOR="#999999" WIDTH="650">
		<TR>
			<TD HEIGHT="15" BGCOLOR="#ffffff" NOWRAP><B><SPAN CLASS="print">■</SPAN><FONT COLOR="#000000">請求済み事後管理指導情報抽出</FONT></B></TD>
		</TR>
	</TABLE>
<%
	'エラーメッセージ表示
