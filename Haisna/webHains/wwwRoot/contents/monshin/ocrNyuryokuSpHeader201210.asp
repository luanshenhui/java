...
function callMonshinChangeOption() {
    var url;            // URL文字列
    var opened = false; // 画面がすでに開かれているかチェック
...
<!-- タイトルの表示 -->
    <TABLE BORDER="0" CELLPADDING="2" CELLSPACING="1" BGCOLOR="#999999" WIDTH="100%">
        <TR HEIGHT="14">
            <TD NOWRAP HEIGHT="14" BGCOLOR="#ffffff"><B><SPAN CLASS="demand">■</SPAN><FONT COLOR="#000000">OCR入力結果確認（新）</B></FONT></TD>
...
%>
            <TD ALIGN="LEFT">
                <IMG SRC="../../images/specialNavi201210_2.gif" ALT="" BORDER="0" USEMAP="#queNavi2">
                <MAP NAME="queNavi2">
                    <AREA SHAPE="RECT" COORDS="4,   0,104,22" HREF="JavaScript:jumpOcrNyuryoku(1)" ALT="現病歴既往歴">
                    <AREA SHAPE="RECT" COORDS="112, 0,193,22" HREF="JavaScript:jumpOcrNyuryoku(2)" ALT="生活習慣問診１">
                    <AREA SHAPE="RECT" COORDS="201, 0,283,22" HREF="JavaScript:jumpOcrNyuryoku(3)" ALT="生活習慣問診２">
                    <AREA SHAPE="RECT" COORDS="290, 0,346,22" HREF="JavaScript:jumpOcrNyuryoku(4)" ALT="婦人科問診">
                    <AREA SHAPE="RECT" COORDS="354, 0,410,22" HREF="JavaScript:jumpOcrNyuryoku(5)" ALT="食習慣問診">
                    <AREA SHAPE="RECT" COORDS="418, 0,486,22" HREF="JavaScript:jumpOcrNyuryoku(9)" ALT="特定健診">
                </MAP>
            </TD>
<%
    '### 男性受診者の場合 ###
...
%>
            <TD ALIGN="LEFT">
                <IMG SRC="../../images/specialNavi201210_1.gif" ALT="" BORDER="0" USEMAP="#queNavi">
                <MAP NAME="queNavi">
                    <AREA SHAPE="RECT" COORDS="4,   0,104,22" HREF="JavaScript:jumpOcrNyuryoku(1)" ALT="現病歴既往歴">
                    <AREA SHAPE="RECT" COORDS="112, 0,193,22" HREF="JavaScript:jumpOcrNyuryoku(2)" ALT="生活習慣問診１">
                    <AREA SHAPE="RECT" COORDS="201, 0,283,22" HREF="JavaScript:jumpOcrNyuryoku(3)" ALT="生活習慣問診２">
                    <AREA SHAPE="RECT" COORDS="290, 0,346,22" HREF="JavaScript:jumpOcrNyuryoku(5)" ALT="食習慣問診">
                    <AREA SHAPE="RECT" COORDS="354, 0,422,22" HREF="JavaScript:jumpOcrNyuryoku(9)" ALT="特定健診">
                </MAP>
            </TD>
<%
    End If
            ...
            <TD ALIGN="RIGHT">
                <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0">
                    <TR>
                        ...
                        <TD NOWRAP><A HREF="JavaScript:function voi(){};voi()"><IMG SRC="../../images/prevCopy_ocr.gif" WIDTH="110" HEIGHT="24" ALT="前回値を複写します" BORDER="0" ONCLICK="JavaScript:parent.list.copyOcrNyuryoku()"></A></TD>
                        ...
                        <TD NOWRAP>
<%'### 2016.02.04 張 操作権限チェックロジック追加 STR ### %>
                        ...
                        <%  else    %>
                             &nbsp;
                        <%  end if  %>
<%'### 2016.02.04 張 操作権限チェックロジック追加 END ### %>
                        </TD>
                    </TR>
                </TABLE>
            </TD>
