...
%>
            <TD ALIGN="LEFT">
                ...
                <AREA SHAPE="RECT" COORDS="565, 0,630,28" HREF="JavaScript:jumpOcrNyuryoku(9)" ALT="特定健診">
                </MAP>
            </TD>
<%
    '### 男性受診者の場合 ###
...
%>
            <TD ALIGN="LEFT">
                ...
                <AREA SHAPE="RECT" COORDS="506, 0,567,28" HREF="JavaScript:jumpOcrNyuryoku(9)" ALT="特定健診">
                </MAP>
            </TD>
<%
    End If
...
<!-- SL-UI-Y0101-607 前回複写ボタン追加 End -->
                        ...
                        <TD NOWRAP>
                        <!--★★★ プログラム情報登録及びユーザーグループ別権限登録後正常にチェック ★★★-->
                        <!--### ユーザーグループ別操作権限チェック Start ###-->
