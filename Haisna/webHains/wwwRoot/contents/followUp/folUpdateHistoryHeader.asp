...
Sub CreateClassInfo()
	...
	Redim Preserve strArrClass(10)
	Redim Preserve strArrClassName(10)

	strArrClass(0) = "X":strArrClassName(0) = "すべて"
	strArrClass(1) = "1":strArrClassName(1) = "二次検査受診日"
	strArrClass(2) = "2":strArrClassName(2) = "来院"
	strArrClass(3) = "3":strArrClassName(3) = "検査項目"
	strArrClass(4) = "4":strArrClassName(4) = "予約情報"
	strArrClass(5) = "5":strArrClassName(5) = "検査結果"
	strArrClass(6) = "6":strArrClassName(6) = "アンケート"
	strArrClass(7) = "7":strArrClassName(7) = "フォローアップはがき"
	strArrClass(8) = "8":strArrClassName(8) = "フォロー対象者"
	strArrClass(9) = "9":strArrClassName(9) = "健診項目削除"
	strArrClass(10) = "0":strArrClassName(10) = "健診項目追加"
...
function callUpdateHistoryTop() {
	...
	myForm.followNoteFlg.value = (myForm.followNoteFlg.checked) ? '1' : '';
	...
	parent.params.followNoteFlg = myForm.followNoteFlg.value;
...
<FORM NAME="entryForm" ACTION="<%= Request.ServerVariables("SCRIPT_NAME") %>" METHOD="post">
	...
	<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="1">
		...
		<TR>
			...
			<TD>
				<TD><INPUT TYPE="checkbox" NAME="followNoteFlg" VALUE="1" <%= IIf(strFollowNoteFlg = "1", " CHECKED","") %>></TD>
				<TD>備考の履歴も表示する。</TD>
<!--				<TD><A HREF="<%= strURL %>" TARGET="_top"><IMG SRC="../../images/back.gif"  ALT="フォローアップ画面に戻ります" border="0"></A></TD>-->
			</TD>
		</TR>
	</TABLE>
	<BR>
