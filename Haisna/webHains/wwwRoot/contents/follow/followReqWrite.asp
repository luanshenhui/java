...
Dim objFSO              '依頼状ファイルコピー
Dim objWord             'データを読み込み用
Dim objDoc              '依頼状にデータを読み込み用
...
Loop
    ...
    If blnCount <> False Then
        ...
        Set objFSO = CreateObject("Scripting.FileSystemObject")
            objFSO.CopyFile DOKUMENT_DATAPATH & "request.doc", DOKUMENT_DATAPATH & strFileName
        Set objFSO = nothing

        Set objWord = CreateObject("Word.Application")
        Set objDoc = CreateObject("Word.Document")
            objWord.visible = False
            objDoc = objWord.Documents.Open(DOKUMENT_DATAPATH & strFileName)
            ...
            myRange.text = strPerId
            Set myRange = nothing
            objWordDoc.Save Application(DOKUMENT_DATAPATH & strFileName)
...
<BODY BGCOLOR="#ffffff" onload="javascript:void(window.open('../../followDocument/<%= strFileName %>')">
