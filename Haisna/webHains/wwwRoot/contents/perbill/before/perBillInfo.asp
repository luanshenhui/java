...
<BLOCKQUOTE>
	...
	<TABLE BORDER="0" CELLPADDING="2" CELLSPACING="1" BGCOLOR="#999999" WIDTH="650">
		<TR>
			<TD HEIGHT="15" BGCOLOR="#ffffff" NOWRAP><B><SPAN><FONT COLOR="#000000">■請求書情報</SPAN></B></TD>
		</TR>
	</TABLE>
<%
'メッセージの編集
...
<%
			Else
%>
				<TD NOWRAP><A HREF="JavaScript:showMergeWindow();">
					<IMG SRC="/webHains/images/b_MergePerBill.gif" WIDTH="110" HEIGHT="24" ALT="この請求書を他の請求書と統合します">
				</A></TD>
...
<%
				...
				End If
%>
				<TD NOWRAP height="15"><%= IIf( vntOtherLineDivCd(i) <> "", vntOtherLineName(i),  vntLineName(i) ) %><FONT COLOR="#666666"></FONT></TD>
...
%>
		<TR height="1">
			<TD 70" colspan="7" nowrap align="right" bgcolor="#999999" height="1"></TD>
		</TR>
		<TR height="15">
			...
			<TR>
				<TD NOWRAP>
					<A HREF="JavaScript:deleteData();">
						<IMG SRC="/webHains/images/b_delPerBill.gif" WIDTH="110" HEIGHT="24" ALT="この請求書を取り消す">
					</A>
				</TD>
			</TR>
<%
