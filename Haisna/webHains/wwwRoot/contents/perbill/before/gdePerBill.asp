...
<BASEFONT SIZE="2">
<!-- === Navigation Bar (Logo) === -->
<FORM NAME="NaviBar" ACTION="/webHains/contents/common/search.asp" TARGET="_top" method="post">
...
<TABLE BORDER="0" CELLPADDING="2" CELLSPACING="1" BGCOLOR="#999999" WIDTH="635">
	<TR>
		<TD NOWRAP HEIGHT="15" BGCOLOR="#ffffff"><B><SPAN CLASS="perbill">■</SPAN><FONT COLOR="#000000">個人請求書の検索</FONT></B></TD>
	</TR>
</TABLE>
<br>
...
%>
			...
			<INPUT TYPE="hidden" NAME="age" VALUE="<%= Int(vntAge(i)) %>">
