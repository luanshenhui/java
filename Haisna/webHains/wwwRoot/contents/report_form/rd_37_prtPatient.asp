...
'---------------------------------------------------------------------
'
'   File Name : rd_37_prtPatient.asp
'   Created Date : 2005.12.06
'   Modified Date : 2005.12.06
...
<!--
    function LoadForm() 
    {
        ...
        Rdviewer.FileOpen("http://157.104.16.194:8090/RDServer/form/37_prtPatient.mrd", "/rp [<%= l_ScslDate %>] [<%= l_dayID %>]");
    }
//-->
</SCRIPT>
</HEAD>
