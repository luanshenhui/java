...
'---------------------------------------------------------------------
'
'	File Name : rd_29_prtReceivable.asp
'
'	Created Date : 2003.12.30
'
'	Modified Date : 2003.12.31
'
...
<!--
	function LoadForm() 
	{
		...
		Rdviewer.FileOpen("http://157.104.16.194:8090/RDServer/form/29_prtReceivable.mrd", "/rp [<%= l_ScslDate %>] [<%= l_EcslDate %>]");
	}
//-->
</SCRIPT>
</HEAD>
