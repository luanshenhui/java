...
'---------------------------------------------------------------------
'
'	File Name : rd_12_prtWorkSheetCheck.asp
'
...
<!--
	function LoadForm() 
	{
		...
		Rdviewer.FileOpen("http://157.104.16.194:8090/RDServer/form/12_prtWorkSheetCheck.mrd", "/rp [<%= l_ScslDate %>] [<%= l_EcslDate %>] [<%= l_perID %>]");
	}
//-->
</SCRIPT>
</HEAD>
