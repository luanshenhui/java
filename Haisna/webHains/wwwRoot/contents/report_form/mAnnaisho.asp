...
<%
    ...
    Function Print()
        ...
        Dim objPrintCls     'ご案内書出力用COMコンポーネント
        Dim Ret             '関数戻り値
        ...
        '英文出力の有無別の呼び先定義（スタートは英文のみ）
        Select Case l_engdiv

            Case "jap"
                Set objPrintCls = Server.CreateObject("HainsprtInvitation_medi.prtInvitation_m")
