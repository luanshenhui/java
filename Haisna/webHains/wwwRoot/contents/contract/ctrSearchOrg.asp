...
<FORM NAME="entryForm" ACTION="<%= Request.ServerVariables("SCRIPT_NAME") %>" METHOD="get">
	...
	<TABLE BORDER="0" CELLPADDING="2" CELLSPACING="1" BGCOLOR="#999999" WIDTH="650">
		<TR>
			<TD HEIGHT="15" BGCOLOR="#ffffff" NOWRAP><B><SPAN CLASS="contract">■</SPAN><FONT COLOR="#000000">団体の検索</FONT></B></TD>
		</TR>
	</TABLE>
	...
	<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="650">
		...
		<TR>
			...
			<TD ALIGN="right" VALIGN="top" NOWRAP><A HREF="/webHains/contents/maintenance/organization/mntOrganization.asp?mode=insert&target=/webHains/contents/contract/ctrCourseList.asp"><IMG SRC="/webHains/images/newrsv.gif" BORDER="0" WIDTH="77" HEIGHT="24" ALT="新しく団体を登録します"></A></TD>
			</TD>
		</TR>
	</TABLE>
<%
	'団体一覧の編集
	If Request("act") <> "" Then
		Call EditOrgList(strKey, lngStartPos, lngGetCount, "ctrCourseList.asp?", False, True)
	End If
%>
	</BLOCKQUOTE>
</FORM>
