...
<FORM NAME="entryForm" ACTION="<%= Request.ServerVariables("SCRIPT_NAME") %>" METHOD="post">
	...
	<!-- 検査結果の一覧表示 -->
<%
	Call EditMenResultTable1(lngHisCount, vntRsvNo, lngRsvNo, strMenResultGrpCd1, lngLastDspMode, vntCsGrp )
%>
</FORM>
</BODY>
</HTML>
