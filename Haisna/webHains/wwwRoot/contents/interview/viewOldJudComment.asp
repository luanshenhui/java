...
var params = {
	...
	<FRAMESET BORDER="0" FRAMESPACING="0" FRAMEBORDER="no" ROWS="<%=IIf(strWinMode="1",180,65)%>,*">
		<FRAME NAME="header" SRC="viewOldJudCommentHeader.asp<%=strUrlPara%>">
		<FRAME NAME="bodyview"  SRC="viewOldJudCommentBody.asp<%=strUrlPara%>">
	</FRAMESET>
</HTML>
