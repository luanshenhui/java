...
Function Print()
	...
	If Not IsArray(CheckValue()) Then
		...
		Set objPrintCls = Server.CreateObject("HainsprtFailSafe.prtFailSafe")

		'受診者数についてドキュメントファイル作成処理（オブジェクト.メソッド名(引数)）
		Ret = objPrintCls.PrintprtFailSafe( _
							Session("USERID"), _
						      	, _
						    	CDATE("2004/08/02"), _
						    	CDATE("2004/08/02") _
...
<!--- タイトル -->
	<TABLE BORDER="0" CELLPADDING="2" CELLSPACING="1" BGCOLOR="#999999" WIDTH="650">
		<TR>
			<TD HEIGHT="15" BGCOLOR="#ffffff" NOWRAP><Font color="#0000FF">■FailSafe印刷用</font></TD>
		</TR>
	</TABLE>
	<BR>
