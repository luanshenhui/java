...
Dim objCommon
	If Not IsArray(CheckValue()) Then
		...
		'情報漏えい対策用ログ書き出し
		Call putPrivacyInfoLog("PH022", "受診予定者チェックシートの印刷を行った")
...
'↓2003.12.31 23：09 NSC)阿部 オブジェクトの呼び出し
'Set objCommon = Server.CreateObject("HainsCommon.Common")
'strURL = "/webHains/contents/report_form/rd_13_prtConsultCheck.asp"
...
'Response.End 
		...
		'オブジェクトのインスタンス作成（プロジェクト名.クラス名）
		Set objPrintCls = Server.CreateObject("HainsprtConsultCheck.prtConsultCheck")
		'ドキュメントファイル作成処理（オブジェクト.メソッド名(引数)）
...
<!--- タイトル -->
	<TABLE BORDER="0" CELLPADDING="2" CELLSPACING="1" BGCOLOR="#999999" WIDTH="650">
		<TR>
			<TD HEIGHT="15" BGCOLOR="#ffffff" NOWRAP><B><SPAN CLASS="print">■受診予定者チェックシート</SPAN></B></TD>
		</TR>
	</TABLE>
<%
'エラーメッセージ表示
