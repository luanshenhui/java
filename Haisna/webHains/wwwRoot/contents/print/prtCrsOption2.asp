...
Function Print()
	...
	If Not IsArray(CheckValue()) Then
		...
		Set objPrintCls = Server.CreateObject("HainsCrsOption2.CrsOption2")

		'人間ドック症例別人数統計ドキュメントファイル作成処理（オブジェクト.メソッド名(引数)）
		Ret = objPrintCls.PrintCrsOption2( _
						Session("USERID"), _
						, _
						strSCslDate _
						 ) 
...
<TITLE>【運営会議資料】オプション・コースの利用状況</TITLE>
...
<FORM NAME="entryForm" ACTION="<%= Request.ServerVariables("SCRIPT_NAME") %>">
	...
	<TABLE BORDER="0" CELLPADDING="2" CELLSPACING="1" BGCOLOR="#999999" WIDTH="650">
		<TR>
			<TD HEIGHT="15" BGCOLOR="#ffffff" NOWRAP><B><SPAN CLASS="print">■【運営会議資料】オプション・コースの利用状況</SPAN></B></TD>
		</TR>
	</TABLE>
	<BR>
