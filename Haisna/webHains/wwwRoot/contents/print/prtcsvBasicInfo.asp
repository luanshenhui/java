...
Function Print()
	...
	If Not IsArray(CheckValue()) Then
		...
		'情報漏えい対策用ログ書き出し
		Call putPrivacyInfoLog("PH109", "団体別受診者（健診基本情報）CSV出力よりファイル出力を行った")

''''''''''''''''''■■■■■■■■■■ 画面項目にあわせて編集
'''''''''''''''''		'オブジェクトのインスタンス作成（プロジェクト名.クラス名）
		Set objPrintCls = Server.CreateObject("HainsAbsenceListBASIC.AbsenceListBASIC")
'''''''''''''''''			'プロジェクト名はソースを開いて確認。
'''''''''''''''''
...
<TITLE>団体別受診者（健診基本情報）CSV出力</TITLE>
...
<!--- タイトル -->
	<TABLE BORDER="0" CELLPADDING="2" CELLSPACING="1" BGCOLOR="#999999" WIDTH="650">
		<TR>
			<TD HEIGHT="15" BGCOLOR="#ffffff" NOWRAP><B><SPAN CLASS="print">■団体別受診者（健診基本情報）CSV </SPAN></B></TD>
		</TR>
	</TABLE>
<%
'エラーメッセージ表示
