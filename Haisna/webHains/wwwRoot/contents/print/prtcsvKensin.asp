...
'''オブジェクトのインスタンス作成（プロジェクト名.クラス名）
        Set objPrintCls = Server.CreateObject("HainsAbsenceListKen.AbsenceListKen")

        Ret = objPrintCls.PrintAbsenceListKen(Session("USERID"), CDate(strSCslDate), CDate(strECslDate), strOrgGrpCd, strOrgCd11, strOrgCd12,strOrgCd21, strOrgCd22, strOrgCd31, strOrgCd32, strOrgCd41, strOrgCd42, strOrgCd51, strOrgCd52, strCourseCd)
...
<!--- タイトル -->
    <TABLE BORDER="0" CELLPADDING="2" CELLSPACING="1" BGCOLOR="#999999" WIDTH="650">
        <TR>
            <TD HEIGHT="15" BGCOLOR="#ffffff" NOWRAP><B><SPAN CLASS="print">■団体健診金額CSV出力</SPAN></B></TD>
        </TR>
    </TABLE>
<%
'エラーメッセージ表示
...
<!--- 印刷ボタン -->
    ...
    <% If Session("PAGEGRANT") = "4" Then   %>
        <a href="javascript:check();"><img src="/webHains/images/print.gif"></a>
    <%  End if  %>
