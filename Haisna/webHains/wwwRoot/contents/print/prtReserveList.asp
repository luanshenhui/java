...
Function Print()
	...
	If Not IsArray(CheckValue()) Then
		...
		'情報漏えい対策用ログ書き出し
		Call putPrivacyInfoLog("PH021", "予約者一覧表の印刷を行った")

		Set objCommon = Server.CreateObject("HainsCommon.Common")

		'オブジェクトのインスタンス作成（プロジェクト名.クラス名）
		Set objPrintCls = Server.CreateObject("HainsprtReserveList.prtReserveList")
...
<!--- タイトル -->
	<TABLE BORDER="0" CELLPADDING="2" CELLSPACING="1" BGCOLOR="#999999" WIDTH="650">
		<TR>
			<TD HEIGHT="15" BGCOLOR="#ffffff" NOWRAP><B><SPAN CLASS="print">■予約者一覧表</SPAN></B></TD>
		</TR>
	</TABLE>
<%
'エラーメッセージ表示
