...
'''''''''''''''''		'オブジェクトのインスタンス作成（プロジェクト名.クラス名）
		Set objPrintCls = Server.CreateObject("HainsAbsenceListSTD_NEW.AbsenceListSTD")

'''''''''''''''''			'プロジェクト名はソースを開いて確認。
'''''''''''''''''
'''''''''''''''''		'団体一覧表ドキュメントファイル作成処理（オブジェクト.メソッド名(引数)）
		Ret = objPrintCls.PrintAbsenceListSTD(Session("USERID"), CDate(strSCslDate), CDate(strECslDate), strFType, strOrgGrpCd, strOrgCd11, strOrgCd12,strOrgCd21, strOrgCd21, strOrgCd31, strOrgCd32, strOrgCd41, strOrgCd42, strOrgCd51, strOrgCd52)
