...
'◆ 集計内容
	strContents 	= Request("Contents")		'集計方法
...
Function Print()
	...
	Const PRT_TEMPPATH = "/webHains/Temp/"			'ＣｏＲｅｐｏｒｔワーク
	
	
	If Not IsArray(CheckValue()) Then
		'団体別予約受診人数統計帳票
		'オブジェクトのインスタンス作成（プロジェクト名.クラス名）
		Set objPrintCls = Server.CreateObject("HainsprtOrgConCount.prtOrgConsultCount")
...
<!--- タイトル -->
	<TABLE BORDER="0" CELLPADDING="2" CELLSPACING="1" BGCOLOR="#999999" WIDTH="650">
		<TR>
			<TD HEIGHT="15" BGCOLOR="#ffffff" NOWRAP><B><SPAN CLASS="print">■</SPAN>団体別予約受診人数統計</B></TD>
		</TR>
	</TABLE>
	<BR>
