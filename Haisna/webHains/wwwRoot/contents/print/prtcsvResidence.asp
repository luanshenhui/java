...
Function Print()
    ...
    If Not IsArray(CheckValue()) Then
		...
		'情報漏えい対策用ログ書き出し
		Call putPrivacyInfoLog("PH113", "聖路加レジデンス提供用CSV出力よりファイル出力を行った")

''''''''''''''''''■■■■■■■■■■ 画面項目にあわせて編集
'''''''''''''''''       'オブジェクトのインスタンス作成（プロジェクト名.クラス名）
        Set objPrintCls = Server.CreateObject("HainsAbsenceListResi.AbsenceListResi")
'''''''''''''''''       'プロジェクト名はソースを開いて確認。
'''''''''''''''''
'        Ret = objPrintCls.PrintAbsenceListResi(Session("USERID"), CDate(strSCslDate), CDate(strECslDate), strOrgGrpCd, strOrgCd11, strOrgCd12,strOrgCd21, strOrgCd22, strOrgCd31, strOrgCd32, strOrgCd41, strOrgCd42, strOrgCd51, strOrgCd52, strCourseCd, strSpItem, strCslDivCd, strOrgBill, strBillOrgCd1, strBillOrgCd2)

        Ret = objPrintCls.PrintAbsenceListResi(Session("USERID"), CDate(strSCslDate), CDate(strECslDate), strPerId, strOrgGrpCd, strOrgCd11, strOrgCd12,strOrgCd21, strOrgCd22, strOrgCd31, strOrgCd32, strOrgCd41, strOrgCd42, strOrgCd51, strOrgCd52, strCourseCd, strSpItem, strCslDivCd, strOrgBill, strBillOrgCd1, strBillOrgCd2)
...
<!--- タイトル -->
    <TABLE BORDER="0" CELLPADDING="2" CELLSPACING="1" BGCOLOR="#999999" WIDTH="650">
        <TR>
            <TD HEIGHT="15" BGCOLOR="#ffffff" NOWRAP><B><SPAN CLASS="print">■</SPAN>聖路加レジデンス提供用CSV出力</B></TD>
        </TR>
    </TABLE>
<%
'エラーメッセージ表示
...
<!--- 日付 -->
        ...
        <TR>
            ...
            <TD>
                <SELECT NAME="Course">
                    ...
                    <OPTION VALUE="133">レジデンス簡易健診</OPTION>
                </SELECT>
            </TD>
    ...
    <TABLE BORDER="0" CELLPADDING="2" CELLSPACING="1">
        <TR>
            ...
            <TD>
                <SELECT NAME="SpItem">
                    <OPTION VALUE="FPDITEM201410">聖路加レジデンス</OPTION>
                    <OPTION VALUE="SANTORI">サントリー健保</OPTION>
                </SELECT>
            </TD>
        </TR>
    </TABLE>
