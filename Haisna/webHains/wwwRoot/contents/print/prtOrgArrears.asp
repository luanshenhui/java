...
Function Print()
	...
	If Not IsArray(CheckValue()) Then
		...
		Set objPrintCls = Server.CreateObject("HainsprtOrgArrears.prtOrgArrears")
...
<FORM NAME="entryForm" ACTION="<%= Request.ServerVariables("SCRIPT_NAME") %>">
	...
	<TABLE BORDER="0" CELLPADDING="2" CELLSPACING="1" BGCOLOR="#999999" WIDTH="650">
		<TR>
			<TD HEIGHT="15" BGCOLOR="#ffffff" NOWRAP><B><SPAN CLASS="print">■未収団体一覧</SPAN></B></TD>
		</TR>
	</TABLE>
	<BR>
