...
Function CheckValue()
	...
	'ここにチェック処理を記述
	With objCommon
'		.AppendArray vntArrMessage, "コメント"
...
Function Print()
	...
	Dim objPrintCls		'Ｘ線受診状況（月）CSV作成用COMコンポーネント
	Dim Ret			'関数戻り値
	Dim strURL
	...
	If Not IsArray(CheckValue()) Then
		...
		Set objPrintCls = Server.CreateObject("HainsXsituationsMonth.XsituationsMonth")

	    	'Ｘ線受診状況（年）CSV作成処理
		Ret = objPrintCls.PrintXsituationsMonth(Session("USERID"), _
			                                strSCslYear, strSCslMonth, strNationCd)
...
<FORM NAME="entryForm" ACTION="<%= Request.ServerVariables("SCRIPT_NAME") %>">
	...
	<TABLE BORDER="0" CELLPADDING="2" CELLSPACING="1" BGCOLOR="#999999" WIDTH="650">
		<TR>
			<TD HEIGHT="15" BGCOLOR="#ffffff" NOWRAP><B><SPAN CLASS="print">■Ｘ線受診状況（月）</SPAN></B></TD>
		</TR>
	</TABLE>
	<BR>
<%
