...
Sub CreateOutputInfo()
    ...
    strArrOutputCls(1) = "1":strArrOutputClsName(1) = "眼底チェックリスト"
    strArrOutputCls(2) = "2":strArrOutputClsName(2) = "婦人科コメントチェックリスト"
    strArrOutputCls(3) = "3":strArrOutputClsName(3) = "胸部X線チェックリスト"
    strArrOutputCls(4) = "4":strArrOutputClsName(4) = "上部消化管チェックリスト"
    strArrOutputCls(5) = "5":strArrOutputClsName(5) = "腹部超音波チェックリスト"
    strArrOutputCls(6) = "6":strArrOutputClsName(6) = "胸部CTチェックリスト"
    strArrOutputCls(7) = "7":strArrOutputClsName(7) = "乳房チェックリスト"
