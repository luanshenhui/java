...
Function Print()
	...
	If Not IsArray(CheckValue()) Then
		...
		Set objPrintCls = Server.CreateObject("HainsGFConditions.GFConditions")

		'人間ドック症例別人数統計ドキュメントファイル作成処理（オブジェクト.メソッド名(引数)）
		Ret = objPrintCls.PrintGFConditions( _
						Session("USERID"), _
						, _
						strSCslDate _
						 ) 
...
<FORM NAME="entryForm" ACTION="<%= Request.ServerVariables("SCRIPT_NAME") %>">
	...
	<TABLE BORDER="0" CELLPADDING="2" CELLSPACING="1" BGCOLOR="#999999" WIDTH="650">
		<TR>
			<TD HEIGHT="15" BGCOLOR="#ffffff" NOWRAP><B><SPAN CLASS="print">■</SPAN>≪内視鏡≫実施状況</B></TD>
		</TR>
	</TABLE>
	<BR>
