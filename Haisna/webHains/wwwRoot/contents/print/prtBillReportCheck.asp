...
'#### 2010.05.11 SL-UI-Y0101-235 MOD START ####'
'        Set objCommon = Server.CreateObject("HainsCommon.Common")
'        strURL = "/webHains/contents/report_form/rd_28_prtBillReportCheck.asp"
...
'        Response.End
		...
		Set objPrintCls = Server.CreateObject("HainsprtBillReportCheck.prtBillRepCheck")
...
'#### 2010.05.11 SL-UI-Y0101-235 MOD END ####'
...
<FORM NAME="entryForm" ACTION="<%= Request.ServerVariables("SCRIPT_NAME") %>">
    ...
    <TABLE BORDER="0" CELLPADDING="2" CELLSPACING="1" BGCOLOR="#999999" WIDTH="650">
        <TR>
            <TD HEIGHT="15" BGCOLOR="#ffffff" NOWRAP><B><SPAN CLASS="print">■請求書チェックリスト（成績書）</SPAN></B></TD>
        </TR>
    </TABLE>
<%
    'エラーメッセージ表示
