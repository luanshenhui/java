...
Set objCommon = Server.CreateObject("HainsCommon.Common")
strURL = "/webHains/contents/report_form/rd_18_prtBill.asp"
...
strURL = strURL & "&p_BilBan=" & strBillNo2 
...
Sub CreateOutputInfo()
	...
	strArrOutputCls(0) = "0":strArrOutputClsName(0) = "請求書"
	strArrOutputCls(1) = "1":strArrOutputClsName(1) = "領収書"
...
<!--- タイトル -->
	<TABLE BORDER="0" CELLPADDING="2" CELLSPACING="1" BGCOLOR="#999999" WIDTH="650">
		<TR>
			<TD HEIGHT="15" BGCOLOR="#ffffff" NOWRAP><B><SPAN CLASS="print">■</SPAN><FONT COLOR="#000000">請求書・領収書</FONT></B></TD>
		</TR>
	</TABLE>
	<BR>
...
<!--- 日付 -->
	...
	<TABLE BORDER="0" CELLPADDING="1" CELLSPACING="2">
		<TR>
			...
			<BR>
			<!--- 印刷モード -->
<!--  2003/03/05  ADD  START  E.Yamamoto  印刷は全てプレビューとするため固定設定とする  -->
