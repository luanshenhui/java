...
Function Print()
	...
	If Not IsArray(CheckValue()) Then
		...
		Set objPrintCls = Server.CreateObject("HainsprtRsvMngMonthly.prtRsvMngMonthly")
...
<!--- タイトル -->
	<TABLE BORDER="0" CELLPADDING="2" CELLSPACING="1" BGCOLOR="#999999" WIDTH="650">
		<TR>
			<TD HEIGHT="15" BGCOLOR="#ffffff" NOWRAP><B><SPAN CLASS="print">■</SPAN>予約管理（Monthly）</SPAN></B></TD>
		</TR>
	</TABLE>
<%
	'エラーメッセージ表示
