...
Dim objCommon
	...
	'情報漏えい対策用ログ書き出し
	Call putPrivacyInfoLog("PH026", "ワークシート８項目の印刷を行った")
...
'#### 2010.05.27 SL-UI-Y0101-210 MOD START ####'
'Set objCommon = Server.CreateObject("HainsCommon.Common")
'strURL = "/webHains/contents/report_form/rd_12_prtWorkSheetCheck.asp"
...
'Response.End
        ...
        'オブジェクトのインスタンス作成（プロジェクト名.クラス名）
        Set objPrintCls = Server.CreateObject("HainsprtWorkSheetCheck.prtWkSheetCheck")
        'ドキュメントファイル作成処理（オブジェクト.メソッド名(引数)）
        Ret = objPrintCls.PrintOut(UID, strSCslDate, strECslDate)
        Print = Ret
'#### 2010.05.27 SL-UI-Y0101-210 MOD END ####'
	End If
...
<!--- タイトル -->
	<TABLE BORDER="0" CELLPADDING="2" CELLSPACING="1" BGCOLOR="#999999" WIDTH="650">
		<TR>
			<TD HEIGHT="15" BGCOLOR="#ffffff" NOWRAP><B><SPAN CLASS="print">■</SPAN>ワークシート８項目</B></TD>
		</TR>
	</TABLE>
<%
'エラーメッセージ表示
