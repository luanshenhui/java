VERSION 5.00
Begin VB.Form frmSelectCopyStdValue 
   ...
   ClientTop       =   330
   ClientWidth     =   7185
   Icon            =   "frmSelectCopyStdValue.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   1845
   ...
   Begin VB.ComboBox cboHistory 
      Height          =   300
      ItemData        =   "frmSelectCopyStdValue.frx":000C
      Left            =   1080
      List            =   "frmSelectCopyStdValue.frx":002E
   ...
   Begin VB.Image Image1 
      Height          =   480
      Left            =   240
      Picture         =   "frmSelectCopyStdValue.frx":0050
      Top             =   180
      Width           =   480
   End
End
Attribute VB_Name = "frmSelectCopyStdValue"
...
Private Sub Form_Load()
    ...
    Dim i   As Integer
    Dim objHistory  As StdValue_Record
