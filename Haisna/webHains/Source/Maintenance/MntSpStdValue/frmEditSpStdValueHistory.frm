VERSION 5.00
Begin VB.Form frmEditSpStdValueHistory 
   BorderStyle     =   3  '固定ﾀﾞｲｱﾛｸﾞ
   Caption         =   "特定健診基準値履歴情報の設定"
   ClientHeight    =   1245
   ClientLeft      =   2580
   ClientTop       =   3225
   ClientWidth     =   7185
   ...
   EndProperty
   Icon            =   "frmEditSpStdValueHistory.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   1245
   ...
   Begin VB.ComboBox cboCourse 
      Height          =   300
      ItemData        =   "frmEditSpStdValueHistory.frx":000C
      Left            =   1380
      List            =   "frmEditSpStdValueHistory.frx":002E
   ...
   Begin VB.ComboBox cboEndDay 
      Height          =   300
      ItemData        =   "frmEditSpStdValueHistory.frx":0050
      Left            =   6240
      List            =   "frmEditSpStdValueHistory.frx":0057
      Style           =   2  'ﾄﾞﾛｯﾌﾟﾀﾞｳﾝ ﾘｽﾄ
      TabIndex        =   5
      Top             =   240
      Width           =   555
   ...
   Begin VB.ComboBox cboEndMonth 
      Height          =   300
      ItemData        =   "frmEditSpStdValueHistory.frx":005F
      Left            =   5340
      List            =   "frmEditSpStdValueHistory.frx":0066
      Style           =   2  'ﾄﾞﾛｯﾌﾟﾀﾞｳﾝ ﾘｽﾄ
      TabIndex        =   4
      Top             =   240
      Width           =   555
   ...
   Begin VB.ComboBox cboEndYear 
      Height          =   300
      ItemData        =   "frmEditSpStdValueHistory.frx":006E
      Left            =   4320
      List            =   "frmEditSpStdValueHistory.frx":0075
      Style           =   2  'ﾄﾞﾛｯﾌﾟﾀﾞｳﾝ ﾘｽﾄ
      TabIndex        =   3
      Top             =   240
      Width           =   735
   ...
   Begin VB.ComboBox cboStrDay 
      Height          =   300
      ItemData        =   "frmEditSpStdValueHistory.frx":007F
      Left            =   3300
      List            =   "frmEditSpStdValueHistory.frx":0086
      Style           =   2  'ﾄﾞﾛｯﾌﾟﾀﾞｳﾝ ﾘｽﾄ
      TabIndex        =   2
      Top             =   240
      Width           =   555
   ...
   Begin VB.ComboBox cboStrMonth 
      Height          =   300
      ItemData        =   "frmEditSpStdValueHistory.frx":008E
      Left            =   2400
      List            =   "frmEditSpStdValueHistory.frx":0095
      Style           =   2  'ﾄﾞﾛｯﾌﾟﾀﾞｳﾝ ﾘｽﾄ
      TabIndex        =   1
      Top             =   240
      Width           =   555
   ...
   Begin VB.ComboBox cboStrYear 
      Height          =   300
      ItemData        =   "frmEditSpStdValueHistory.frx":009D
      Left            =   1380
      List            =   "frmEditSpStdValueHistory.frx":00A4
      Style           =   2  'ﾄﾞﾛｯﾌﾟﾀﾞｳﾝ ﾘｽﾄ
      TabIndex        =   0
      Top             =   240
      Width           =   735
   ...
   End
End
Attribute VB_Name = "frmEditSpStdValueHistory"
