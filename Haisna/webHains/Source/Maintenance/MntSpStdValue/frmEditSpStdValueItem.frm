...
Begin VB.Form frmEditSpStdValueItem 
   BorderStyle     =   3  '固定ﾀﾞｲｱﾛｸﾞ
   Caption         =   "特定健診基準値設定値の変更"
   ClientHeight    =   6495
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7275
   ...
   EndProperty
   Icon            =   "frmEditSpStdValueItem.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6495
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox cboStdFlg 
         ...
         EndProperty
         Height          =   300
         ItemData        =   "frmEditSpStdValueItem.frx":000C
         Left            =   2220
         List            =   "frmEditSpStdValueItem.frx":002E
      ...
      Begin VB.ComboBox cboJud 
         ...
         EndProperty
         Height          =   300
         ItemData        =   "frmEditSpStdValueItem.frx":0050
         Left            =   2220
         List            =   "frmEditSpStdValueItem.frx":0072
         Style           =   2  'ﾄﾞﾛｯﾌﾟﾀﾞｳﾝ ﾘｽﾄ
         TabIndex        =   9
         Top             =   780
         Width           =   2550
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboTeisei 
         ...
         EndProperty
         Height          =   300
         ItemData        =   "frmEditSpStdValueItem.frx":0094
         Left            =   2220
         List            =   "frmEditSpStdValueItem.frx":00B6
         Style           =   2  'ﾄﾞﾛｯﾌﾟﾀﾞｳﾝ ﾘｽﾄ
         TabIndex        =   22
         Top             =   780
         Width           =   1470
   ...
   Begin MSComctlLib.ImageList imlToolbarIcons 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditSpStdValueItem.frx":00D8
            Key             =   "CLOSED"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditSpStdValueItem.frx":052A
            Key             =   "OPEN"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditSpStdValueItem.frx":097C
            Key             =   "MYCOMP"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEditSpStdValueItem.frx":0AD6
            Key             =   "DEFAULTLIST"
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "frmEditSpStdValueItem"
