...
On Error GoTo ErrorHandle
    ...
    Dim orgCD1 As Variant
    Dim orgCD2 As Variant
...
'    End If
    ...
    Set objItem = CreateObject("HainsORGItem.Item")
    lngCount = objItem.SelectItem_pList(orgCD1, orgCD2, orgNAME)
    
    'ヘッダの編集
    Set objHeader = lsvItem.ColumnHeaders
    objHeader.Clear
    objHeader.Add , , "コード1", 1000, lvwColumnLeft
    objHeader.Add , , "コード2", 1000, lvwColumnLeft
    objHeader.Add , , "団体名称", 2000, lvwColumnLeft
    ...
    For i = 0 To lngCount - 1
        ...
        Set objListItem = lsvItem.ListItems.Add(, mstrListViewKey & strItemCd & i, strItemCd)
        objListItem.SubItems(1) = orgCD2(i)
        objListItem.SubItems(2) = orgNAME(i)
    ...
    Do
        ...
        For i = 1 To lsvItem.ListItems.Count
            If lsvItem.ListItems(i).Selected = True Then
                ...
                Else
                    mvntItemCd(j) = Mid(strWorkKey, 1, 5)
                    mvntSuffix(j) = Mid(strWorkKey, 6)
                End If
