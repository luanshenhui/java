...
Private Sub cmdAddItem_Click()
    ...
    Dim vntPgmName          As Variant      '選択された業務名
    Dim vntPgmFileName      As Variant      '選択されたプログラム名
    Dim vntPgmGrant         As Variant      '選択された
...
Private Function RegistGrp() As Boolean
    ...
    strUsrGrpcd = mstrSecurityGrpCd        'ユーザーグループコード
...
'
    ...
    If lngRet = 0 Then
        MsgBox "データ保存に失敗しました。", vbExclamation
        Exit Function
    End If
...
Private Sub MoveListItem(intMovePosition As Integer)
    ...
    With lsvItem.ColumnHeaders
        ...
        .Add , , "業務名", 2200, lvwColumnLeft
        .Add , , "プログラム名", 2000, lvwColumnLeft    ' 2005.08.23 追加
        .Add , , "操作権限", 1100, lvwColumnLeft
        .Add , , "Seq", 600, lvwColumnLeft
        .Add , , "権限フラグ", 500, lvwColumnLeft
...
Private Function EditListItem(iMode As Integer) As Boolean
    ...
    Dim vntUsrGrpCd         As Variant              'ユーザーグループ
    Dim vntPgmCd            As Variant              'プログラムコード
    Dim vntPgmName          As Variant              '業務名称
    Dim vntPgmFileName      As Variant              'プログラム名称
    Dim vntPgmGrant         As Variant              'プログラム操作権限フラグ
    Dim vntGrantName        As Variant              'プログラム操作権限名
    Dim vntDispSeq          As Variant              '画面表示順序
    Dim vntDelFlg           As Variant
    Dim vntMenuName         As Variant
    
    Dim lngCount            As Long                 'レコード数
    Dim strSelectKey        As String               'リストビュー用アイテムキー
