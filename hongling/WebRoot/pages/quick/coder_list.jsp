...
<style type="text/css">
 table#border{ border-top:#c69b6e 1px solid; border-left:#c69b6e 1px solid; } 
 table#border td{ border-bottom:#c69b6e 1px solid; border-right:#c69b6e 1px solid;text-align: center; } 
 h3{height:30px;}
</style>
<div STYLE="margin: 0px auto;text-align: center;width:600px;color:#000000;padding-top:30px;">
...
<table width="600" border="0"  align="center" cellspacing="0"  id="border">
  ...
  <tr>
    <td height="70" colspan="3">
   	  <textarea name="showbom" id="showbom" style="width:390px;height:70px;resize:none;background-color:#c69b6e;"></textarea>
    </td>
  </tr>
</table>
</div>