...
jQuery.csImportAssemble = {
	...
	save : function() {
		...
		var requestUrl = $.csCore
				.buildServicePath('/service/assemble/importAssemble');
		$.ajaxFileUpload({
...
//				alert(JSON.stringify(data));
	...
	init : function() {
		$.csImportAssemble.bindLabel();
		$.csImportAssemble.bindEvent();
	}
};