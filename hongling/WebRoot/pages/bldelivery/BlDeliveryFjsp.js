jQuery.csBlDeliveryFList={
	...
	bindEvent:function (){
		...
		// 绑定事件
			...
			$("#blBtnDelivery").click(function(){$.csCore.loadModal($.csBlDeliveryFList.getPath()+'/pages/bldelivery/delivery.jsp',760,440,function(){$.csOrdenDelivery.init();});});
		}
		
		$("#blBtnDeliverySetting").click(function(){$.csCore.loadModal($.csBlDeliveryFList.getPath()+'/pages/bldelivery/setting.jsp',760,440,function(){$.csDeliverySetting.init();});});
		$("#blBtnDeliveryDetail").click(function(){$.csCore.loadModal($.csBlDeliveryFList.getPath()+'/pages/bldelivery/BlDeliveryDetailF.jsp',760,440,function(){$.csBlDeliveryDetailFList.init();});});
	...
	initDelivery: function(deliveryType) {
		...
		if (deliveryType==DICT_APPLY_DELIVERY_TYPE_AUTO) {
			...
			$("#blBtnDelivery").unbind("click");
			// 绑定事件
			$("#blBtnDelivery").click(function(){$.csCore.loadModal('../bldelivery/delivery.jsp',760,440,function(){$.csOrdenDelivery.init();});});
		}
	},
	init:function(){
		$.csBlDeliveryFCommon.bindLabel();
