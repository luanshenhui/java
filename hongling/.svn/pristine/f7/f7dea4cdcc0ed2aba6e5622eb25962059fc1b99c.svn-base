...
public class DESCrypt {
	private static String strDefaultKey = "hongling";
	...
	public static void main(String[] args) throws Exception {
		DESCrypt des = new DESCrypt("www.rcmtm.com");
		String str1 = "中文测试";
		// DES加密
		String str2 = des.getEncString(str1);
		String deStr = des.getDesString(str2);
//		System.out.println("密文:" + str2.toUpperCase());
		// DES解密
		...
		String encodeByte = base64Encoder.encode(des.encrypt(str1.getBytes("UTF8")));
		System.out.println("demo:     "+encodeByte);
	}
}