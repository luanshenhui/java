...
public class DeleteRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the in0 value for this DeleteRequest.
     * 
     * @return in0
     */
    public int getIn0() {
    ...
    /**
     * Sets the in0 value for this DeleteRequest.
     * 
     * @param in0
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://oa.rcmtm.com/services/RequestService", ">deleteRequest"));
