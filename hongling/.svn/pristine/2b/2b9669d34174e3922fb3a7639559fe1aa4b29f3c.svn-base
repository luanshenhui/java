...
public class WorkflowServiceLocator extends org.apache.axis.client.Service implements oa.weaver.services.WorkflowService.WorkflowService {
    ...
    private java.lang.String WorkflowServiceHttpPort_address = "http://oa.rcmtm.com/services/WorkflowService";
    ...
    public oa.weaver.services.WorkflowService.WorkflowServicePortType getWorkflowServiceHttpPort() throws javax.xml.rpc.ServiceException {
    ...
    public oa.weaver.services.WorkflowService.WorkflowServicePortType getWorkflowServiceHttpPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            oa.weaver.services.WorkflowService.WorkflowServiceHttpBindingStub _stub = new oa.weaver.services.WorkflowService.WorkflowServiceHttpBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (oa.weaver.services.WorkflowService.WorkflowServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                oa.weaver.services.WorkflowService.WorkflowServiceHttpBindingStub _stub = new oa.weaver.services.WorkflowService.WorkflowServiceHttpBindingStub(new java.net.URL(WorkflowServiceHttpPort_address), this);
                _stub.setPortName(getWorkflowServiceHttpPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://oa.rcmtm.com/services/WorkflowService", "WorkflowService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://oa.rcmtm.com/services/WorkflowService", "WorkflowServiceHttpPort"));
        }
