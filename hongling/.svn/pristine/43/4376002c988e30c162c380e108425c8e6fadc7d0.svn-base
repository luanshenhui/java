...
public class GetRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the in0 value for this GetRequest.
     * 
     * @return in0
     */
    public int getIn0() {
    ...
    /**
     * Sets the in0 value for this GetRequest.
     * 
     * @param in0
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://oa.rcmtm.com/services/RequestService", ">getRequest"));
