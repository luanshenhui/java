...
$(document).ready(function (){
	...
	$.csCore.getValue("Member_Username",null,"lblName");
	$.csCore.getValue("Member_Password",null,"lblPassword");
	$.csCore.getValue("Common_Captcha",null,"lblCaptcha");
	$.csCore.getValue("Button_OK",null,"btnSubmit");
    $("#imgCaptcha").attr("src",$.csCore.buildServicePath('/service/core/getcaptcha'));
...
jQuery.csLogin={
	...
	realm : function(){
		...
		if ($.csValidator.isNull(realmdata) || $.csValidator.isNull(realmdata.customerName)){
			$("#logo_login").html("<img src='../../themes/default/images/realm/rcmtm.gif'></img>");
			$("#lblLogoTitle").html($.csCore.getValue("Common_LogoTitle"));
		}else{
