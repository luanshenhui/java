...
public class WorkflowDetailTableInfo  implements java.io.Serializable {
    ...
    private oa.weaver.workflow.webservices.WorkflowRequestTableRecord[] workflowRequestTableRecords;
    ...
    public WorkflowDetailTableInfo(
           ...
           oa.weaver.workflow.webservices.WorkflowRequestTableRecord[] workflowRequestTableRecords) {
     ...
     */
    public oa.weaver.workflow.webservices.WorkflowRequestTableRecord[] getWorkflowRequestTableRecords() {
        return workflowRequestTableRecords;
    }
     ...
     */
    public void setWorkflowRequestTableRecords(oa.weaver.workflow.webservices.WorkflowRequestTableRecord[] workflowRequestTableRecords) {
        this.workflowRequestTableRecords = workflowRequestTableRecords;
    }
