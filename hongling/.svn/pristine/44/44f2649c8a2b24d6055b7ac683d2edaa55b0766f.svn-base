...
<script type="text/javascript" src="../fabricInfoReport/list.js">
</script>
<div>
	<div id="search" class="list_search">
		...
		<a id="btnExportFabricInfo" ><s:text name="导出"></s:text></a>
	</div>
	<div id="FabricInfoReportResult"></div>
	<div id="overdue" style="display:none;"></div>
	<div id="FabricInfoReportStatistic" class="pagingleft"></div>
	<div id="FabricInfoReportPagination" class="paging"></div>
	<textarea id="FabricInfoReportTemplate" class="list_template">
