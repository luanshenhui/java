...
public class WorkflowMainTableInfo  implements java.io.Serializable {
    private oa.weaver.workflow.webservices.WorkflowRequestTableRecord[] requestRecords;
    ...
    public WorkflowMainTableInfo(
           oa.weaver.workflow.webservices.WorkflowRequestTableRecord[] requestRecords,
     ...
     */
    public oa.weaver.workflow.webservices.WorkflowRequestTableRecord[] getRequestRecords() {
        return requestRecords;
    }
     ...
     */
    public void setRequestRecords(oa.weaver.workflow.webservices.WorkflowRequestTableRecord[] requestRecords) {
        this.requestRecords = requestRecords;
    }
