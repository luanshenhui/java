...
public class WorkflowRequestTableRecord  implements java.io.Serializable {
    ...
    private oa.weaver.workflow.webservices.WorkflowRequestTableField[] workflowRequestTableFields;
    ...
    public WorkflowRequestTableRecord(
           ...
           oa.weaver.workflow.webservices.WorkflowRequestTableField[] workflowRequestTableFields) {
     ...
     */
    public oa.weaver.workflow.webservices.WorkflowRequestTableField[] getWorkflowRequestTableFields() {
        return workflowRequestTableFields;
    }
     ...
     */
    public void setWorkflowRequestTableFields(oa.weaver.workflow.webservices.WorkflowRequestTableField[] workflowRequestTableFields) {
        this.workflowRequestTableFields = workflowRequestTableFields;
    }
