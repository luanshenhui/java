...
public class CreateRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the in0 value for this CreateRequest.
     * 
     * @return in0
     */
    ...
    /**
     * Sets the in0 value for this CreateRequest.
     * 
     * @param in0
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://oa.rcmtm.com/services/RequestService", ">createRequest"));
