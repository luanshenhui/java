...
public class WorkflowServicePortTypeProxy implements oa.weaver.services.WorkflowService.WorkflowServicePortType {
  private String _endpoint = null;
  private oa.weaver.services.WorkflowService.WorkflowServicePortType workflowServicePortType = null;
  ...
  private void _initWorkflowServicePortTypeProxy() {
    try {
      workflowServicePortType = (new oa.weaver.services.WorkflowService.WorkflowServiceLocator()).getWorkflowServiceHttpPort();
  ...
  public oa.weaver.services.WorkflowService.WorkflowServicePortType getWorkflowServicePortType() {
    if (workflowServicePortType == null)
      _initWorkflowServicePortTypeProxy();
