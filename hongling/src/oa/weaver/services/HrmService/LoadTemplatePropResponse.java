...
public class LoadTemplatePropResponse  implements java.io.Serializable {
    private oa.weaver.services.HrmService.AnyType2AnyTypeMapEntry[] out;

    public LoadTemplatePropResponse() {
    }

    public LoadTemplatePropResponse(
           oa.weaver.services.HrmService.AnyType2AnyTypeMapEntry[] out) {
           this.out = out;
    }
     ...
     * @return out
     */
    public oa.weaver.services.HrmService.AnyType2AnyTypeMapEntry[] getOut() {
        return out;
    }
     ...
     * @param out
     */
    public void setOut(oa.weaver.services.HrmService.AnyType2AnyTypeMapEntry[] out) {
        this.out = out;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://oa.rcmtm.com/services/HrmService", ">LoadTemplatePropResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://oa.rcmtm.com/services/HrmService", ">anyType2anyTypeMap>entry"));
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("http://oa.rcmtm.com/services/HrmService", "entry"));
