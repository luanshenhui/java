...
public class HrmServiceLocator extends org.apache.axis.client.Service implements oa.weaver.services.HrmService.HrmService {
    ...
    private java.lang.String HrmServiceHttpPort_address = "http://oa.rcmtm.com/services/HrmService";
    ...
    public oa.weaver.services.HrmService.HrmServicePortType getHrmServiceHttpPort() throws javax.xml.rpc.ServiceException {
    ...
    public oa.weaver.services.HrmService.HrmServicePortType getHrmServiceHttpPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            oa.weaver.services.HrmService.HrmServiceHttpBindingStub _stub = new oa.weaver.services.HrmService.HrmServiceHttpBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (oa.weaver.services.HrmService.HrmServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                oa.weaver.services.HrmService.HrmServiceHttpBindingStub _stub = new oa.weaver.services.HrmService.HrmServiceHttpBindingStub(new java.net.URL(HrmServiceHttpPort_address), this);
                _stub.setPortName(getHrmServiceHttpPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://oa.rcmtm.com/services/HrmService", "HrmService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://oa.rcmtm.com/services/HrmService", "HrmServiceHttpPort"));
        }
