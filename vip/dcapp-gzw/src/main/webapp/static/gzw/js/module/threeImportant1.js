...
$(function () {
    ...
    $.each(arrTitle,function(i,o){
        $.post("/a/index/api",{
            _id:'gzw_three_important_bubble',
            arr1: arrId[j],
            arr2: arrTitle[i]
        },function (res1) {
            var num1 = res1[0].c1;
    ...
    $('.tree-step>span').click(function(){
        ...
        //取告警约束数值
        $.post("/a/index/api",{
            _id:'gzw_three_important_pop_alarm',
            pop1: arrId[j],
            pop2: tit
        },function (res2) {
        ...
        //取风险约束数值
        $.post("/a/index/api",{
            _id:'gzw_three_important_pop_risk',
            pop1: arrId[j],
            pop2: tit
        },function (res3) {
    ...
    //系统播报信息
    var titleId = arrId[j].substr(0,2);
    $.post("/a/index/api",{
        _id:'gzw_three_important_broadcast',
        arr: titleId
    },function (res4) {
        var news1,news2;
