+function ($) {
    ...
    //定义一个区域图类：
    var webFlowSimple = function (element, options) {
        ...
        if (navigator.userAgent.indexOf("MSIE 8.0") > 0 || navigator.userAgent.indexOf("MSIE 7.0") > 0 || navigator.userAgent.indexOf("MSIE 6.0") > 0) {
            ...
            webFlowSimple.prototype.useSVG = "";
            //低于ie8
        }
        else {

            webFlowSimple.prototype.useSVG = "1"
        ...
        this.$element.addClass("GooFlowS");

        if (webFlowSimple.prototype.color.font) {

            this.$element.css("color", webFlowSimple.prototype.color.font);

        }

        var width = (this.options.width || 1000);

        var height = (this.options.height || 840);
      ...
      /*  var tmp = "";*/
        ...
        /*if (this.options.haveHead) {
            ...
            tmp = "<div class='GooFlowS_head' " + (webFlowSimple.prototype.color.main ? "style='border-bottom-color:" + webFlowSimple.prototype.color.main + "'" : "") + ">";
            ...
            if (this.options.headLabel) {
                ...
                tmp += "<label title='" + (this.options.initLabelText) + "' "
                    ...
                    + (webFlowSimple.prototype.color.main ? "style='background:" + webFlowSimple.prototype.color.main + "'" : "") + ">" + (this.options.initLabelText) + "</label>";
            ...
            for (var x = 0; x < this.options.headBtns.length; ++x) {
                ...
                if (this.options.headTitle) {
                    ...
                    tmp += "<a href='javascript:void(0)' class='GooFlowS_head_btn GooFlowS_head_btn-text'><i class='ico_" + this.options.headBtns[x] + "'></i>" + this.options.headTitle[x] + "</a>"

                } else {

                    tmp += "<a href='javascript:void(0)' class='GooFlowS_head_btn'><i class='ico_" + this.options.headBtns[x] + "'></i></a>"
        ...
        if (this.options.haveTool) {
            ...
            /*this.$element.append("<div class='GooFlowS_tool'" + (this.options.haveHead ? "" : " style='margin-top:3px'") + "><div style='height:" + (height - headHeight - (this.options.haveHead ? 7 : 10)) + "px' class='GooFlowS_tool_div'></div></div>");*/

            //.GooFlowS_tool div  就是 class='GooFlowS_tool_div' 这个元素
            this.$tool = this.$element.find(".GooFlowS_tool div");
            ...
            if (this.options.haveGroup) {
                ...
                this.$tool.append("<span/><a href='javascript:void(0)' type='group' title='工作区' class='GooFlowS_tool_btn' id='btn_group'><i class='ico_group'/></a>");
        ...
        this.$element.append("<div class='GooFlowS_work' style='width:" + (width) + "px;height:" + (height) + "px;" + (this.options.haveHead ? "" : "margin-top:3px") + "'></div>");

        this.$workArea = $("<div class='GooFlowS_work_inner' style='width:" + width  + "px;height:" + height  + "px'></div>").attr({
        ...
        this.$element.children(".GooFlowS_work").append(this.$workArea);
            ...
            this.$workArea.on("click", {inthis: this}, function (e) {
               ...
               var type = This.$nowType;
                 ...
                 if (type == "cursor") {
                    ...
                    if (n == "svg" || (n == "DIV" && t.prop("class").indexOf("GooFlowS_work") > -1) || n == "LABEL") {
...
/*
            ...
            this.$workArea.mousemove({inthis: this}, function (e) {
                ...
                var line = document.getElementById("GooFlowS_tmp_line");

                // console.log(lineStart)
                if (lineStart) {


                    if (webFlowSimple.prototype.useSVG != "") {
            ...
            this.$workArea.mouseup({inthis: this}, function (e) {
                ...
                var tmp = document.getElementById("GooFlowS_tmp_line");
            ...
            this.$lineMove = $("<div class='GooFlowS_line_move' style='display:none'></div>");//操作折线时的移动框
            ...
            this.$lineMove.on("mousedown", {inthis: this}, function (e) {
                ...
                lm.css({"background-color": webFlowSimple.prototype.color.font || "#333"});
            ...
            //选定线时显示的操作框
           /* this.$lineOper = $("<div class='GooFlowS_line_oper' style='display:none'><i class='b_l1'></i><i class='b_l2'></i><i class='b_l3'></i><i class='b_x'></i></div>");
            ...
            this.$mpFrom = $("<div class='GooFlowS_line_mp' style='display:none'></div>");

            this.$mpTo = $("<div class='GooFlowS_line_mp' style='display:none'></div>");
            ...
            if (this.options.useOperStack && this.$editable) {
                ...
                //将外部的方法加入到webFlowSimple对象的事务操作堆栈中,在过后的undo/redo操作中可以进行控制，一般用于对流程图以外的附加信息进行编辑的事务撤销/重做控制；
        ...
        //弹出窗口
        var sureBtn = $('<a href="javascript:void(0)" class="btn-s btn-opear" data-role="save">保 存</a>'),

            cancelBtn = $('<a href="javascript:void(0)" class="btn-s btn-opear m-l-30" data-role="close">取 消</a>');
        ...
        _addTooButton.call(this);
    };


    webFlowSimple.prototype = {
        ...
        initDraw: function (id, width, height) {
            ...
            if (webFlowSimple.prototype.useSVG != "") {
                ...
                //#059eea 蓝线   #ed560d 红线
                defs.appendChild(webFlowSimple.prototype.getSvgMarker("arrow1", webFlowSimple.prototype.color.line || "#059eea"));

                defs.appendChild(webFlowSimple.prototype.getSvgMarker("arrow2", webFlowSimple.prototype.color.mark || "#ed560d"));

                defs.appendChild(webFlowSimple.prototype.getSvgMarker("arrow3", webFlowSimple.prototype.color.mark || "#ed560d"));
                ...
                this.$workArea.prepend("<div class='GooFlowS_work_vml' style='position:relative;width:" + width  + "px;height:" + height  + "px'></div>");
        ...
        initGroup: function (width, height) {
            ...
            //存放背景区域的容器
            this.$group = $("<div class='GooFlowS_work_group' style='width:" + width + "px;height:" + height+ "px'></div>");
        ...
        initLinePointsChg: function () {
            ...
            this.$mpFrom.on("mousedown", {inthis: this}, function (e) {
                ...
                var line = webFlowSimple.prototype.drawLine("GooFlowS_tmp_line", [ps[0], ps[1]], [pe[0], pe[1]], true, true);
        ...
        switchToolBtn: function (type) {
            ...
            this.$tool.children("#btn_" + this.$nowType.split(" ")[0]).attr("class", "GooFlowS_tool_btn");
            ...
            this.$tool.children("#btn_" + type.split(" ")[0]).attr("class", "GooFlowS_tool_btndown");
        ...
        addNode: function (id, json,tipData) {
            ...
            addCallback.add(function () {
                ...
                if (json.type.indexOf(" round") < 0) {
                    ...
                    var elem ="<div class='bubble_txt'><span>业务数据量 : "+tipData[json.name].bizDataCount+"</span><br /><span>告警数 ："+tipData[json.name].alarmCount+"</span><span>风险数 ："+tipData[json.name].riskCount+"</span>";
                    var tips="<div style='display:block'><div class='bubble'>"+elem+"</div></div>";

                    this.$nodeDom[id] = $("<div class='GooFlowS_item" + mark + "' id='" + id + "' data-id='" + id + "' style='top:" + json.top + "px;left:" + json.left + "px'><table cellspacing='1' style='width:" + (json.width - 2) + "px;height:" + (json.height - 2) + "px;'><tr><td class='ico'><i class='ico_" + json.type + "'></i><span data-node='name'>" + json.name + "</span></td></tr></table>"+tips+"</div>");
                    ...
                    this.$nodeDom[id] = $("<div class='GooFlowS_item item_round" + mark + "' id='" + id + "' data-id='" + id + "' style='top:" + json.top + "px;left:" + json.left + "px'><table cellspacing='0'><tr><td class='ico'><i class='ico_" + json.type + "'></i></td></tr></table><div  style='display:none'></div><div class='span'  data-node='name'>" + json.name + "</div></div>");

                }

                if (webFlowSimple.prototype.color.node) {

                    if (json.type.indexOf(" mix") > -1) {

                        this.$nodeDom[id].css({

                            "background-color": webFlowSimple.prototype.color.mix,

                            "border-color": webFlowSimple.prototype.color.mix
                        ...
                        this.$nodeDom[id].css({
                            ...
                            "background-color": webFlowSimple.prototype.color.node,

                            "border-color": webFlowSimple.prototype.color.node

                        });
                    }

                    if (mark && webFlowSimple.prototype.color.mark) {

                        this.$nodeDom[id].css({"border-color": webFlowSimple.prototype.color.mark});
        ...
        initWorkForNode: function () {
            ...
            //绑定点击事件
            this.$workArea.delegate(".GooFlowS_item", "click", {inthis: this}, function (e) {

                e.data.inthis.focusItem(this.id, true);

                $(this).removeClass("item_mark");

                if ($(this).find('i').hasClass('ico_start') || $(this).find('i').hasClass('ico_end')){
                    return;
                }else{
                    //弹出气泡
                ...
                //双击调用modal
               /* .delegate(".GooFlowS_item", "dblclick ", {inthis: this}, function (e) {
            ...
            this.$workArea.delegate(".ico", "mousedown", {inthis: this}, function (e) {
                ...
                var Dom = $(this).parents(".GooFlowS_item");
                ...
                document.onmouseup = function (e) {
                    ...
                    $(".GooFlowS_item").find("div").css("display","block");
                    This.$ghost.empty().hide();
            ...
            //绑定鼠标覆盖/移出事件
            this.$workArea.delegate(".GooFlowS_item", "mouseenter", {inthis: this}, function (e) {

                if (e.data.inthis.$nowType != "direct" && !document.getElementById("GooFlowS_tmp_line"))    return;

                $(this).addClass("item_mark").addClass("crosshair").css("border-color", webFlowSimple.prototype.color.mark || "#ed560d");

            });

            this.$workArea.delegate(".GooFlowS_item", "mouseleave", {inthis: this}, function (e) {
                ...
                if (this.id == e.data.inthis.$focus) {
                    ...
                    $(this).css("border-color", webFlowSimple.prototype.color.line || "#059eea");

                } else {

                    //#00a1e2 浅蓝色
                    $(this).css("border-color", webFlowSimple.prototype.color.node || "#00a1e2");
            ...
            //绑定连线时确定初始点
            this.$workArea.delegate(".GooFlowS_item", "mousedown", {inthis: this}, function (e) {
                ...
                var line = webFlowSimple.prototype.drawLine("GooFlowS_tmp_line", [X, Y], [X, Y], true, true);
            ...
            //绑定连线时确定结束点
            this.$workArea.delegate(".GooFlowS_item", "mouseup", {inthis: this}, function (e) {
                ...
                if (lineStart && !This.$mpTo.data("p")) {
                    ...
                    if (!This.$nodeData[this.id].marked) {
                        ...
                        if (this.id != This.$focus) {
                            ...
                            $(this).css("border-color", webFlowSimple.prototype.color.node);

                        }
                        else {

                            $(this).css("border-color", webFlowSimple.prototype.color.line);
           ...
           /* if (this.options.rename == true) {
                // 图标文字垂直排列
                this.$workArea.delegate(".GooFlowS_item > .span", "dblclick", {inthis: this}, function (e) {
                ...
                this.$workArea.delegate(".ico + td", "dblclick", {inthis: this}, function (e) {
                    ...
                    var id = $(this).parents(".GooFlowS_item").attr("id");
...
*/
           ...
           /* this.$workArea.delegate(".rs_close", "click", {inthis: this}, function (e) {
            ...
            //绑定结点的RESIZE功能,调整尺寸
            /*this.$workArea.delegate(".GooFlowS_item > div > div[class!=rs_close]", "mousedown", {inthis: this}, function (e) {
            ...
            if (this.$focus != "") {
                ...
                if (jq.prop("tagName") == "DIV") {
                    ...
                    blurCallback.add(function () {
                        ...
                        if (webFlowSimple.prototype.color.line) {

                            if (this.$nodeData[this.$focus].marked) {

                                jq.css("border-color", webFlowSimple.prototype.color.mark || "#ed560d");

                            }
                            else {

                                jq.css("border-color", webFlowSimple.prototype.color.node || "#00a1e2");
                    ...
                    blurCallback.add(function () {
                        ...
                        if (webFlowSimple.prototype.useSVG != "") {
                            ...
                            if (!this.$lineData[this.$focus].marked) {
                                ...
                                jq[0].childNodes[1].setAttribute("stroke", webFlowSimple.prototype.color.line || "#059eea");
                            ...
                            if (!this.$lineData[this.$focus].marked) {
                                ...
                                jq[0].strokeColor = webFlowSimple.prototype.color.line || "#059eea"
...
/*
                focusCallback.add(function () {
                    ...
                    if (webFlowSimple.prototype.color.line) {
                        ...
                        jq.css("border-color", webFlowSimple.prototype.color.line);
                ...
                focusCallback.add(function () {
                   ...
                   /* if (webFlowSimple.prototype.useSVG != "") {
                        ...
                        jq[0].childNodes[1].setAttribute("stroke", webFlowSimple.prototype.color.mark || "#ed560d");
                        ...
                        jq[0].strokeColor = webFlowSimple.prototype.color.mark || "#ed560d"
...
//载入一组数据
        loadData: function (nodes) {
        	...
        	var data = nodes.XMLContent,
        		nodesData = nodes.nodesData;
            ...
            for (var i in data.nodes) {
                ...
                this.addNode(i, data.nodes[i],nodesData)
...
//参数para为JSON结构，与JQUERY中$.ajax()方法的传参一样
        loadDataAjax: function (url) {

            var $this = this,
            
            _url=url || this.options.dataUrl;

            $.getJSON(_url, {flowId: this.options.flowId, _date: new Date().getTime()}, function (data) {
...
//把画好的整个流程图导出到一个变量中(其实也可以直接访问webFlowSimple对象的$nodeData,$lineData,$areaData这三个JSON属性)
        ...
        drawLine: function (id, sp, ep, mark, dash) {
            ...
            if (webFlowSimple.prototype.useSVG != "") {
                ...
                if (mark) {
                    ...
                    path.setAttribute("stroke", webFlowSimple.prototype.color.mark || "#ed560d");
                    ...
                    path.setAttribute("stroke", webFlowSimple.prototype.color.line || "#059eea");
                ...
                if (id != "" && id != "GooFlowS_tmp_line") {

                    var text = document.createElementNS("http://www.w3.org/2000/svg", "text");

                    text.setAttribute("fill", webFlowSimple.prototype.color.font || "#333");
                ...
                if (mark) {
                    ...
                    line.strokeColor = webFlowSimple.prototype.color.mark || "#ed560d"

                }
                else {

                    line.strokeColor = webFlowSimple.prototype.color.line || "#059eea"

                }

                line.fillColor = webFlowSimple.prototype.color.line || "#059eea";
        ...
        drawPoly: function (id, sp, m1, m2, ep, mark) {
            ...
            if (webFlowSimple.prototype.useSVG != "") {
                ...
                if (mark) {
                    ...
                    poly.strokeColor = webFlowSimple.prototype.color.mark || "#ed560d"

                }
                else {

                    poly.strokeColor = webFlowSimple.prototype.color.line || "#059eea"
...
//原lineData已经设定好的情况下，只在绘图工作区画一条线的页面元素
        addLineDom: function (id, lineData) {
            ...
            if (lineData.type && lineData.type != "sl") {
                ...
                res = webFlowSimple.prototype.calcPolyPoints(n1, n2, lineData.type, lineData.M)

            }
            else {

                res = webFlowSimple.prototype.calcStartEnd(n1, n2)
            ...
            if (lineData.type == "sl") {
                ...
                this.$lineDom[id] = webFlowSimple.prototype.drawLine(id, res.start, res.end, lineData.marked)

            }
            else {

                this.$lineDom[id] = webFlowSimple.prototype.drawPoly(id, res.start, res.m1, res.m2, res.end, lineData.marked)
            ...
            for (var i in this.$lineData) {
                ...
                if (this.$lineData[i].from == id) {
                    ...
                    if (this.$lineData[i].type == "sl") {
                        ...
                        res = webFlowSimple.prototype.calcStartEnd(node, other)

                    }
                    else {

                        res = webFlowSimple.prototype.calcPolyPoints(node, other, this.$lineData[i].type, this.$lineData[i].M)
                    ...
                    if (this.$lineData[i].type == "sl") {
                        ...
                        res = webFlowSimple.prototype.calcStartEnd(other, node)

                    }
                    else {

                        res = webFlowSimple.prototype.calcPolyPoints(other, node, this.$lineData[i].type, this.$lineData[i].M)
                ...
                if (this.$lineData[i].type == "sl") {
                    ...
                    this.$lineDom[i] = webFlowSimple.prototype.drawLine(i, res.start, res.end, this.$lineData[i].marked);

                }
                else {

                    this.$lineDom[i] = webFlowSimple.prototype.drawPoly(i, res.start, res.m1, res.m2, res.end, this.$lineData[i].marked);
        ...
        setLineType: function (id, newType, M) {
            ...
            setLineCallback.add(function () {
                ...
                if (newType != "sl") {
                    ...
                    var res = webFlowSimple.prototype.calcPolyPoints(this.$nodeData[from], this.$nodeData[to], this.$lineData[id].type, this.$lineData[id].M);
                ...
                //如果是变回直线
                    ...
                    res = webFlowSimple.prototype.calcStartEnd(this.$nodeData[from], this.$nodeData[to]);

                    if (!res)    return;

                    this.$draw.removeChild(this.$lineDom[id]);

                    this.$lineDom[id] = webFlowSimple.prototype.drawLine(id, res.start, res.end, this.$lineData[id].marked || this.$focus == id);
...
//设置折线中段的X坐标值（可左右移动时）或Y坐标值（可上下移动时）
        setLineM: function (id, M, noStack) {
            ...
            moveLineCallback.add(function () {
                ...
                var ps = webFlowSimple.prototype.calcPolyPoints(this.$nodeData[from], this.$nodeData[to], this.$lineData[id].type, this.$lineData[id].M);

                this.$draw.removeChild(this.$lineDom[id]);

                this.$lineDom[id] = webFlowSimple.prototype.drawPoly(id, ps.start, ps.m1, ps.m2, ps.end, this.$lineData[id].marked || this.$focus == id);
            ...
            if (type == "node") {
                ...
                markItemCallback.add(function () {
                    ...
                    if (mark) {
                        ...
                        jq.css("border-color", webFlowSimple.prototype.color.mark);
                    }
                    else {
                ...
                markItemCallback.add(function () {
                    ...
                    if (webFlowSimple.prototype.useSVG != "") {
                        ...
                        if (mark) {
                            ...
                            this.$nodeDom[id].childNodes[1].setAttribute("stroke", webFlowSimple.prototype.color.mark || "#ed560d");

                            this.$nodeDom[id].childNodes[1].setAttribute("marker-end", "url(#arrow2)");

                        } else {

                            this.$nodeDom[id].childNodes[1].setAttribute("stroke", webFlowSimple.prototype.color.line || "#059eea");
                        ...
                        if (mark) {
                            ...
                            this.$nodeDom[id].strokeColor = webFlowSimple.prototype.color.mark || "#ed560d"

                        }
                        else {

                            this.$nodeDom[id].strokeColor = webFlowSimple.prototype.color.line || "#059eea"
...
//设置区域分块的尺寸
        ...
        addArea: function (id, json) {
            ...
            this.$areaDom[id] = $("<div id='" + id + "' class='GooFlowS_area area_" + json.color + "' style='top:" + json.top + "px;left:" + json.left + "px'><div class='bg' style='width:" + (json.width - 2) + "px;height:" + (json.height - 2) + "px'></div>"
                + "<label>" + json.name + "</label><i></i><div><div class='bubble'></div></div>");
...
//重构整个流程图设计器的宽高
    ...
    function _addTooButton(toolBtns) {
        ...
        if ((toolBtns & 1) == 1) {
            ...
            _btns.push("<a href='javascript:void(0)' type='cursor' title='选择' class='GooFlowS_tool_btndown' id='btn_cursor'><i class='ico_cursor'/></a>")

        }

        if ((toolBtns & 2) == 2) {

            _btns.push("<a href='javascript:void(0)' type='direct' title='连线' class='GooFlowS_tool_btn' id='btn_direct'><i class='ico_direct'/></a>")

        }

        if ((toolBtns & 4) == 4) {

            _btns.push("<a href='javascript:void(0)' type='start round' title='开始节点' class='GooFlowS_tool_btn' id='btn_start'><i class='ico_start'/></a>")

        }

        if ((toolBtns & 8) == 8) {

            _btns.push("<a href='javascript:void(0)' type='mutiselect' title='添加节点' class='GooFlowS_tool_btn' id='btn_mutiselect'><i class='ico_mutiselect'/></a>")

        }
        if ((toolBtns & 16) == 16) {

            _btns.push("<a href='javascript:void(0)' type='end round' title='结束节点' class='GooFlowS_tool_btn' id='btn_end'><i class='ico_end'/></a>")

        }
        if ((toolBtns & 32) == 32) {

            _btns.push("<a href='javascript:void(0)' type='task mix' title='复合节点' class='GooFlowS_tool_btn' id='btn_task'><i class='ico_task'/></a>")
...
//兼容各种浏览器的,获取鼠标真实位置
    ...
    function Plugin(option) {
        ...
        return this.each(function () {
            ...
            var data = $this.data('by.webFlowSimple');

            var options = typeof option == 'object' && option;

            if (!data) {

                $this.data('by.webFlowSimple', (data = new webFlowSimple(this, options)))
    ...
    var old = $.fn.webFlowSimple;

    $.fn.webFlowSimple = Plugin;

    $.fn.webFlowSimple.Constructor = webFlowSimple;

    $.fn.webFlowSimple.noConflict = function () {

        $.fn.webFlowSimple = old;
