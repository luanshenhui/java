                           ...
                           <div class="form-left">
                               <ul class="form-left-tree">
                                   ...
                                   <li class="tree-step1 tree-blue tree-down arrow-green">
                                       <a href="javascript:void(0)">拟办人意见<span>业务数据量：128<br/>告警数：1 风险数：0</span></a>
                                   </li>
                                   <li class="tree-step2 tree-blue arrow-green tree-row">
                                       <a href="javascript:void(0)">拟办负责人签字<span>业务数据量：128<br/>告警数：1  风险数：1</span></a>
                                   </li>
                                   <div class="tree-div1">
                                       <li class="tree-step3 tree-blue arrow-green tree-down">
                                           <a href="javascript:void(0)">专委会讨论<span>业务数据量：168<br/>告警数：2  风险数：1</span></a>
                                       </li>
                                       <li class="tree-step4 tree-blue arrow-red tree-row">
                                           <a href="javascript:void(0)">专委会领导<span>业务数据量：138<br/>告警数：2  风险数：0</span></a><i></i>
                                       </li>
                                   </div>
                                   <div class="tree-div2">
                                       <li class="tree-step5 tree-blue arrow-red tree-down">
                                           <a href="javascript:void(0)">审委会讨论<span>业务数据量：268<br/>告警数：3  风险数：1</span></a>
                                       </li>
                                       <li class="tree-step6 tree-blue arrow-green tree-down">
                                           <a href="javascript:void(0)">审委会领导审批<span>业务数据量：168<br/>告警数：1  风险数：0</span></a>
                                       </li>
                                   </div>
                                   <li class="tree-red">
