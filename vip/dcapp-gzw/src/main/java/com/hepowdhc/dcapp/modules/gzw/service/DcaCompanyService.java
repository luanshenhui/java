...
import com.hepowdhc.dcapp.modules.gzw.dao.DcaCompanyDao;
...
public class DcaCompanyService extends CrudService<DcaCompanyDao, DcaCompany> {
	...
	public List<DcaCompany> findListTime(DcaCompany dcaCompany) {
		return dao.findListTime(dcaCompany);
	}
}