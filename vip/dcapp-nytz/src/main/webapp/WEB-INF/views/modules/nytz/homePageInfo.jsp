...
<script src="/static/nytz/js/jquery.homepageInfo.js" type="text/javascript"></script>
<div id="homePageInfo" class="wrap">
	<div>
        <div class="mainbox">
			<div class="box" id="box">
				<div class="left m-r-20">
				<div data-id="left-first">
					<div class="small-box">
						<div id="businessGauge" class="businessGauge" data-id="businessGauge">
						</div>
		        ...
		        <div class="right m-l-20">
					...
					<div class="small-box">
						<div id="riskDeptInfo" class="riskDeptInfo" data-id="riskDeptInfo"></div>
					...
					<div class="small-box">
						<div class="xs-title">
							<span>覆盖业务</span>
							<span class="right font-42 m-r-20" data-id="overlayService"></span>
						</div>
