...
<script src="/static/nytz/js/jquery.homepage.js" type="text/javascript"></script>
<script>
...
<div class="wrap" id="homePage">
	<div class="container">
        <div class="header">
            <h1 class="header-log"><a href="${ctx}/login" target="_blank" style="cursor:pointer"><img src="/static/nytz/images/logo.png"></a></h1>
	        ...
	        <div class="mainbox">
			<iframe id="iframe-main" src="${ctx}/nytz/homepageInfo" scrolling="no" style="border:none;" width="1920" height="906" allowtransparency="true"></iframe>	
			</div>
