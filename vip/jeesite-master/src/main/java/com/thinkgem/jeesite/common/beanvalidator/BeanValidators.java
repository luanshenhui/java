 ...
 * 
 * ConstraintViolation中包含propertyPath, message 和invalidValue等信息. 提供了各种convert方法，适合不同的i18n需求: 1. List<String>,
 * String内容为message 2. List<String>, String内容为propertyPath + separator + message 3. Map<propertyPath, message>
 * 
