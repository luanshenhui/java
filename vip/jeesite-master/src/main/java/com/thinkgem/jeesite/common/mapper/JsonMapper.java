...
public class JsonMapper extends ObjectMapper {
	...
	/**
	 * 構造泛型的Collection Type如: ArrayList<MyBean>, 则调用constructCollectionType(ArrayList.class,MyBean.class) HashMap
	 ...
	 * @throws IOException
	 */
	public static <T> T toJsonCollections(String jsonString, Class<?> collectionClass, Class<?>... elementClasse)
			throws JsonParseException, JsonMappingException, IOException {
		JavaType javaType = JsonMapper.getInstance().getTypeFactory().constructParametricType(collectionClass,
				elementClasse);
		return JsonMapper.getInstance().readValue(jsonString, javaType);
	}
