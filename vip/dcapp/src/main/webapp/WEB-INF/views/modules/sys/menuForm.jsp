...
<body>
	...
	<form:form id="inputForm" modelAttribute="menu" action="${ctx}/sys/menu/save" method="post" class="form-horizontal span12">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>
		<div class="control-group ">
			<label class="control-label font-normal">上级菜单:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label font-normal">名称:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label font-normal">链接:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label font-normal">目标:</label>
			<div class="controls">
...
<!-- 		<div class="control-group"> -->
<!-- 			<label class="control-label font-normal">图标:</label> -->
<!-- 			<div class="controls"> -->
<%-- 				<sys:iconselect id="icon" name="icon" value="${menu.icon}"/> --%>
<!-- 			</div> -->
<!-- 		</div> -->
		<div class="control-group">
			<label class="control-label font-normal">排序:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label font-normal">可见:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label font-normal">权限标识:</label>
			<div class="controls">
		...
		<div class="form-actions">
			<shiro:hasPermission name="sys:menu:edit"><input id="btnSubmit" class="btn-s btn-opear" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
