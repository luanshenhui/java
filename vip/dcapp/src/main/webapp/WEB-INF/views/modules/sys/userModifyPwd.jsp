...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/modifyPwd" method="post" class="form-horizontal span12">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>
		<div class="control-group">
			<label class="control-label font-normal">旧密码:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label font-normal">新密码:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label font-normal">确认新密码:</label>
			<div class="controls">
