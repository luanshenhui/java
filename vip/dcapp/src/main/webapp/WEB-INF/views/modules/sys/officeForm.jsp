...
<body>
	...
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal span12">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>
		<div class="control-group">
			<label class="control-label font-normal">上级部门:</label>
			<div class="controls">
                <sys:treeselect id="office" name="parent.id" value="${office.parent.id}" labelName="parent.name" labelValue="${office.parent.name}"
					title="上级部门" url="/sys/office/treeData" extId="${office.id}" cssClass="" allowClear="${office.currentUser.admin}"/>
			</div>
		</div>
		<%-- <div class="control-group">
			<label class="control-label font-normal">归属区域:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label font-normal">部门名称:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label font-normal">部门编码:</label>
			<div class="controls">
				<form:input path="code" htmlEscape="false" maxlength="50"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label font-normal">职能类型:</label>
			<div class="controls">
		...
		<%--<div class="control-group">
			<label class="control-label font-normal">机构级别:</label>
			<div class="controls">
		 ...
		 <div class="control-group">
			<label class="control-label font-normal">是否可用:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label font-normal">部门正职:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label font-normal">部门副职:</label>
			<div class="controls">
		...
		<%-- <div class="control-group">
			<label class="control-label font-normal">联系地址:</label>
			<div class="controls">
				<form:input path="address" htmlEscape="false" maxlength="50"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label font-normal">邮政编码:</label>
			<div class="controls">
				<form:input path="zipCode" htmlEscape="false" maxlength="50"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label font-normal">负责人:</label>
			<div class="controls">
				<form:input path="master" htmlEscape="false" maxlength="50"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label font-normal">电话:</label>
			<div class="controls">
				<form:input path="phone" htmlEscape="false" maxlength="50"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label font-normal">传真:</label>
			<div class="controls">
				<form:input path="fax" htmlEscape="false" maxlength="50"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label font-normal">邮箱:</label>
			<div class="controls">
		...
		<c:if test="${empty office.id}">
			<div class="control-group">
				<label class="control-label font-normal">快速添加下级部门:</label>
				<div class="controls">
		...
		<div class="form-actions">
			<shiro:hasPermission name="sys:office:edit"><input id="btnSubmit" class="btn-s btn-opear" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
