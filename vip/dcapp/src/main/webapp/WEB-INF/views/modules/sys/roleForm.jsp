...
<body>
	...
	<form:form id="inputForm" modelAttribute="role" action="${ctx}/sys/role/save" method="post" class="form-horizontal span12">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>
		<div class="control-group">
			<label class="control-label font-normal">归属机构:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label font-normal">角色名称:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label font-normal">英文名称:</label>
			<div class="controls">
		...
		<!-- 角色类型: assignment：可进行任务分配 -->
		<form:hidden path="roleType" value="assignment"/>
		<%-- <div class="control-group">
			<label class="control-label font-normal">角色类型:</label>
			<div class="controls">
		...
		<%-- <div class="control-group">
			<label class="control-label font-normal">是否系统数据:</label>
			<div class="controls">
		...
		<%-- <div class="control-group">
			<label class="control-label font-normal">数据范围:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label font-normal">角色授权:</label>
			<div class="controls">
		...
		<div class="form-actions">
			<c:if test="${(role.sysData eq fns:getDictValue('是', 'yes_no', '1') && fns:getUser().admin)||!(role.sysData eq fns:getDictValue('是', 'yes_no', '1'))}">
				<shiro:hasPermission name="sys:role:edit"><input id="btnSubmit" class="btn-s btn-opear" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
			</c:if>
