...
<head>
	...
	<style type="text/css">
		#main {padding:0;margin:0;} #main .container-fluid{padding:0 4px 0 1px;}
		/* #header {margin:0 0 8px;position:static;} #header li {font-size:14px;_font-size:12px;}
		#header .brand {font-family:Helvetica, Georgia, Arial, sans-serif, 黑体;font-size:26px;padding-left:33px;}*/
		/* #footer {margin:8px 0 0 0;padding:3px 0 0 0;font-size:11px;text-align:center;border-top:2px solid #0663A2;}
		#footer, #footer a {color:#999;} */ #left{overflow-x:hidden;overflow-y:auto;} #left .collapse{position:static;} 
		#userControl>li>a{/*color:#fff;*/text-shadow:none;} #userControl>li>a:hover, #user #userControl>li.open>a{background:transparent;}
		.ellipsis-text{	width: 140px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden;}
	</style>
...
<!-- 					</li> -->
					<li id="userInfo" class="dropdown">
						<a class="dropdown-toggle ellipsis-text" data-toggle="dropdown" href="#" title="${fns:getUser().name}">您好, ${fns:getUser().name}&nbsp;<span id="notifyNum" class="label label-info hide"></span></a>
						<ul class="dropdown-menu">
...
<%-- 							<li><a href="${ctx}/oa/oaNotify/self" target="mainFrame"><i class="icon-bell"></i>&nbsp;  我的通知 <span id="notifyNum2" class="label label-info hide"></span></a></li> --%>
	...
	<script type="text/javascript"> 
		...
		function wSize(){
			...
			frameObj.height((strs[0] < minHeight ? minHeight : strs[0]) - headerObj.height() - footerObj.height() - (strs[1] < minWidth ? 63 : 70));
			$("#openClose").height($("#openClose").height() - 30);// <c:if test="${tabmode eq '1'}"> 
