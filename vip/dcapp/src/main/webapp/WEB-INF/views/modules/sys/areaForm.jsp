...
<body>
	...
	<form:form id="inputForm" modelAttribute="area" action="${ctx}/sys/area/save" method="post" class="form-horizontal span12">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>
		<div class="control-group">
			<label class="control-label font-normal">上级区域:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label font-normal">区域名称:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label font-normal">区域编码:</label>
			<div class="controls">
				<form:input path="code" htmlEscape="false" maxlength="50"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label font-normal">区域类型:</label>
			<div class="controls">
		...
		<div class="form-actions">
			<shiro:hasPermission name="sys:area:edit"><input id="btnSubmit" class="btn-s btn-opear" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
