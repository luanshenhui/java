 ...
 * @version 2016-11-16
 */
public class DcaRiskManageLog extends DataEntity<DcaRiskManageLog> {

	private static final long serialVersionUID = 1L;
	private String uuid; // uuid
	private String riskManageId; // 风险管理ID;via.dca_alarm_detail
	...
	private String action; // 动作描述 1-界定;2-撤销界定;3-转发界定
	...
	public DcaRiskManageLog() {
		super();
	}

	public DcaRiskManageLog(String id) {
		super(id);
	}
	...
	@Length(min = 0, max = 5, message = "动作描述 1-界定;2-撤销界定;3-转发界定长度必须介于 0 和 5 之间")
